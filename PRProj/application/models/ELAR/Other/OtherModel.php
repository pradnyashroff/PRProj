  ...
  public function addOtherRimDetails($data) {
    ...
    public function hodActionOtherClaim($data, $ClaimId,$StatusId) {
     ...
     public function otherClaimDetailsApproval($ocm_id) {
        ...
        $this->db->select('ocm.ocm_id, em.emp_code, em.emp_name, ocm.plant_code, ocm.reg_date, gm.grade, dm.dept_name, ocm.bank_name,ocm.acc_no,ocm.ifsc,ocm.justification');
    ...
    public function showSancAuthoReportAccept($txtFromDate,$txtToDate) {
        ...
        $condition = "ocm.ocm_id=ocs.ocm_id and ocs.action=1 and ocs.level_of=4 and ocs.emp_code=em.emp_code and ocm.ocm_status=3 and em.emp_dept=dm.dept_code and em.plant_code=pm.plant_code and  ocm.reg_date BETWEEN  " . "'" . $txtFromDate . "'" . " AND " . "'" . $txtToDate . "'";
         $this->db->select('ocm.ocm_id,em.emp_name,ocm.total_amt,ocm.reg_date,em.emp_code,dm.dept_name,pm.plant_name');
...
$query = $this->db->get();
    ...
    public function fetchMdOfficeMailDetailsForClaimer() {
     ...
     public function otherBankDetails($emp_code) {
    ...
    public function getClaimerPlant($ocm_id) {
