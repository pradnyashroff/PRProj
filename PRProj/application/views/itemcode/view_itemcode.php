...
<html>
	...
	<body class="hold-transition skin-blue sidebar-mini" >
		...
		<!-- Content Header (Page header) -->
			...
			<h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">View ItemCode 
			<?php
				if (isset($error)) {
			...
			<ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
				...
				<li class="active" style="color:#FFFFFF;">View ItemCode</li>
			</ol>
			</section>
			<!-- Main content -->
			...
			<div class="wrapper">
              ...
              <!-- /.box-tools -->
			   ...
			   <div class="box-body">
					<?php $itencode_detail = $this->method_call->itemcode_file($iten_gen_id);
						...
						{  
					?>
					<form method="POST" action="<?php echo site_url('purchase/itemcode/update_hsncode');?>" id="delpur">     
					<div class="col-sm-4">
			  ...
			  <label class="col-sm-1 pull-left control-label">3</label>
			   <label class="col-sm-4 pull-left control-label">PR Owner nm</label>
				<div class="input-group  col-sm-6">
				<?php echo $rowitem->pr_owner_name; ?>
			  ...
			  <label class="col-sm-1 pull-left control-label">4</label>
			   ...
			   <label class="col-sm-4 pull-left control-label">Itemdate</label>
				<div class="input-group  col-sm-6">
                 ...
                 <?php echo $rowitem->item_gen_date; ?>                         
...
<!--end -->
 ...
 <div class="box-header with-border">
					   <div class="box box-default ">
					   <div class="box-header with-border">
              <h3 class="box-title" style="color:#3482AE;">2. ItemCode Details</h3>
	  ...
	  <div class="box-body">
				...
				<!-- ItemCode start -->
				    ...
				    <table id="example6" class="table table" style="width:100%";>
                <thead style="background-color:#3482AE;color:#FFFFFF;width:100%;">
...
foreach ($item->result() as $row5)  
         {  ?>
			<tr>
				...
				<td name="qcs_item_id"><?php echo $row5->qcs_item_id; ?></td>
...
<input type="hidden" name="item_id_list" id="can_id"> 
		<br>
			...
			<!--
				<?php 
				     if($rowitem->item_gen_status =="Reject_by_taxation_dept"){
						 ?>
						 <div class="form-group col-sm-12">
								
								<div class="col-sm-4">
								</div>
						 <div class="col-sm-4"><button type="submit" id="" class="btn  bg-skincolor " style="border: 1px solid orange;width: 100%;">Proceed</button></div>
						 </div>
										...
										<div class="box-body">
												...
												<table id="exampletest" class="table table">
													...
													<tbody>
														...
														<?php 
															$view_item= $this->method_call->qcs_items_list($iten_gen_id);
															$final_rate=0; 
...
<table>
<tr>
<td><input type="text" name="edit_hsncode"   class="form-control"  required></td>
