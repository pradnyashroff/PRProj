 ...
 <br><br><table id="example" class="table table">
               ...
               <tr style="background-color:#3482AE;color:#FFFFFF">
                ...
                <tbody>
				 ...
				 $qcs_approved = $this->method_call->qcs_approved_item_gen($emp_code);
...
foreach ($qcs_approved->result() as $row)  
         {  ?>
            ...
            <td >  <a href="<?php echo site_url('purchase/itemcode/itemcode_create/'.$row->qcs_id);?>"> QCS <?php echo $row->qcs_id;?> </a></td> 
