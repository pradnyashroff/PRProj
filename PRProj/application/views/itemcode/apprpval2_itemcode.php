...
<head>
  ...
  <title>Approve By SAP Department</title>
...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;">SAP Department
</li>
</li>
      </ol>
 ...
 if($itencode_detail!=null){
	 foreach ($itencode_detail->result() as $rowitem)  
       ...
       <form method="POST" action="<?php echo site_url('purchase/itemcode/update_itemcode');?>" id="delpur">   
<div class="box-header with-border">
	...
	<div class="box-header with-border">
	  ...
	  <div class="box-body">
				    ...
				    <table id="example7" class="table table-bordered table-striped" style="font-size: 12px!important;">
                <thead>
...
foreach ($item->result() as $row5)  
         {  ?>
			<tr>
				 ...
				 <td class="glyphicon glyphicon-edit" style="color:red;" onclick="itemCodeUpdate_data('<?php echo $row5->qcs_item_id;?>','<?php echo $row5->q_item_code;?>','<?php $varassetDesc =$row5->q_item_description; echo htmlspecialchars($varassetDesc); ?>')" data-toggle="modal" data-target="#itemcode_up_Modal"<?php echo $row5->qcs_item_id;?>"><?php echo $row5->qcs_item_id; ?></td>
...
<input type="hidden" name="item_id_list" id="can_id"> 
 ...
 <label class="col-sm-4 pull-left control-label"><h4>3 . ItemCode List Add </h4> </label>
					  </div>
                <div class="form-group col-md-12">

			 <textarea id="editor1" class="form-control " style="font-family:'exo';" name="itemcode_list" rows="10" cols="80" required>
 </textarea>
			 ...
			 <div class="input-group  col-sm-6">
			    <input type="radio" name="itemcode_state" value="Approve_by_sap_dept"> Approve</input>
				
				&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;
			
           <input type="radio" name="itemcode_state" value="Reject_by_sap_dept"> Reject</input>
			   ...
			   <label class="col-sm-4 pull-left control-label">Approver Comment </label>
				<div class="input-group  col-sm-4">
					    ...
					    <textarea name="sap_comment" rows="4" cols="50"  required ></textarea>
...
<input type="hidden" name="pr_emp_code" class="form-control" readonly value="<?php echo $rowitem->pr_owner; ?>"> 
  ...
  <input type="text" name="sap_dept_email" value="<?php print_r($eid_owner['emp_email']); ?>" readonly  class="form-control"  required>
 ...
 <!--<div class="col-sm-2"><button type="button" id="delete_can" class="btn  bg-skincolor " style="border: 1px solid orange;width: 100%;">Update ItemCode </button></div>-->
	...
	<input type="Text" name="pr_plant" class="form-control" style="background-color:#E6F2FF;" readonly value="  <?php echo $rowitem->pr_id; ?>"  required>     
	  ...
	  <div class="form-group col-sm-6">
		   ...
		   <div class="form-group col-sm-12">
			  ...
			  <label class="col-sm-4 pull-left control-label">7 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Requirement Details</label>
...
foreach ($item->result() as $row3)  
  ...
  <!-- start item code model-->
  	<div class="modal fade displaycontent" id="itemcode_up_Modal">
...
<div class="modal-dialog" role="document" style="width:600px;">
  ...
  <form id="itemDetails" name="itemDetails" action="<?php echo site_url('purchase/itemcode/updateitemCode'); ?>" method="post">
            <div class="row">
			 ...
			 <input type="hidden" name="item_idEdit"  class=" form-control" id="item_idEdit"   required>
			  <input type="Text" name="item_itemcode" class=" form-control" id="item_itemcode"   required>
...
function itemCodeUpdate_data(iten_gen_id,q_item_code,q_item_description) {
 // alert("pr_id..... "+qcs_item_id);
  // alert("q_item_code..... "+q_item_code);
	
	document.getElementById("item_idEdit").value = iten_gen_id;
	document.getElementById("item_itemcode").value = q_item_code;
