...
<li class="active" style="color:#FFFFFF;">Approved Capex</li>
 ...
 <br><br><table id="example" class="table table-sm" style="font-size: 12px!important;border:1px solid black;
                ...
                <tbody>
				 ...
				 $reject_list = $this->method_call->capex_approved_record($emp_code);
 if($reject_list!=null){
         ...
         {  ?>
           ...
           <td style="text-align:center"> <a href="<?php echo site_url('purchase/capex/view_capex/'.$row->capex_id);?>"> Capex <?php echo $row->capex_id;?> </a></td> 
			...
			<?php $st =  $row->capex_status;
					...
					if($st  == 'capex_approved'){
						echo 'Capex Process Completed';
