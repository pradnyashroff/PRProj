...
<li class="active"style="color:#FFFFFF;">View CAPEX
 ...
 if($q_capex_detail!=null){
	 foreach ($q_capex_detail->result() as $q_row)  
         ...
         <div class=" form-group col-sm-12" style="color:#3482AE;text-align:center; font-family:'exo';text-transform: uppercase;">
		<span> <h4 style="color:#3482AE;text-align:center; font-family:'exo';text-transform: uppercase;font-size:25px;"> CAPITAL EXPENDITURE  APPROVAL MEMO </h4></span>
		 </div>
...
foreach ($view_item->result() as $row_asset)  
		...
		<tr> 
		 ...
		 <div class="form-group col-sm-12">
			   ...
			   <label class="col-sm-1 pull-left control-label">1</label>
			   <label class="col-sm-4 pull-left control-label"> Asset Code List :</label>
				<div class="input-group  col-sm-6">
