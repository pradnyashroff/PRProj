 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper"  style="background-color:#3482AE">
    ...
    <section class="content-header">
     <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">Approval CAPEX
	 <?php
		if (isset($error)) {
...
<form method="post" id="main_form" action="<?php echo site_url('purchase/Capex/approval4_capex_insert') ?>" enctype='multipart/form-data' >  	
			 ...
			 <div class="col-sm-4">
			  ...
			  <label class="col-sm-1 pull-left control-label">1</label>
			   <label class="col-sm-4 pull-left control-label">CAPEX NO </label>
                ...
                <input type="text" style="background-color:#E6F2FF;" name="capex_no" value="<?php echo $capex_row->capex_id; ?>" readonly class="form-control"  required>
			  ...
			  <label class="col-sm-1 pull-left control-label">4</label>
			   <label class="col-sm-4 pull-left control-label">Department</label>
				<div class="input-group  col-sm-6">
						...
						<input type="text" class="form-control" style="background-color:#E6F2FF;" readonly name="dft_plant" value="<?php print_r($dept_nm['dept_name']); ?>">
		...
		<p style="color:red;font-size:15px;">
			  ...
			  <label class="col-sm-1 pull-left control-label">9</label>
			   <label class="col-sm-4 pull-left control-label">Plant</label>
				<div class="input-group  col-sm-6">
                 <input type="Text" name="plant_code" class=" form-control" value="<?php echo $q_row->plant_code; ?>" style="background-color:#E6F2FF;" readonly   required>                          
...
<!--end -->
			...
			<div class="form-group col-sm-12">
			   ...
			   <div class="input-group  col-sm-6">
			  <input type="radio" name="capex_state" value="capex_approved" required > Approve </input> 
			   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			
             <!--  <input type="radio" name="capex_state" value="capex_rejected" required> Reject</input>-->
...
<!-- QCS Owner -->
<?php $qcs_email = $this->method_call->fetchemp_email($capex_row->qcs_emp_code); ?>
  ...
  <div class="box-header with-border">
            ...
            <div class="row">
			 ...
			 <td style="display:none" >  </td>
				 ...
				 <td colspan="3" style="text-align: center;text-transform: uppercase;" ><b> <center>Selected Supplier   :&nbsp;&nbsp; <?php echo $q_row->sup1_nm; ?><center></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3" style="text-align: center;text-transform: uppercase;" ><b><center>Supplier 2  :&nbsp;&nbsp;<?php echo $q_row->sup2_nm; ?><center></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3" style="text-align: center;text-transform: uppercase;" ><b><center>Supplier 3  :&nbsp;&nbsp;<?php echo $q_row->sup3_nm; ?><center></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
