...
<form method="post" id="main_form" action="<?php echo site_url('purchase/Capex/approval3_capex_insert') ?>" enctype='multipart/form-data' >  	
			 ...
			 <div class="col-sm-4">
			  ...
			  <label class="col-sm-1 pull-left control-label">1</label>
			   <label class="col-sm-4 pull-left control-label">CAPEX NO </label>
                ...
                <input type="text" name="capex_no" value="<?php echo $capex_row->capex_id; ?>" style="background-color:#E6F2FF;" readonly class="form-control"  required>
			  ...
			  <label class="col-sm-1 pull-left control-label">2</label>
			   <label class="col-sm-4 pull-left control-label">CAPEX Owner </label>
                ...
                <input type="text" name="capex_owner" value="<?php echo $capex_row->cap_recommender; ?>" style="background-color:#E6F2FF;" readonly class="form-control"  required>
			  ...
			  <label class="col-sm-1  control-label">3</label>
			   <label class="col-sm-4 control-label">CAPEX Date</label>
				<div class="input-group  col-sm-6">
				  ...
				  <input type="text" class="form-control" readonly name="cpx_date" style="background-color:#E6F2FF;" value="<?php echo $capex_row->capex_date; ?>">
			  ...
			  <label class="col-sm-1 pull-left control-label">4</label>
			   <label class="col-sm-4 pull-left control-label">Department</label>
				<div class="input-group  col-sm-6">
						...
						<input type="text" class="form-control" readonly name="dft_plant" style="background-color:#E6F2FF;" value="<?php print_r($dept_nm['dept_name']); ?>">
		 ...
		 <div class="form-group col-sm-4">
			  ...
			  <label class="col-sm-1 pull-left control-label">6</label>
			   <label class="col-sm-4 pull-left control-label">QCS Owner </label>
				<div class="input-group  col-sm-6">
				<input type="Text"  class=" form-control" name ="q_owner" style="background-color:#E6F2FF;" value="<?php echo $q_row->qcs_owner; ?>" readonly   required>                          
		...
		<p style="color:red;font-size:15px;">
			  ...
			  <label class="col-sm-1 pull-left control-label">9</label>
			   <label class="col-sm-4 pull-left control-label">Plant</label>
				<div class="input-group  col-sm-6">
                 <input type="Text" name="plant_code" class=" form-control" style="background-color:#E6F2FF;" value="<?php echo $q_row->plant_code; ?>" readonly   required>                          
...
<!--end -->
 ...
 <div class="box-header with-border">
					   <div class="box box-default ">
					   <div class="box-header with-border">
              <h3 class="box-title">2 . Capex Details</h3>
     ...
     1   
			   ...
			   <label class="col-sm-3 pull-left control-label">FUND NO</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" value="<?php echo $capex_row->fund_no; ?> " style="background-color:#E6F2FF;" readonly name="dft_fund_no"  class="form-control" >
	...
	12
			   ...
			   <label class="col-sm-5 pull-left control-label">Brief Business/ Financial  Justification for Capex</label>
				<div class="col-sm-12 pull-right table-responsive">
                          ...
                          <table id="exampletest" class="table table-bordered table-striped" >
                <thead>
...
<!-- Asset code -->
			 ...
			 <div class="box-header with-border">
					   <div class="box box-default collapsed-box">
					   <div class="box-header with-border">
              <h3 class="box-title">5.  Asset Code Creation &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;   <img src="<?php echo base_url(); ?>assets/images/excel.jpg" style="heu=ight:30px;width:30px;" onclick="pradnya(<?php echo $capex_row->capex_owner_code;?>)"  ></h3>
				<button type="button"  id="btnExport" name="btnExport" onclick="pradnya(<?php echo $capex_row->capex_owner_code;?>)" class="btn" style="display: none;">Basic</button>
				<button type="submit"  id="btnExport" name="btnExport" onclick="fnExcelReport();" class="btn" style="display: none;">hidden </button>
		...
		<tbody>
							...
							<?php $view_item = $this->method_call->qcs_items_assetcode($capex_id);
...
foreach ($view_item->result() as $row_asset1)  
         ...
         { 
			...
			<td><?php echo $capex_row->capex_ion_no; ?></td>
...
<br>
	...
	<div class="form-group col-sm-12">
			   ...
			   <label class="col-sm-4 pull-left control-label">Asset code Attachment</label>
				...
				<input type ="file" class ="form-control" name ="assetFile_attach"/>
                </div>
                </div> 	
		 ...
		 <?php echo $capex_row->cpx_release_no;?>
			   ...
			   <div class="input-group  col-sm-6">
			  <input type="radio" name="capex_state" value="capex_approved_by_asset_dept" required > Approve </input> 
			   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			
               <!--<input type="radio" name="capex_state" value="capex_rejected_by_asset_dept" required> Reject</input>-->
...
<!-- QCS Owner -->
<?php $qcs_email = $this->method_call->fetchemp_email($capex_row->capex_approval3); ?>
<input type="hidden" name="qcs_email" class="form-control"  readonly value="<?php print_r($qcs_email['emp_email']); ?> "  required>                          
...
<!-- end -->	
  ...
  <div class="box-header with-border">
            ...
            <div class="row">
			    ...
			    <div class="form-group col-sm-12">
			        <table id="example6" class="table table-bordered table-striped display">
            
                <tbody>
								   <tr style="background-color:#3482AE;color:#FFFFFF;">
	  
			 <td style="display:none" >  </td>
			  <td style="text-align: center;text-transform: uppercase;"> Sr No </td>
			 <td style="display:none" >  </td>
			 <td style="display:none" >  </td>
			 <td style="display:none" >  </td>
			 <td style="display:none" >  </td>
				 <td colspan="6"style="text-align: center;text-transform: uppercase;" >Technical Specification</td>
				 <td colspan="3" style="text-align: center;text-transform: uppercase;" >Selected Supplier   :&nbsp;&nbsp; <?php echo $q_row->sup1_nm; ?></td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3" style="text-align: center;text-transform: uppercase;" >Supplier 2  :&nbsp;&nbsp;<?php echo $q_row->sup2_nm; ?></td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3" style="text-align: center;text-transform: uppercase;" >Supplier 3  :&nbsp;&nbsp;<?php echo $q_row->sup3_nm; ?></td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
    ...
    function fnExcelReport()
{
    ...
    tab = document.getElementById('exampletestExport'); // id of table
    ...
    if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./))      
    {
        ...
        txtArea1.focus(); 
        sa=txtArea1.document.execCommand("SaveAs",true,"helloPradnya.xls");
    }  
	...
	function exportMe(owner){
		...
		var capex_id = "<?php echo $capex_id ?>"; 
        var dt = new Date();
        var day = dt.getDate();
