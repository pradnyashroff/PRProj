 ...
 <div class="box-header with-border">
			 ...
			 <div class="col-sm-4">
			  ...
			  <label class="col-sm-1 pull-left control-label" style="color:#3482AE">1</label>
			   <label class="col-sm-4 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">CAPEX NO </label>
			  ...
			  <label class="col-sm-1  control-label" style="color:#3482AE">3</label>
			   <label class="col-sm-4 control-label">CAPEX Date</label>
				<div class="input-group  col-sm-6">
				  ...
				  <input type="text" style="background-color:#E6F2FF" class="form-control" readonly name="cpx_date" value="<?php echo $capex_row->capex_date; ?>">
			  ...
			  <label class="col-sm-1 pull-left control-label" style="color:#3482AE">5</label>
			   <label class="col-sm-4 pull-left control-label">QCS NO</label>
				<div class="input-group  col-sm-6">
				 ...
				 <input type="hidden" name="qcs_no" style="background-color:#E6F2FF" class=" form-control" readonly value="<?php echo $q_row->qcs_id; ?> " required> 
...
<!--end -->
					   ...
					   <div class="box-header with-border">
						...
						<div class="box-body">
							...
							<div class="form-group col-sm-12">
								<div class="col-sm-1 " style="color:#3482AE">1</div>
							...
							<div class="form-group col-sm-12">
								<div class="col-sm-1" style="color:#3482AE">2</div>
	 ...
	 <div class="col-sm-1" style="color:#3482AE">
3.1
      </div>
...
19
 ...
 <div class="box-header with-border">
					   <div class="box box-default">
					   <div class="box-header with-border">
              <h3 class="box-title" style="color:#3482AE;">3. &nbsp; Approver History</h3>
...
<a href="<?php echo site_url('purchase/capex/draft_capex/'.$capex_row->capex_id) ?>"  class="btn" style="width: 95%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);text-transform: uppercase;">Move To Draft</a>
</div>
...
<a href="<?php echo site_url('purchase/capex/print_capex_view/'.$capex_row->capex_id) ?>"  class="btn" style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);">Print</a>
</div>
			   ...
			   <label class="col-sm-5 pull-left control-label"style="color:#3482AE">Requirement Details</label>
				<div class="input-group  col-sm-5 pull-right">
						  ...
						  <table id="exam" class="table table-sm" style="font-size: 12px!important;border:1px solid black;
									; border-color:#3482AE;text-align: center; width:100%;width:100%;box-shadow: 8px 5px 5px 5px rgba(46,61,73,0.15);">
					<thead style="text-align: center;" >
						<tr style="background-color:#3482AE;color:#FFFFFF">
...
<div class="col-sm-4"><button type="submit" name="save" class="btn  bg-skincolor " style="border: 1px solid orange;width: 100%;text-transform: uppercase;">Update</button></div>
...
<?php
		 ...
		 ?>  
				  ...
				  <tfoot>
        <tr>
            <td style="text-align:right;" colspan="7" style="color:#3482AE"><b>Grand Total:</b></td>
