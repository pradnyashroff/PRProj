...
<li class="active" style="color:#FFFFFF;">Draft Capex</li>
 ...
 <br><br>
                ...
                <tbody>
				 ...
				 $draft_list = $this->method_call->capex_draft_record($emp_code);
 if($draft_list!=null){
...
foreach ($draft_list->result() as $row)  
         {  ?>
           ...
           <td style="display:none;"><?php echo $row->capex_id;?></td>  
            <td style="text-align:center">  <a href="<?php echo site_url('purchase/capex/draft_capex/'.$row->capex_id);?>"> Capex <?php echo $row->capex_id;?> </a></td> 
