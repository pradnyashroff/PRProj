    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >      	  
		...
		<div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">Due Date Record
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Due Date Record
                    </li>
                    </li>
                </ol>
            </section>
							...
							<div class="box-body" style="box-shadow: 12px 15px 20px 10px rgba(46,61,73,0.15);">        
								<div class="table-responsive">
									...
									<tbody>
										...
										<td>123456789</td>
										<td>20-03-2020</td>
										<td><a href="#" data-toggle="modal" data-target="#due_date"><span class='fa fa-envelope' style="color:red;"></span></a></td>
                                    </tbody>
								</table>
							</div> 
						</div>
		...
		<div class="modal fade displaycontent" id="due_date">
			<div class="modal-dialog" role="document" style="width: 800px;">
				<div class="modal-content">
					<div class="modal-header" style="background-color:#3482AE">
						...
						<h4 class="modal-title"style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">Due Date Record</h4>
					</div>
									...
									<div class="row">
										<div class="col-sm-12" style="  ">
											...
											<div class="form-group col-md-6">
												...
												<input class="form-control" style="background-color:#E6F2FF;" readonly type="text" required name="txt_deadline_date" id="txt_deadline_date" value=""/>  
											</div>
											<div class="form-group col-md-6">
												<label >No.Of Over Day</label>
												<input class="form-control" style="background-color:#E6F2FF;" readonly type="text" required name="txt_Over_Day" id="txt_Over_Day" value=""/>  
											</div>
											<div class="form-group col-md-6">
												<label >Total Fine</label>
												<input class="form-control" style="background-color:#E6F2FF;" readonly type="text" required name="txt_Total_Fine" id="txt_Total_Fine" value=""/>  
											</div>
											<center><button type="submit" name="save"  class="btn" style="width: 19%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Send Message</button></center> 
                                        </div>
