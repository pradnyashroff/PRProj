...
<html>
						...
						<div class="box">
							<div class="box-body" style="box-shadow: 12px 15px 20px 10px rgba(46,61,73,0.15);">        
								<div class="table-responsive">
									...
									<tbody>
										<?php  $Admin_total_book= $this->method_call->Admin_Total_Book_count();
														if($Admin_total_book!=null){
															$sr_no=1;
														foreach ($Admin_total_book->result() as $row)  
														{
													?>
									<tr>
										<td><a href="#" class="fa fa-eye" style="color:red;" data-toggle="modal" data-target="#total_book" onclick="Book_Detail(<?php echo $row->book_id; ?>)" ><?php echo $sr_no; ?></a></td>
										
										<td><?php echo $row->book_name; ?></td>
										<td><?php echo $row->autho_name; ?></td>
	...
	<div class="modal fade displaycontent" id="total_book">
