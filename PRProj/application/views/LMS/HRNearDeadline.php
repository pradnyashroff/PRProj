...
<html>
    <head>
        ...
        <title>Near DeadLine Book Table</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >      	  
		...
		<div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">Near DeadLine Book Table
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Near DeadLine Book Table
                    </li>
                    </li>
                </ol>
            </section>
						...
						<div class="box">
							<div class="box-body" style="box-shadow: 12px 15px 20px 10px rgba(46,61,73,0.15);">        
								<div class="table-responsive">
									...
									<tbody>
										<td> <a href="#" data-toggle="modal" data-target="#deadline_book" style="color:red;" class="fa fa-eye">1</td>
										<td>ABC</td>
										<td>Java</td>
										<td>1</td>
										<td>20-03-2020</td>
	...
	<div class="modal fade displaycontent" id="deadline_book">
			<div class="modal-dialog" role="document" style="width: 1000px;">
				<div class="modal-content">
					<div class="modal-header" style="background-color:#3482AE">
						...
						<h4 class="modal-title"style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">Near Deadline Book Details</h4>
					</div>
