...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >      	  
		...
		<div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">New Book Request
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">New Book Request
                    </li>
                    </li>
                </ol>
            </section>
						...
						<div class="box">
							<div class="box-body" style="box-shadow: 12px 15px 20px 10px rgba(46,61,73,0.15);">        
								<div class="table-responsive">
									...
									<tbody>
										<td> <a href="#" data-toggle="modal" data-target="#order_Book" style="color:red;" class="fa fa-eye">1</td>
										<td>ABC</td>
										<td>Plant1</td>
										<td>CPP</td>
										<td>-</td>
	...
	<div class="modal fade displaycontent" id="order_Book">
									...
									<div class="row">
										<div class="col-sm-12" style="  ">
											...
											<div class="form-group col-md-6">
												...
												<input class="form-control" style="background-color:#E6F2FF;" readonly type="text" required name="txt_Mob_no" id="txt_Mob_no" value="<?php echo $emp_mobile; ?>"/>	
											</div>
											<div class="form-group col-md-6">
											...
											<div class="form-group col-md-6">
												...
												<input class="form-control" type="text" required id="txt_publisher" style="background-color:#E6F2FF;" readonly name="txt_publisher" value=""/>	
											</div>
											<div class="form-group col-md-6">
												<label >Quantity</label>
												<input class="form-control" type="text" required name="txt_quantity" id="txt_quantity" style="background-color:#E6F2FF;" readonly value=""/>		
											</div>
											<div class="form-group col-md-6">
												<label >Book Type</label>
												<input class="form-control" type="text" required name="txt_Category" id="txt_Category" style="background-color:#E6F2FF;" readonly value=""/> 
											</div>
											<div class="form-group col-md-6">
												<label >Edition</label>
												<input class="form-control" type="text" required name="txt_edition" id="txt_edition" style="background-color:#E6F2FF;" readonly value=""/> 
											</div>
											<div class="form-group col-md-6">
												<label >Comment</label>
