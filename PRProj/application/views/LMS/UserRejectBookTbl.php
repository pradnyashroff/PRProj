						...
						<div class="box">
							<div class="box-body" style="box-shadow: 12px 15px 20px 10px rgba(46,61,73,0.15);">        
								<div class="table-responsive">
									...
									<tbody>
												<?php $bookRejectCount= $this->method_call->RejectBook($emp_code);
												...
												<tr>
													 <td> <a href="<?php echo site_url('LMS/LMS_cntr/UserRejectView/'.$row->order_id);?>"style="color:red;" class="fa fa-eye"><?php echo $row->order_id; ?></a></td>
