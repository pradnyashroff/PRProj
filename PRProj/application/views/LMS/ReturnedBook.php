    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >      	  
		...
		<div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">Returned Book
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Returned Book
                    </li>
                    </li>
                </ol>
            </section>
						...
						<div class="box">
							<div class="box-body" style="box-shadow: 12px 15px 20px 10px rgba(46,61,73,0.15);">        
								<div class="table-responsive">
									...
									<tbody>
												<?php  $bookIssuedCount= $this->method_call->ReturnBookDetails($emp_code);
												...
												<tr>
													<td> <a href="<?php echo site_url('LMS/LMS_cntr/UseReturnBookView/'.$row->order_id);?>" style="color:red;" class="fa fa-eye"><?php echo $row->order_id; ?></a></td>
