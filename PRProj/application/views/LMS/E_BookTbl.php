    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >      	  
		...
		<div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">E-Book Table
                    <?php
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">E-Book Table
                    </li>
                    </li>
                </ol>
            </section>
						...
						<div class="box">
							<div class="box-body" style="box-shadow: 12px 15px 20px 10px rgba(46,61,73,0.15);">        
								<div class="table-responsive">
									...
									<tbody>
										<?php $Admin_Stock_total_book= $this->method_call->E_BookTblDetails();
									...
									<tr>
                                        ...
                                        <?php $Ebook=$booktot->ebook_link;?>
                                        <!--<td> <a href="<?php echo base_url()."uploads/LMS/EBook/" +$Ebook ?>"><?php echo $booktot->ebook_link; ?></a></td>-->
                                        <td><a href="<?=base_url('uploads/LMS/EBook/'.$Ebook)?>" target="_blank" style="color: red"><?php echo $booktot->ebook_link; ?></a></td>
