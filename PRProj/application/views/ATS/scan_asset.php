 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
    ...
    <section class="content-header">
     <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase; margin-left:9%;">
      Scan Asset
		<?php
if (isset($error)) {
...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;">  Scan Asset
</li>
</li>
      </ol>
 ...
 <form   method="post" action="" enctype="multipart/form-data" id="myform" >
			  ...
			  <label class="col-sm-2 pull-left control-label">1</label>
			   <label class="col-sm-5 pull-left control-label">Scan Barcode<span style="color:red"><sup>*</sup></span>
</label>
				<div class="col-sm-5 pull-right">
               
 <input type="text" value=""  name="scanned_barcode" id="bar" autofocus required class="form-control" >
...
<?php 
 if($asset!=null){
		 ...
		 <?php echo form_open_multipart('ATS/Ats/update_asset'); ?>
			  ...
			  <label class="col-sm-2 pull-left control-label">1</label>
			   <label class="col-sm-5 pull-left control-label">Asset No</label>
				<div class="col-sm-5 pull-right">
 ...
 <input type="hidden" value="<?php echo $row->aid; ?>"  name="aid"   style="background-color:#E6F2FF;"  readonly class="form-control" >
 <input type="hidden" value="<?php echo $row->barcode; ?>"  name="barcode"   style="background-color:#E6F2FF;"  readonly class="form-control" >
 <input type="hidden" value="<?php echo $row->business_area; ?>"  name="privious_loc"   style="background-color:#E6F2FF;"  readonly class="form-control" >
 <input type="hidden" value="<?php echo $emp_name; ?>"  name="moved_by"   style="background-color:#E6F2FF;"  readonly class="form-control" >
			  ...
			  <label class="col-sm-2 pull-left control-label">2</label>
			   <label class="col-sm-5 pull-left control-label">Asset Sub No</label>
				<div class="col-sm-5 pull-right">
  ...
  <div class="form-group col-sm-12">
			 ...
			 <div class="form-group col-sm-12">
			  ...
			  <label class="col-sm-2 pull-left control-label">4</label>
			   <label class="col-sm-5 pull-left control-label">GRN Number</label>
				<div class="col-sm-5 pull-right">
			 ...
			 <div class="form-group col-sm-12">
			  ...
			  <label class="col-sm-2 pull-left control-label">5</label>
			   <label class="col-sm-5 pull-left control-label">Asset Description</label>
				<div class="col-sm-5 pull-right">
			  ...
			  <label class="col-sm-2 pull-left control-label">6</label>
			   <label class="col-sm-5 pull-left control-label">Business Area </label>
				<div class="col-sm-5 pull-right"> 
                   <input type="text"  value="<?php echo $row->business_area; ?>" name="business_area" class="form-control" required>
 ...
 <div class="form-group col-sm-12">
			  ...
			  <label class="col-sm-2 pull-left control-label">7</label>
			   <label class="col-sm-5 pull-left control-label">Storage Location Code/Vendor Code</label>
				<div class="col-sm-5 pull-right">
                   <input type="text"  value="<?php echo $row->storage_loc; ?>" name="storage_loc" class="form-control" required>
			  ...
			  <label class="col-sm-2 pull-left control-label">9</label>
			   <label class="col-sm-5 pull-left control-label">Capitalization Date</label>
				<div class="col-sm-5 pull-right">
                   <input type="text"  value="<?php 
				   echo $row->cap_date; ?>" name="cap_date"   style="background-color:#E6F2FF;"  readonly class="form-control" required>
			  ...
			  <label class="col-sm-2 pull-left control-label">10</label>
			   <label class="col-sm-5 pull-left control-label">Capitalization Amont</label>
				<div class="col-sm-5 pull-right">
                   <input type="text"  value="<?php  echo $row->cap_amount; ?>" name="cap_amount"   style="background-color:#E6F2FF;"  readonly class="form-control" required>
			...
			?>
				 <option value="<?php echo $st; ?>">Current :- <?php echo $stats; ?></option>
				 <option value="1">Active</option>
				 <option value="2">Obselete</option>
				 <option value="3">On Lease(to vendor)</option>
...
<div class="form-group col-sm-12">
			  ...
			  <div class="form-group col-sm-12 barcode">
			  
			  <label class="col-sm-2 pull-left control-label">13</label>
			   <label class="col-sm-5 pull-left control-label">Barcode</label>
				<div class="col-sm-5 pull-right">
<br>
<span style="font-family: 'idauto'; font-size:15px; font-weight:100;">*<?php $bar= $row->barcode; echo $row->barcode; ?>*</span>
				  
 
                </div>
			  </div>
 <div class="row invoice-info non-printable">
 ...
 <div class="col-sm-1 invoice-col">
              ...
              <div class="box-footer">
			   ...
			   <button type="submit" class="btn " style="box-shadow: 0 0 3px 1px rgba(0,0,0,.35); background-color:#3482AE;color:white;font-family:'exo';text-transform: uppercase;width: 100%;">Submit</button>
			   	</div>
				 <div class="col-sm-2">
                <a href="<?php echo site_url('ATS/ats/index') ?>" class="btn " style="box-shadow: 0 0 3px 1px rgba(0,0,0,.35); background-color:#3482AE;color:white;font-family:'exo';text-transform: uppercase;width: 100%;">Cancel</a>
				</div>
                 <div class="col-sm-4">
				</div>
                 </div>
