 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
    ...
    <section class="content-header">
     <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase; margin-left:0%;">
      Asset Archival
...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;">Asset Archival
...
<th >Storage Location</th>
                  ...
                  <th >Capitalization Amount</th>
                  
                  <th >Status</th>
                  <th >Barcode</th>
                  <th >Asset Verification Date</th>
                  <th >Asset Verification Status</th>
                ...
                <tbody>
				 ...
				 <?php  
				  $assetlist= $this->method_call->archivelist();
				   if($assetlist!=null){
         foreach ($assetlist->result() as $row)  
         {  
            ?>
			<tr>  
          <td><?php echo $row->aid;?></td>  
          <td><a href="<?php echo site_url('ATS/ats/view_asset/'.$row->aid) ?>"><?php echo $row->scan_asset_no;?></td>  
            <td><?php echo $row->scan_asset_subno;?></td>  
            <td><?php echo $row->asset_class_desc;?></td>  
            <td><?php echo $row->asset_spec;?></td>  
            <td><?php echo $row->business_area;?></td>  

 <td><?php echo $row->storage_loc;?></td>  
...
?></td>  
			...
			<td style="background-color:#04a600;">Verified</td>  
            </tr>  
				   <?php }  }
         ?>  
