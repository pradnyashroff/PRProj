  ...
  <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
    ...
    <section class="content-header">
     ...
     <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
        <li style="color:#FFFFFF;text-transform: uppercase;"><a href="<?php echo site_url('ATS/Ats/AssetDashboard') ?>" style="color:#FFFFFF;text-transform: uppercase;"><i class="fa fa-home" style="color:#FFFFFF;text-transform: uppercase;"></i> Home</a></li>
 ...
 <br><br>
              <table id="example" class="table table">
                ...
                <tbody>
				 ...
				 <?php  
				  $assetlist= $this->method_call->assetlist();
				   if($assetlist!=null){
...
$UNIX_DATE = ($row->cap_date - 25569) * 86400;
