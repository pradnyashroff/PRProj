...
<li class="active" style="color:#FFFFFF;"> Purchase Master </li>
  ...
  ; border-color:#3482AE;text-align: center; width:100%;box-shadow: 12px 15px 20px 10px rgba(46,61,73,0.15);">
                ...
                <tr style="background-color:#3482AE;color:#FFFFFF">
                  ...
                  <th scope="col" style="text-align: center;width:15%;">PR OWNER NAME</th>
                ...
                <tbody>
				  ...
				  <?php $pr= $this->method_call->list_pr($emp_code);
 if($pr!=null){
...
if($comp == "Qcs_Draft" ){ $status="QCS Draft"; }
if($comp == "submited_Sourcing_Mgr" ){ $status="Pending For Sourcing Manager Approval"; }
if($comp == "Sourcing_Mgr_approved"){$status="Approved By Sourcing Manager";}
if($comp == "Sourcing_Mgr_reject"){$status="Rejected By Sourcing Manager";}

if($comp == "Sourcing_Head_Approved"){$status="Approved By Sourcing Head";}
