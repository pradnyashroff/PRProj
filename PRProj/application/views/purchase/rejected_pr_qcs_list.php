...
<li class="active" style="color:#FFFFFF;">QCS Rejected</li>
 ...
 <table id="example" class="table table-sm" style="font-size: 12px!important;border:1px solid black;
                ...
                <tr style="background-color:#3482AE;color:#FFFFFF">
				  ...
				  <th style="text-align: center;text-transform: uppercase;">QCS Date</th>
                   <th style="text-align: center;text-transform: uppercase;">QCS Owner Name</th>
				  <th style="text-align: center;text-transform: uppercase;">PR No </th>
                   <th style="text-align: center;text-transform: uppercase;">Plant</th>
                 
                   <th style="text-align: center;text-transform: uppercase;">QCS Status</th>
	...
	<!--approval level 1 list -->
	  ...
	  <?php $qcs_approval1= $this->method_call->list_rejected_pr_qcs($emp_code);
...
foreach ($qcs_approval1->result() as $row)  
         {  ?>
            ...
            <td style="text-align: center;" >  <a href="<?php echo site_url('purchase/QCS/qcs_view/'.$row->qcs_id);?>"> QCS <?php echo $row->qcs_id;?> </a></td>  
			 <td style="text-align: center;" ><?php echo $row->qcs_date;?></td>  
            <td style="text-align: center;" ><?php echo $row->qcs_owner;?></td>  
