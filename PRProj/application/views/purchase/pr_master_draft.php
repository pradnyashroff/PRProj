...
<li class="active" style="color:#FFFFFF;"> Purchase Master </li>
 ...
 <br><br>
  ...
  ; border-color:#3482AE;text-align: center; width:100%;box-shadow: 12px 15px 20px 10px rgba(46,61,73,0.15);">
                ...
                <tr style="background-color:#3482AE;color:#FFFFFF">
                  ...
                  <th scope="col" style="text-align: center;">PROCURMENT REASON</th>
                ...
                <tbody>
				  ...
				  <?php $pr= $this->method_call->list_pr_draft($emp_code);
 if($pr!=null){
...
foreach ($pr->result() as $row)  
         {  ?>
           ...
           <td style="text-align:center"><?php echo $row->pr_state;?></td>  
