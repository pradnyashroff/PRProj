...
<body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo-bold'" >
 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" style="font-family:'exo';background-color:#3482AE">
    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1 style="font-family:'exo';color:white;">
     Rejected PR
...
<li class="active" style="font-family:'exo'"> Purchase Master </li>
 ...
 <br><br>
  ...
  ; border-color:#3482AE;text-align: center; width:100%;box-shadow: 12px 15px 20px 10px rgba(46,61,73,0.15);">
               ...
               <th scope="col" style="text-align: center;width:10%">Location</th>
                 ...
                 <th scope="col" style="text-align: center;width:10%">PR State</th>
                </tr>
                ...
                <tbody>
				  ...
				  <?php $pr= $this->method_call->list_pr_rejected($emp_code);
 if($pr!=null){
...
foreach ($pr->result() as $row)  
         {  ?>
            ...
            <td style="text-align: center;">  <a href="<?php echo site_url('purchase/PR/view_draft_pr/'.$row->pr_id);?>"> PR <?php echo $row->pr_id;?> </a></td>  
