...
<?php print_r($dept_nm['dept_name']); ?>
			 ...
			 <div class="form-group col-sm-4">
			   ...
			   <label class="col-sm-0 pull-left control-label" style="color:#3482AE">7</label>
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE">REQUIREMENT DETAILS</label>
...
foreach ($item->result() as $row3)  
		 ...
		 <?php  $sr_no++; }
			  ...
			  <label class="col-sm-2 pull-left control-label" style="color:#3482AE"></label>
			   <label class="col-sm-3.5 pull-right control-label" style="color:#3482AE">CUMMULATIVE TOTAL AMT OF PR  <?php echo $row->pr_id; ?> : <span class="fa fa-inr"> </span> <?php echo $final_rate; ?> </label>
			 ...
			 <label class="col-sm-1 pull-left control-label" style="color:#3482AE">9</label>
			   <label class="col-sm-5 pull-left control-label" style="color:#3482AE">INSPECTION REQ. AT SUPPLIER END</label>
				<div class="input-group  col-sm-6">
...
<?php $filea= $this->method_call->filefetch($pr_id); //displaying ccs
 ...
 ?>
		 ...
		 <?php }
			  ...
			  <form method="post" action="<?php echo site_url('purchase/PR/ph_update_pr') ?>" >

			    <div class="form-group col-sm-12">
			  
			 <label class="col-sm-1 pull-left control-label" style="color:#3482AE">17</label>
			   <div class="input-group  col-sm-5 pull-left"><input type="radio" name="pr_state" value="PH_approved" required ><B style="color:#3482AE"> APPROVE </B></input></div>
				<div class="input-group  col-sm-5 pull-right">
                 
                                    <input type="radio" name="pr_state" value="PH_reject" ><B style="color:#3482AE"> REJECT</B></input>
			 ...
			 <label class="col-sm-1 pull-left control-label" style="color:#3482AE">18</label>
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE">APPROVER COMMENT </label>
				<div class="input-group  col-sm-8">
                                        ...
                                        <textarea class="form-control" rows="4" cols="50" name="ph_comment" required> </textarea>
...
<div class="col-sm-4"><button type="submit"  class="btn" style="width: 100%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);" >Proceed</button></div>
<div class="col-sm-4"></div>
				
                </div>
				
			<?php $ph_name= $this->method_call->fetch_emp_name($row->ph_id); ?>
<input type="hidden" name="ph_nm" value="<?php echo $ph_name;?>"></input>
  ...
  <input type="hidden" name="emp_email" value="<?php print_r($eid_owner['emp_email']); ?>" readonly  class="form-control"  required>
			  ...
			  <label class="col-sm-1 pull-left control-label">7</label>
			   <label class="col-sm-4 pull-left control-label">email sourcing</label>
				<div class="input-group  col-sm-6">
                  <input type="hidden" value="<?php echo $row->pr_source_id; ?>" readonly   name="pr_source_id" class="form-control"  required>
  <?php $pr_source_eid= $this->method_call->fetchemp_email($row->pr_source_id); ?>
  <input type="hidden" name="pr_source_eid" value="<?php print_r($pr_source_eid['emp_email']); ?>" readonly  class="form-control"  required>
			  ...
			  <label class="col-sm-1 pull-left control-label">7</label>
			   <label class="col-sm-4 pull-left control-label">email DH</label>
				<div class="input-group  col-sm-6">
                  <input type="hidden" value="<?php echo $row->dh_id; ?>" readonly   name="dh_id" class="form-control"  required>
  <?php $dh_eid= $this->method_call->fetchemp_email($row->dh_id); ?>
  <input type="hidden" name="dh_eid" value="<?php print_r($dh_eid['emp_email']); ?>" readonly  class="form-control"  required>
