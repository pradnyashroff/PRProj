...
<head>
  ...
  <title>Purchase | CAPEX  List</title>
  ...
  <div class="content-wrapper">
    ...
    CAPEX List
     ...
     <ol class="breadcrumb">
       ...
       <li> <a href="<?php echo site_url('purchase/Mgmt_ctr/home') ?>">CAPEX</a></li>

<li class="active">CAPEX List</li>
 ...
 <br><br><table id="example" class="table table-bordered table-striped">
				...
				<?php
				 ...
				 $cpx_list= $this->method_call->capex_list_count();
 if($cpx_list!=null){
	 	   
	$sr_no=1;			  
foreach ($cpx_list->result() as $row)  
         {  ?>
			
			
			<tr>  
            <td style="display:none;"><?php echo $row->capex_id;?></td>  
            <td >  <a href="<?php echo site_url('purchase/Mgmt_ctr/capex_view/'.$row->capex_id);?>"> CAPEX <?php echo $row->capex_id;?> </a></td> 
