...
PR List
     ...
     <ol class="breadcrumb">
       ...
       <li> <a href="<?php echo site_url('purchase/Mgmt_ctr/home') ?>">Purchase</a></li>
 ...
 <br><br>
              <table id="example" class="table table-bordered table-striped">
                ...
                <tbody>
				  	  ...
				  	  <?php $pr= $this->method_call->list_pr_count();
 if($pr!=null){
...
foreach ($pr->result() as $row)  
         {  ?>
            ...
            <td >  <a href="<?php echo site_url('purchase/Mgmt_ctr/view_pr/'.$row->pr_id);?>"> PR <?php echo $row->pr_id;?> </a></td>  
