...
<li class="active">Informal PO  List</li>
 ...
 <br><br><table id="example" class="table table-bordered table-striped">
                ...
                <tbody>
				 ...
				 $info_po = $this->method_call->info_po_list_count();
 if($info_po!=null){
	 	   
	$sr_no=1;			  
foreach ($info_po->result() as $row)  
         {  ?>
		<?php $po_owner_nm= $this->method_call->fetch_emp_name($row->informal_po_empcode); ?>
            ...
            <td >  <a href="<?php echo site_url('purchase/Mgmt_ctr/view_informal_po/'.$row->informal_po_id);?>"> Informal PO No <?php echo $row->informal_po_id;?> </a></td> 
