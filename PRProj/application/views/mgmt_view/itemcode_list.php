...
<li class="active"> ItemCode</li>
 ...
 <br><br> <table id="example" class="table table-bordered table-striped">
                ...
                <tbody>
				 ...
				 $itemc_approved = $this->method_call->itemcode_list_count();
...
foreach ($itemc_approved->result() as $row)  
         {  ?>
            ...
            <td>  <a href="<?php echo site_url('purchase/Mgmt_ctr/view_itemcode/'.$row->iten_gen_id);?>"> ItemCode <?php echo $row->iten_gen_id;?> </a></td> 
