			  ...
			  <label class="col-sm-1 pull-left control-label">4</label>
			   <label class="col-sm-4 pull-left control-label">Department</label>
				...
				<?php $dept_nm= $this->method_call->fetch_dept_nm($q_row->dept_id); ?>
				 ...
				 <input type="text" class="form-control" readonly name="cpx_date" value="<?php print_r($dept_nm['dept_name']); ?>">
...
3.1
			   ...
			   <label class="col-sm-4 pull-left control-label">Required Capital GL Code-1</label>
				<div class="col-sm-5">
                  ...
                  <input type="text" disabled value="<?php echo $capex_row->actual_gl_code; ?> "  class="form-control" >

                </div>
				
				<div class="col-sm-2">
                 
                  <input type="text" disabled value="<?php echo $capex_row->amtGlCode1; ?> "  class="form-control" >
...
3.2
			   ...
			   <label class="col-sm-4 pull-left control-label">Required Capital GL Code-2</label>
				<div class="col-sm-5">
                  ...
                  <input type="text" disabled value="<?php echo $capex_row->actual_gl_code2; ?> "  class="form-control" >

                </div>
				
				<div class="col-sm-2">
                 
                  <input type="text" disabled value="<?php echo $capex_row->amtGlCode2; ?> "  class="form-control" >
...
3.3
			   ...
			   <label class="col-sm-4 pull-left control-label">Required Capital GL Code-3</label>
				...
				<div class="col-sm-2">
                  ...
                  <input type="text" disabled value="<?php echo $capex_row->amtGlCode3; ?> "  class="form-control" >
...
3.1
			   ...
			   <label class="col-sm-4 pull-left control-label">Revenue GL Code-1</label>
				<div class="col-sm-5">
                  ...
                  <input type="text" disabled value="<?php echo $capex_row->revenue_gl_code1; ?> "  class="form-control" >

                </div>
				
				<div class="col-sm-2">
                 
                  <input type="text" disabled value="<?php echo $capex_row->amtRevenueGlCode1; ?> "  class="form-control" >
...
3.2
			   ...
			   <label class="col-sm-4 pull-left control-label">Revenue GL Code-2</label>
				<div class="col-sm-5">
                  ...
                  <input type="text" disabled value="<?php echo $capex_row->revenue_gl_code2; ?> "  class="form-control" >

                </div>
				
				<div class="col-sm-2">
                 
                  <input type="text" disabled value="<?php echo $capex_row->amtRevenueGlCode2; ?> "  class="form-control" >
	...
	13
			   ...
			   <label class="col-sm-3 pull-left control-label">Source/ Supplier/ Agency</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" disabled name="cap_supllier" value="<?php echo $capex_row->cap_sel_supplier; ?>" readonly class="form-control" >
			...
			<div class="form-group col-sm-12">
			   ...
			   <label class="col-sm-4 pull-left control-label">Finance For(Asset Code) Comment</label>
				<div class="input-group  col-sm-6">
				  ...
				  <?php $approval2_name= $this->method_call->fetch_emp_name($capex_row->capex_approval2); ?>
					 ...
					 echo "Approval Pending From Asset Code Creatation  ($approval2_name)";
			   ...
			   <label class="col-sm-4 pull-left control-label">Sourcing Comment</label>
				<div class="input-group  col-sm-6">
				  ...
				  <?php $approval3_name= $this->method_call->fetch_emp_name($capex_row->qcs_emp_code); ?>

                                   <?php if($capex_row->capex_approval3_cmt == null){
					 echo "Approval Pending From Sourcing Department($approval3_name)";
