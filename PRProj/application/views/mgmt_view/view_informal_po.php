...
<head>
 ...
 <link rel="icon" type="image/ico" href="<?php echo base_url();?>assets/images/favicon"/>
...
<li class="active">View Informal PO                                                                                                                                                     
</li>
</li>
      </ol>
...
<!-- item detail  -->
 <div class="box-header with-border">
		...
		<tr>
				   ...
				   <th >Qty.</th>
				   <th >UOM</th>
				 <th colspan="4" style="color:#1E8449;"><center> Final Supplier :  &nbsp;<?php echo $po_row->selected_supplier; ?>   <center></th>
  ...
  <div class="box-header with-border">
		...
		<br>
                ...
                <tbody>
				 ...
				 <td colspan="7" style="color:#1E8449;"  ><b> Final Supplier   :&nbsp;&nbsp; <?php echo $po_row->selected_supplier; ?></b> </td>
...
<!--end -->
					    ...
					    <div class="table-responsive" style="width:100%;">
				<h4><b><h4>6.&nbsp;&nbsp;  Approval History</h4></b> </h4>
...
if($po_row->outside_budget == 'NO' && $po_row->pr_value == 'NO' && $po_row->order_value == 'NO' && $po_row->offers_received == 'NO' && $po_row->non_properitery_item == 'NO' && $po_row->properitery_item == 'NO' && $po_row->advance_bg == 'NO' && $po_row->post_grn_nonproprietary == 'NO' && $po_row->delivery_terms =='NO' && $po_row->post_grn_proprietary == 'NO')	
{ ?>
	  <div class="form-group col-sm-12">
...
else if($po_row->outside_budget == 'YES' && $po_row->pr_value == 'YES' && $po_row->order_value == 'YES' && $po_row->offers_received == 'YES' && $po_row->non_properitery_item == 'YES' && $po_row->properitery_item == 'YES' && $po_row->advance_bg == 'YES' && $po_row->post_grn_nonproprietary == 'YES' && $po_row->delivery_terms =='YES' && $po_row->post_grn_proprietary == 'YES')
{
	?>
	  <div class="form-group col-sm-12">
			  
			 <label class="pull-left control-label"><h4>9</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4>MD Office Comment</h4></label>
		<h5><div class="input-group  col-sm-6">
			<?php $emp_name= $this->method_call->fetch_emp_name($po_row->po_approval_level1); ?>

                 <?php if($po_row->po_approval_level1_cmt == null){
					 echo "Approval Pending From MD Office  ($emp_name)" ;
...
else if(($po_row->outside_budget == 'YES' || $po_row->pr_value == 'YES') &&( $po_row->order_value == 'NO' && $po_row->offers_received == 'NO' && $po_row->non_properitery_item == 'NO' && $po_row->properitery_item == 'NO' && $po_row->advance_bg == 'NO' && $po_row->post_grn_nonproprietary == 'NO' && $po_row->delivery_terms =='NO' && $po_row->post_grn_proprietary == 'NO'))
{
	?>
	  <div class="form-group col-sm-12">
...
else if(($po_row->outside_budget == 'NO' && $po_row->pr_value == 'NO') && ($po_row->order_value == 'YES' || $po_row->offers_received == 'YES' || $po_row->non_properitery_item == 'YES' || $po_row->properitery_item == 'YES' || $po_row->advance_bg == 'YES' || $po_row->post_grn_nonproprietary == 'YES' || $po_row->delivery_terms =='YES' || $po_row->post_grn_proprietary == 'YES'))
{
	?>
