						...
						<hr style="margin-bottom:0px;margin-top:0px">
							...
							<ul class="treeview-menu" style="background-color:#3481AE;">
									...
									<ul class="treeview-menu">
										<li>
											<a href="<?php echo site_url('purchase/Mgmt_ctr/pr_list') ?>" class="">
												<i class="fa fa-edit" style="color:#FFFFFF"></i> <span style="color:#FFFFFF">View PR</span>
											</a>
										</li> 
									</ul>
								</li>
									...
									<ul class="treeview-menu">
										<li>
											<a href="<?php echo site_url('purchase/Mgmt_ctr/qcs_list') ?>" class="">
												<i class="fa fa-edit" style="color:#FFFFFF"></i> <span style="color:#FFFFFF">View QCS</span>
											</a>
										</li> 
									</ul>
								</li>
									...
									<ul class="treeview-menu">
										<li>
											<a href="<?php echo site_url('purchase/Mgmt_ctr/itemcode_list') ?>" class="">
												<i class="fa fa-edit" style="color:#FFFFFF"></i> <span style="color:#FFFFFF">View Item Code</span>
											</a>
										</li> 
									</ul>
								</li>
									...
									<ul class="treeview-menu">
										<li>
											<a href="<?php echo site_url('purchase/Mgmt_ctr/informal_po_list') ?>" class="">
												<i class="fa fa-edit" style="color:#FFFFFF"></i> <span style="color:#FFFFFF">View Informal PO</span>
											</a>
										</li> 
									</ul>
								</li>
								<li class="treeview">
									<a href="#" class="">
										<i class="glyphicon glyphicon-list-alt" style="color:#FFFFFF"></i>
										<span style="color:#FFFFFF" >CAPEX</span>
										<span class="pull-right-container">
											<i class="fa fa-angle-down pull-right " style="color:#FFFFFF!important;font-size: 20px;font-weight: 900;"></i>
										</span>
									</a>
									<ul class="treeview-menu">
										<li>
											<a href="<?php echo site_url('purchase/capex/capex_create_list') ?>" class="">
												<i class="fa fa-edit" style="color:#FFFFFF"></i> <span style="color:#FFFFFF">View Capex</span>
											</a>
										</li> 
									</ul>
								</li>
