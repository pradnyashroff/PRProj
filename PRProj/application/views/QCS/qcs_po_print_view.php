...
<head>
 ...
 <link rel="shortcut icon" type="image/ico" href="assets/images/ruchalogo">
	  ...
	  <?php $qcs_detail= $this->method_call->informal_po_qcs_detail($informal_po_id);
 if($qcs_detail!=null){
...
<body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >
 ...
 <h4>
	  <label class="col-sm-12"style="text-align:center">Informal PO&nbsp;&nbsp;&nbsp;(Plant :- <?php echo $po_row->plant_code; ?>)</label>
...
<!--end -->
 ...
 <div class="form-group col-sm-12">
			  ...
			  <label class="pull-left control-label"><h4 class="box-body">2 .</h4></label>
			   <label class="col-sm-5 pull-left control-label"><h4 class="box-body">Final Supplier</h4></label>
				<div class="input-group  col-sm-6">
                 
          <h4 class="box-body">  <?php echo $po_row->selected_supplier; ?> </h4>
...
<!--end -->
				 ...
				 <div class="form-group col-sm-12">
				  <div class="box-header with-border">
					   <div class="box box-default ">
							<div class="box-header with-border">
								<h3 class="box-title" style="color:#3482AE;text-transform: uppercase;">6 . Approval History</h3>
...
foreach ($item->result() as $rowhistory)  
	 ...
	 <div class="form-group col-sm-12" id="q_attachement">
			  ...
			  <label class="pull-left control-label"><h4 class="box-body">7</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4 class="box-body">QCS Attachments </h4></label>
				<div class="input-group  col-sm-6">
 ...
 <?php }
			  ...
			  <label class="pull-left control-label"><h4 class="box-body">8</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4 class="box-body">Informal PO Attachments</h4></label>
			  	<div class="input-group  col-sm-6"> 
				<div class="form-group col-sm-12">
						 <div class="col-sm-5" >
		 ...
		 <div class="form-group col-sm-12">
			  ...
			  <label class="pull-left control-label"><h4 class="box-body">9</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4 class="box-body">Justification of Informal PO</h4></label>
			  	<div class="input-group  col-sm-6"> 
				<div class="form-group col-sm-12">
						 
								<h4 class="box-body"><?php  echo $po_row->just_informal_po; ?></h4>
...
<br><br><br>			<br><br><br>	<br><br><br>	<br><br><br>			<br><br><br>		
 ...
 <!-- QCS Start --->  
			 <h3>
	  <label class="col-sm-12"style="text-align:center">Cost Comparison Sheet &nbsp;&nbsp;&nbsp;(Plant :- <?php echo $po_row->plant_code; ?>)</label>
  </h3>  
	...
	<!-- po deatil -->
             <div class="box-header with-border">
					   <div class="box box-default">
					   <div class="box-header with-border">
              <h3 class="box-title">10 . QCS Details</h3>
   ...
   <?php echo $po_row->qcs_owner; ?>
    ...
    <?php echo $po_row->plant_code; ?>
			  ...
			  <input type="hidden" value="<?php echo $po_row->pr_type; ?>" style="background-color:#E6F2FF;" readonly   name="" class="form-control"  required>
...
<!--Item Details -->
  <div class="box-header with-border">
					   <div class="box box-default">
					   <div class="box-header with-border">
              <h3 class="box-title">11 . Item Details</h3>
		 ...
		 <input type="hidden" name="view_qcs_id" placeholder="" value="<?php echo $po_row->qcs_id; ?>" style="background-color:#E6F2FF;" readonly class="form-control"  required></td>
           <table id="exampletest" class="table table">
                <thead>
				<tr style="background-color:#3482AE;color:#FFFFFF;">
...
<!-- Technical specification -->
  <div class="box-header with-border">
					   <div class="box box-default">
					   <div class="box-header with-border">
              <h3 class="box-title">12. Technical Specification Comparison</h3>
		...
		<br>
			 ...
			 <td style="display:none" >  </td>
				 ...
				 <td colspan="3" ><b> <center>Supplier 1  :&nbsp;&nbsp; <?php echo $po_row->sup1_nm; ?><center></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
...
<!-- end -->
	 ...
	 <div class="form-group col-sm-12">
	  <div class="box-header with-border">
					   <div class="box box-default ">
							<div class="box-header with-border">
								<h3 class="box-title" style="color:#3482AE;text-transform: uppercase;">13 .  Approval History</h3>
 ...
 <?php $item= $this->method_call->po_qcs_approver_history_id($informal_po_id);
 if($item!=null){
