...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;">QCS Approved</li>
 ...
 <br><br>
	  ...
	  <?php 
	  $sourcing_mgr_approval1= $this->method_call->approved_list_by_sou_mgr($emp_code);
 if($sourcing_mgr_approval1!=null){
		  
foreach ($sourcing_mgr_approval1->result() as $row)  
         {  ?>
          ...
          <td><?php echo $row->pr_id;?></td>  
           ...
           <td><?php echo $row->plant_code;?></td>  
			...
			$sourcing_head_approval1= $this->method_call->approved_list_by_sou_head($emp_code);
 if($sourcing_head_approval1!=null){
		  
foreach ($sourcing_head_approval1->result() as $row)  
         {  ?>
	...
	//Approved 3 
			...
			$sourcing_cfo_approval1= $this->method_call->approved_list_by_cfo($emp_code);
 if($sourcing_cfo_approval1!=null){
		  
foreach ($sourcing_cfo_approval1->result() as $row)  
         {  ?>
           ...
           <td><?php echo $row->plant_code;?></td>  
			...
			$sourcing_coo_approval1= $this->method_call->approved_list_by_coo($emp_code);
 if($sourcing_coo_approval1!=null){
		  
foreach ($sourcing_coo_approval1->result() as $row)  
         {  ?>
           ...
           <td><?php echo $row->plant_code;?></td>  
			...
			$sourcing_mdo_approval1= $this->method_call->approved_list_by_mdo($emp_code);
 if($sourcing_mdo_approval1!=null){
		  
foreach ($sourcing_mdo_approval1->result() as $row)  
         {  ?>
