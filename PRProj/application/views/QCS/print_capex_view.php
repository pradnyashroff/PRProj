 ...
 if($q_capex_detail!=null){
	 foreach ($q_capex_detail->result() as $q_row)  
      ...
      <div class="box-body">
         ...
         <div class=" form-group col-sm-12" style="color:#3482AE;text-transform: uppercase;font-family:'exo';text-align:center;font-size:20px;">
    ...
    <tbody>
	  ...
	  <tr>
	   ...
	   <?php 
		...
		<td><?php echo $capex_row->actual_gl_code;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <b>Amount : </b> <?php echo $capex_row->amtGlCode1;?>  </td>
      </tr>
	  
	    <tr>
        <td>3.2</td>
		<td>Required Capital GL Code-2</td>
		<td><?php echo $capex_row->actual_gl_code2;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b> Amount : </b>  <?php echo $capex_row->amtGlCode2;?> </td>
      </tr>
		...
		<td><?php echo $capex_row->actual_gl_code3;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b> Amount : </b>  <?php echo $capex_row->amtGlCode3;?> </td>
      </tr>
		...
		<td><?php echo $capex_row->revenue_gl_code1;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b> Amount : </b>  <?php echo $capex_row->amtRevenueGlCode1;?> </td> </td>
      </tr>
		...
		<td><?php echo $capex_row->revenue_gl_code2;?>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b> Amount : </b>  <?php echo $capex_row->amtRevenueGlCode2;?> </td></td>
      </tr>
...
<!--end -->
			   ...
			   <label class="col-sm-1 pull-left control-label"><h4>4.</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4>Asset code Attachment</h4></label>
				<div class="input-group  col-sm-6">
				
						
						
						  <h5>  <b><a style="color: #337ab7;" href="<?php echo base_url()."uploads/assetFile_attach/". $capex_row->assetFile_attach ?>"> <?php echo $capex_row->assetFile_attach ?></a> </b></h5>
               </div>
                </div> 	
			   ...
			   <label class="col-sm-1 pull-left control-label"><h4>5</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4>CAPEX ION NO</h4></label>
				<div class="input-group  col-sm-6">
			   ...
			   <label class="col-sm-4 pull-left control-label"><h4>Release NO</h4></label>
				<div class="input-group  col-sm-6">
		 ...
		 <?php echo $capex_row->cpx_release_no;?>
						...
						<div class=" form-group col-sm-12" style="color:#3482AE;text-transform: uppercase;font-family:'exo';text-align:center;font-size:20px;">
						<span> <b> Cost Comparison Summary Sheet </b></span>
			...
			<div class="box-header with-border">
			  ...
			  <input type="hidden" value="<?php echo $capex_row->pr_type; ?>" readonly   name="" class="form-control"  required>
  ...
  <div class="box-header with-border">
		...
		<br>
			 ...
			 <td style="display:none" >  </td>
				 ...
				 <td colspan="3" ><b> <center>Supplier 1  :&nbsp;&nbsp; <?php echo $capex_row->sup1_nm; ?><center></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
			...
			<?php
				 $show_tech_spe= $this->method_call->detail_capex($capex_id);
...
foreach ($show_tech_spe->result() as $rowtech)  
 ...
 <div class="form-group col-sm-12">
				<h4><b><h4 style="color:#3482AE;text-transform: uppercase;font-family:'exo';"> 4. Approval History</h4></b> </h4>
			        <table id="example" class="table table-bordered table-striped display" style="font-size: 12px!important;">
                <thead>
 ...
 <?php $item= $this->method_call->capex_qcs_approver_history_id($capex_id);
 if($item!=null){
