...
<head>
  ...
  <title>Sourcing Head Approved level 2</title>
...
<body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >
  ...
  <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
    ...
    Sourcing Head Approved level 2
		<?php
if (isset($error)) {
...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;">Approval 2
</li>
</li>
      </ol>
 ...
 <div class="box-header with-border">
	...
	<span class="glyphicon glyphicon-edit"  data-toggle="modal" data-target="#pr_view_Modal"href="#pr_view_Modal<?php echo $row4->pr_id?>">&nbsp;<?php echo $row4->pr_id; ?></span>
	 ...
	 <input type="text" class="form-control" style="background-color:#E6F2FF;" readonly name="qcs_date" readonly value ="<?php echo $row4->qcs_date; ?>" >
           ...
           <td class="center" colspan="1"></td>
			...
			<!--end -->	
                ...
                <thead>
					...
					<th colspan="2" > <right><b> Final Supplier :&nbsp;&nbsp;   <?php echo $row4->sup1_nm; ?></b><right></th>
			
				
				 <th colspan="2"> <right><b>  Supplier 2  :&nbsp;&nbsp;   <?php echo $row4->sup2_nm; ?>  </b><right></th>
				 <th colspan="2"> <right><b>  Supplier 3  :&nbsp; &nbsp;   <?php echo $row4->sup3_nm; ?>  </b><right></th> 
            ...
            <th>  Final Total Amount (₹)</th>  
						...
						<td><right> <?php echo $final_rate; ?></right></td>
						<td><right> <?php echo $total_final_ammount1; ?></right></td>
						<td><right> <?php echo $total_quoted_amount2; ?></right></td>
						<td><right> <?php echo $total_final_ammount2; ?></right></td>
						<td><right> <?php echo $total_quoted_amount3; ?></right></td>
						<td><right> <?php echo $total_final_ammount3; ?></right></td>
                <tbody>
...
<div class="col-sm-4">
	...
	<!-- View Item -->
<div class="col-sm-4">
<button type="button" id="item_btnold" data-toggle="modal" data-target="#myModalEdit" class="btn" style="width: 50%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Detailed View</button>
</div>
 ...
 <!--  <input type="hidden" name="temp_qcs_id" placeholder="" value="<?php echo $pr_id.$emp_code; ?>" style="background-color:#E6F2FF;" readonly class="form-control"  required> -->
		...
		<br>
			 ...
			 <td style="display:none" >  </td>
				 ...
				 <td colspan="3"  ><b> <right>Final Supplier  :&nbsp;&nbsp; <?php echo $row4->sup1_nm; ?><right></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3"  ><b><right>Supplier 2  :&nbsp;&nbsp;<?php echo $row4->sup2_nm; ?><right></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3" ><b><right>Supplier 3  :&nbsp;&nbsp;<?php echo $row4->sup3_nm; ?><right></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
...
<div class="col-sm-5">			  
		...
		<div class="col-sm-5"style="color:#3482AE;">	   
			   	<?php 
						if($row4->advance_25 == 'YES'){
							?>
						
						<span>( <?php echo $row4->just_advance_25; ?> ) </span>
...
<!--end -->
		   ...
		   <!-- start -->
			 ...
			 <label class="pull-left control-label"><h4>10.</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4>Approval Status </h4></label>
			 ...
			 <td style="display:none" >  </td>
								 ...
								 <td style="display:none"> </td>
				<td colspan="4" ><right> Approver Name <right> </td>
				 <td colspan="4" ><right>Approval Date/Time  <right> </td>
				
				 <td colspan="4" > <right>Approval Comment   <right> </td>
  ...
  <?php
	  ...
	  <tr>
			 ...
			 <td style="display:none" >  </td>
				 ...
				 <td colspan="4"  >  <input type="text" style="background-color:#E6F2FF;" value="<?php echo $nullDate?>" class="form-control full_width" readonly  > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
			 ...
			 ?>
			  <td colspan="4"  >  <input type="text" style="background-color:#E6F2FF;" readonly value=" Approval Pending From Sourcing Manager " class="form-control full_width"   > </td>
				...
				<?php	 
					 ...
					 ?>
				  <td colspan="4"  >  <input type="text" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value=" <?php echo $row4->approval_level1_comment ?> " class="form-control full_width"   > </td>
  ...
  <?php
	  ...
	  <tr>
	  	 <?php 
			 ...
			 <td style="display:none" >  </td>
			 <td style="display:none" >  </td>
				 <td colspan="4"  >  <input type="text" style="background-color:#E6F2FF;" value="<?php echo $sourcing_mgr_name?>"  class="form-control full_width" readonly style="background-color:#E6F2FF;">  </td>
				 <td colspan="4"  >  <input type="text" style="background-color:#E6F2FF;" value="<?php echo $nullDate?>" class="form-control full_width" readonly  style="background-color:#E6F2FF;" > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				 ...
				 if($row4->approval_level2_comment == null){
					 ?>
					 <td colspan="4"  >  <input type="text"readonly style="background-color:#E6F2FF;" value="Approval Pending From Sourcing Head" class="form-control full_width"   > </td>
					 <?php
				 }else{
				 ?>
				  <td colspan="4"  >  <input type="text"readonly style="background-color:#E6F2FF;" value="<?php echo $row4->approval_level2_comment ?>" class="form-control full_width"   > </td>
				 <?php
				 }
				?>				 
  ...
  <?php
	  ...
	  <tr>
	   <?php 
			 ...
			 <td style="display:none" >  </td>
				 <td colspan="4"  >  <input type="text" value="<?php echo $sourcing_mgr_name?>"  class="form-control full_width"  style="background-color:#E6F2FF;" readonly> </td>
				 <td colspan="4"  >  <input type="text" value="<?php echo $nullDate?>" class="form-control full_width" readonly style="background-color:#E6F2FF;"  > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				 ...
				 if($row4->approval_level2_comment == null){
					 ?>
					 <td colspan="4"  >  <input type="text" value="Approval Pending From Sourcing Head" style="background-color:#E6F2FF;" class="form-control full_width" readonly  > </td>
					 <?php
				 }else{
				 ?>
				  <td colspan="4"  >  <input type="text" value="<?php echo $row4->approval_level2_comment ?>" style="background-color:#E6F2FF;" class="form-control full_width" readonly  > </td>
				 <?php
				 }
				?>				 
	  ...
	  <?php 
			 ...
			 <td style="display:none" >  </td>
				 ...
				 <?php
				   if($row4->approval_level3_comment == null){
					   ?>
					   <td colspan="4"  >  <input type="text" value="Approval Pending From CFO" style="background-color:#E6F2FF;" class="form-control full_width" readonly  > </td>
					 <?php
					 
				 }else{
					 ?>
				  <td colspan="4"  >  <input type="text" value="<?php  echo $row4->approval_level3_comment?>" style="background-color:#E6F2FF;" class="form-control full_width"  readonly > </td>
				  <?php
				 }
				 ?>
	  	  ...
	  	  <?php 
			 ...
			 <td style="display:none" >  </td>
				 ...
				 <?php
				  if($row4->approval_level4_comment == null){
				 ?>
				  <td colspan="4"  >  <input type="text" value="Approval Pending From COO" style="background-color:#E6F2FF;" class="form-control full_width" readonly> </td>
				<?php
					
					 
				 }else{
					 ?>
				  <td colspan="4"  >  <input type="text" value="<?php  echo $row4->approval_level4_comment?>" style="background-color:#E6F2FF;"  class="form-control full_width" readonly> </td>
				  <?php
				 }
				 ?>
				 <td style="display:none" >  </td>
	 ...
	 ?>
	  ...
	  <tr>
	   <?php 
			 ...
			 <td style="display:none" >  </td>
			 <td style="display:none" >  </td>
				 <td colspan="4"  >  <input type="text" value="<?php echo $cfo_name?>" style="background-color:#E6F2FF;" class="form-control full_width"   readonly> </td>
				 <td colspan="4"  >  <input type="text" value="<?php echo $nullDate?>" style="background-color:#E6F2FF;" class="form-control full_width"  readonly > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
...
?>
	...
	?>
		  <!--end-->	
			...
			<form method="post" id="main_form" action="<?php echo site_url('purchase/QCS/approve_sourcing_head') ?>" enctype='multipart/form-data'>
...
<?php
	if($row4->pr_type == '13'&& $row4->outside_budget == 'NO' && $row4->order_value == 'NO' && $row4->offers_received == 'NO' && $row4->non_properitery_item == 'NO' && $row4->properitery_item == 'NO' && $row4->post_grn_proprietary == 'NO' && $row4->post_grn_nonproprietary == 'NO' && $row4->delivery_terms == 'NO' )
	{
		...
		<div class="form-group col-sm-12">
			 ...
			 <label class="col-sm-4 pull-left control-label">Approve / Reject</label>
			   <div class="input-group  col-sm-6">
			  <input type="radio" name="qcs_state" value="COO_Approved" required >&nbsp;&nbsp; APPROVE</input> 
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			 <input type="radio" name="qcs_state" value="COO_Reject" >&nbsp;&nbsp REJECT</input>
		...
		<div class="form-group col-sm-12">
			 ...
			 <label class="col-sm-4 pull-left control-label">Approve / Reject</label>
			   <div class="input-group  col-sm-6">
			  <input type="radio" name="qcs_state" value="Sourcing_Head_Approved" required >&nbsp;&nbsp; APPROVE</input> 
			   
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 
                                    <input type="radio" name="qcs_state" value="Sourcing_Head_Reject" > &nbsp;&nbsp; REJECT</input>
			 ...
			 <label class="pull-left control-label">12</label>
			   <label class="col-sm-4 pull-left control-label">Approver Comment</label>
				<div class="input-group  col-sm-6">
                 ...
                 <!--<textarea class="form-control" rows="4" cols="50" name="sourcing_head_app_cmt" required> </textarea>-->
                 
                  <textarea name="sourcing_head_app_cmt" maxlength="250"  rows="4" cols="50"  required ></textarea>
                      <div id="the-count">
...
<div class="col-sm-2"> <a href="<?php echo site_url('purchase/QCS/Qcs_master_draft') ?>" class="btn" style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Cancel</a></div>
				...
				<div class="col-sm-4">
				 ...
				 <input type="hidden"  name="qcs_num" value="<?php echo $row4->qcs_id; ?>" readonly style="background-color:#E6F2FF;" class="form-control"  required> 
				   ...
				   <input type="hidden" style="background-color:#E6F2FF;" readonly name="pr_id" value="<?php echo $row4->pr_id; ?>" class="form-control"  required>
				    ...
				    <input type="hidden" style="background-color:#E6F2FF;" readonly name="qcs_emp_code" value="<?php echo $row4->qcs_emp_code; ?>" class="form-control"  required>
				     ...
				     <input type="hidden" style="background-color:#E6F2FF;" readonly name="qcs_emp_nm" value="<?php echo $emp_name; ?>" class="form-control"  required>
  ...
  <?php $eid_owner= $this->method_call->fetchemp_email($row4->approval_level3); ?>
  <input type="text" name="approval3_email" value="<?php print_r($eid_owner['emp_email']); ?>" style="background-color:#E6F2FF;" readonly  class="form-control"  >
	...
	<input type="Text" name="pr_plant" class="form-control" style="background-color:#E6F2FF;"  readonly value="<?php echo $row4->pr_id; ?>" required>     
			  ...
			  <label class="col-sm-1 pull-left control-label">5</label>
			   <label class="col-sm-5 pull-left control-label">PR Type</label>
				<div class="input-group  col-sm-6">
			<?php $pt_name= $this->method_call->fetch_prtype_nm($row4->pr_type); ?>
						   <input type="Text" name="pr_dept" style="background-color:#E6F2FF;" class=" form-control" id="pr_dept" readonly value="<?php print_r($pt_name['pt_name']); ?>"  required>
                </div>
                </div>
           ...
           <table id="exampletest" class="table table">
                <thead>
                  ...
                  <th >Sr. No.</th>
				   ...
				   <th >Qty.</th>
				   <th >UOM</th>
				 <th colspan="4" ><right> 1. <?php echo $row4-> sup1_nm; ?>  <right></th>
			
				
				 <th colspan="4" > <right>2. <?php echo $row4-> sup2_nm; ?>  <right></th>
				 <th colspan="4" > <right>3. <?php echo $row4-> sup3_nm; ?>   <right></th>
