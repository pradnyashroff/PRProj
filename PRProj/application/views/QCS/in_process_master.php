...
<li class="active"style="color:#FFFFFF;text-transform: uppercase;">  In Process QCS Master </li>
 ...
 <br><br><table id="example" class="table table">
				...
				<?php
				 ...
				 $pr_approved_source= $this->method_call->list_pr_approved_sourcing($emp_code);
...
foreach ($pr_approved_source->result() as $row)  
         {  ?>
            ...
            <td >  <a href="<?php echo site_url('purchase/QCS/view_qcs/'.$row->pr_id);?>"> PR <?php echo $row->pr_id;?> </a></td>  
