...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;"> Approved  QCS</li>
 ...
 <br><br>
	...
	<!--approval level 1 list -->
	  ...
	  <?php $qcs_approval1= $this->method_call->list_approved_qcs($emp_code);
...
foreach ($qcs_approval1->result() as $row)  
         {  ?>
            ...
            <td >  <a href="<?php echo site_url('purchase/QCS/qcs_approved_view/'.$row->qcs_id);?>"> QCS <?php echo $row->qcs_id;?> </a></td>  
