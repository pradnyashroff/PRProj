  ...
  <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
   ...
   Approval Capex
     ...
     <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
       ...
       <li> <a href="<?php echo site_url('purchase/capex/index') ?>" style="color:#FFFFFF;text-transform: uppercase;">Capex</a></li>

<li class="active" style="color:#FFFFFF;text-transform: uppercase;">Approval Capex</li>
 ...
 <br><br><table id="example" class="table table-bordered table-striped">
		   	...
		   	<!-- approval 4 -->	
				 ...
				 $approval3_list = $this->method_call->capex_approval4_pending_list($emp_code);
...
foreach ($approval3_list->result() as $row)  
		...
		<tr>  
            ...
            <td >  <a href="<?php echo site_url('purchase/QCS/approval4_capex/'.$row->capex_id);?>"> Capex <?php echo $row->capex_id;?> </a></td> 
