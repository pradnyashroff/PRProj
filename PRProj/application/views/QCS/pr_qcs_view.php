...
<body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >
      	   ...
      	   <?php include_once 'headsidelist1.php'; ?>
...
?>
     ...
     <ol class="breadcrumb" style="color:#FFFFFF;">
        <li><a href="<?php echo site_url('Welcome/index') ?>" style="color:#FFFFFF;"><i class="fa fa-dashboard"></i> Home</a></li>
         <li> <a href="<?php echo site_url('purchase/QCS/index') ?>" style="color:#FFFFFF;">QCS</a></li>

<li class="active" style="color:#FFFFFF;">Approved QCS
</li>
</li>
      </ol>
 ...
 <div class="box-header with-border">
					   ...
					   <div class="box-header with-border">
              <h3 class="box-title" style="color:#3482AE">1 . Basic QCS Details</h3>
    ...
    <input type="text" readonly name="pr_dept" value="<?php echo($dept_nm['dept_name']); ?>" class="form-control"  required>              
			  ...
			  <label class="col-sm-1 pull-left control-label">4</label>
			   <label class="col-sm-4 pull-left control-label">QCS Owner</label>
				<div class="input-group  col-sm-6">
    <input type="text" readonly name="qcs_owner_nm" style="background-color:#E6F2FF" value="<?php echo $row4->qcs_owner; ?>" class="form-control"  required>              
			  ...
			  <label class="col-sm-1 pull-left control-label">5</label>
			   <label class="col-sm-4 pull-left control-label">Plant</label>
				<div class="input-group  col-sm-6">
    <input type="text" readonly name="pr_code" style="background-color:#E6F2FF" value="<?php echo $row4->plant_code; ?> " class="form-control"  required>              
...
<!--Cost comparision  -->
  <div class="box-header with-border">
					   <div class="box box-default">
					   <div class="box-header with-border">
              <h3 class="box-title" style="color:#3482AE">2 . Cost Comparison Summary</h3>
...
<div class="col-sm-4">
	...
	<!-- View Item -->
<div class="col-sm-4">
<button type="button" id="item_btnold" data-toggle="modal" data-target="#myModalEdit" class="btn" style="width: 40%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);">Detailed View</button>
</div>
...
<!-- Quotation Attachments -->
 <div class="box-header with-border">
					   <div class="box box-default collapsed-box">
					   <div class="box-header with-border">
              <h3 class="box-title" style="color:#3482AE">4 . Quotation Attachments</h3>
...
<!-- self declaration -->
 ...
 <div class="box-header with-border">
					   <div class="box box-default collapsed-box">
					   <div class="box-header with-border">
              <h3 class="box-title" style="color:#3482AE">5 . Self Declaration</h3>
...
<!--end -->		
 ...
 <div class="box-header with-border">
					   <div class="box box-default">
					   <div class="box-header with-border">
              <h3 class="box-title" style="color:#3482AE">9 &nbsp; Approver History</h3>
  ...
  ; border-color:#3482AE;text-align: center; width:100%;box-shadow: 12px 15px 20px 10px rgba(46,61,73,0.15);">
				...
				<th scope="col" style="text-align: center;"> QCS ID</th>
			
				<th scope="col" style="text-align: center;">Approver Name</th>				
				<th scope="col" style="text-align: center;"> Approver Comment </th>
				<th scope="col" style="text-align: center;"> Approver Status</th>  				
...
foreach ($item->result() as $rowhistory)  
         {   $appver_name= $this->method_call->fetch_emp_name($rowhistory->approval_emp_code); ?>
			...
			<tr>
				 <td style="text-align: center;">  <?php echo $rowhistory->qcs_id; ?></td>
				 
				 <td style="text-align: center;"><?php echo $appver_name; ?></td>
				 <td style="text-align: center;"  ><?php echo $rowhistory->approval_comment; ?></td> 
				 
			<td style="text-align: center;"><?php echo $rowhistory->approver_status; ?></td>
			<td style="text-align: center;"><?php echo $rowhistory->approval_date; ?></td>
			</tr>
 ...
 $approval_level1= $this->method_call->fetch_status_sourcing_mgr($qcs_id,$row4->approval_level1);
	?>
	  ...
	  <tr>
			 ...
			 <td style="display:none" >  </td>
			 <td style="display:none" >  </td>
				 <td colspan="4" style="text-align: center;" >  <input type="text" readonly value="<?php echo $sourcing_mgr_name ?>" class="form-control full_width"   required> </td>
				 <td colspan="4" style="text-align: center;" >  <input type="text" readonly value=" <?php echo $approval_level1 ?>" class="form-control full_width"   > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				<?php 		 
		 if($row4->approval_level1_comment == null){
			 ?>
			  <td colspan="4" style="text-align: center;" >  <input type="text" readonly value=" Approval Pending From Sourcing Manager " class="form-control full_width"   > </td>
					 
				<?php	 
				 }else{
					 ?>
				  <td colspan="4" style="text-align: center;" >  <input type="text" readonly value=" <?php echo $row4->approval_level1_comment ?> " class="form-control full_width"   > </td>
  ...
  <?php
	  ...
	  <tr>
			 ...
			 <td style="display:none" >  </td>
			 <td style="display:none" >  </td>
				 <td colspan="4" style="text-align: center;" >  <input type="text" value="<?php echo $sourcing_mgr_name?>"  class="form-control full_width" readonly> </td>
				 <td colspan="4" style="text-align: center;" >  <input type="text" value="<?php echo $approval_level2?>" class="form-control full_width" readonly  > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				 ...
				 if($row4->approval_level2_comment == null){
					 ?>
					 <td colspan="4" style="text-align: center;" >  <input type="text"readonly value="Approval Pending From Sourcing Head" class="form-control full_width"   > </td>
					 <?php
				 }else{
				 ?>
				  <td colspan="4" style="text-align: center;" >  <input type="text"readonly value="<?php echo $row4->approval_level2_comment ?>" class="form-control full_width"   > </td>
				 <?php
				 }
				?>				 
	...
	?>
	  ...
	  <tr>
		 ...
		 if($row4->approval_level3_comment == null){
			 ?>
			  <td colspan="4"  >  <input type="text" readonly value=" Approval Pending From MDO Office " class="form-control full_width"   > </td>
					 
				<?php	 
				 }else{
					 ?>
				  <td colspan="4"  >  <input type="text" readonly value=" <?php echo $row4->approval_level3_comment ?> " class="form-control full_width"   > </td>
			 ...
			 ?>
			  <td colspan="4"  >  <input type="text" readonly value=" Approval Pending From MDO Office " class="form-control full_width"   > </td>
				...
				<?php	 
					 ...
					 ?>
				  <td colspan="4"  >  <input type="text" readonly value=" <?php echo $row4->approval_level5_comment ?> " class="form-control full_width"   > </td>
...
?>
	...
	<div class="form-group col-sm-2">
			 ...
			 <a href="<?php echo site_url('purchase/QCS/qcs_print/'.$row4->qcs_id) ?>" class="btn" style="width: 80%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);">
...
<div class="modal-dialog" role="document" style="width:1200px;">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#3482AE;">
        ...
        <h4 class="modal-title" style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">View Items in QCS</h4>
      </div>
