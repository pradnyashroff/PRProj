...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;"> QCS View
 ...
 <div class="box-header with-border">
	 ...
	 <input type="text" class="form-control" style="background-color:#E6F2FF;" readonly name="qcs_date"  style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value ="<?php echo $row4->qcs_date; ?>" >
    ...
    <input type="text" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly name="pr_code" value="<?php echo $row4->plant_code; ?> " class="form-control"  required>              
			  ...
			  <input type="hidden" value="<?php echo $row4->pr_type; ?>" style="background-color:#E6F2FF;" readonly style="background-color:#E6F2FF;"  name="" class="form-control"  required>
  
  <?php $pt_name= $this->method_call->fetch_prtype_nm($row4->pr_type); ?>
  <input type="text" name="" value="<?php print_r($pt_name['pt_name']); ?>" style="background-color:#E6F2FF;" readonly style="background-color:#E6F2FF;" class="form-control"  required>
...
<!--end -->
			        ...
			        <table id="example" class="table table" style="font-size: 12px!important;">
                <thead>
...
<!--Cost comparision  -->
  <div class="box-header with-border">
              ...
              <!-- /.box-tools -->
			   ...
			   <div class="box-body">
						   <div class="form-group col-sm-12 hidden">
			        <table id="example6" class="table table" style="font-size: 12px!important;">
                <thead>
           ...
           <td class="right" colspan="1"></td>
			...
			<!--end -->	
                ...
                <thead>
					...
					<th colspan="2" style="border:none;"> <center><b> Supplier 1  :&nbsp;&nbsp;   <?php echo $row4->sup1_nm; ?></b><center></th>
...
<div class="col-sm-4">
	...
	<!-- View Item -->
<div class="col-sm-4">
<button type="button" id="item_btnold" data-toggle="modal" data-target="#myModalEdit" class="btn" style="width: 40%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);text-transform: uppercase;font-family:'exo';">Detailed View</button>
</div>
...
<!--end -->
   ...
   <!-- start -->
	<div class="box-header with-border">
					   <div class="box box-default">
					   <div class="box-header with-border">
              <h3 class="box-title">6. &nbsp; Approval Status</h3>
...
?>
 ...
 <div class="box-header with-border">
					   <div class="box box-default">
					   <div class="box-header with-border">
              <h3 class="box-title">7 &nbsp; Approver History</h3>
 ...
 <div class="form-group col-sm-12">
	...
	<div class="form-group col-sm-12">
         ...
         <?php echo $row4->justification_supplier; ?>
			 ...
			 <div class="form-group col-sm-12"> 
			  <div class="form-group col-sm-4">
			       ...
			       <div class="form-group col-sm-4">
			<?php
				if($row4->qcs_emp_code == $emp_code AND  ($row4->qcs_status=='Sourcing_Head_Reject' ||$row4->qcs_status=='Sourcing_Mgr_reject' ||$row4->qcs_status=='CFO_Reject'
				||$row4->qcs_status=='COO_Reject'|| $row4->qcs_status =='QCS_Reject'))
				{?>
				<a href="<?php echo site_url('purchase/QCS/draft_qcs_step_one/'.$row4->qcs_id) ?>" class="btn" style="width: 50%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);text-transform: uppercase;font-family:'exo';">
          <span class=""></span> Move To QCS Draft 
        </a>
		<?php		}
				else{
		...
		<!--
			 ...
			 <label class="pull-left control-label">15</label>
			...
			<?php $cfo_name= $this->method_call->fetch_emp_name($row4->approval_level3); ?>
			 ...
			 <label class="pull-left control-label">16</label>
		...
		-->
			 ...
			 <a href="<?php echo site_url('purchase/QCS/qcs_print/'.$row4->qcs_id) ?>" class="btn bg-skincolor btn-lg">
...
-->
  <form method="post" id="" action="" >
           ...
           <table id="exampletest" class="table table" style="font-size: 12px!important;">
                <thead>
					<tr style="background-color:#3482AE;color:#FFFFFF;">
                ...
                <tr >
                				 <th colspan="6" style="text-align:right;"style="border:none;"></th>
...
<div class="modal-dialog" role="document" style="width:980px;">
  ...
  <form method="post" id="" action="" >
	...
	<input type="Text" name="pr_plant" class="form-control" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php echo $row4->pr_id; ?>" required>     
			  ...
			  <label class="col-sm-1 pull-left control-label">2</label>
			   <label class="col-sm-5 pull-left control-label">PR Owner nm</label>
				<div class="input-group  col-sm-6">
				<input type="Text" name="pr_owner_name" class="form-control" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php echo $row4->pr_owner_name; ?>" required>  
			  ...
			  <label class="col-sm-1 pull-left control-label">3</label>
			   <label class="col-sm-5 pull-left control-label">Plant</label>
				<div class="input-group  col-sm-6">
				<input type="Text" name="pr_plant" class="form-control" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php echo $row4->plant_code; ?>" required>  
	  ...
	  <div class="form-group col-sm-6">
			  ...
			  <label class="col-sm-1 pull-left control-label">5</label>
			   <label class="col-sm-5 pull-left control-label">PR Date</label>
				<div class="input-group  col-sm-6">
			  <input type="Text" name="pr_dept" class=" form-control" id="pr_dept" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php echo $row4->pr_date; ?>"  required>
                </div>
                </div>
	    ...
	    <div class="form-group col-sm-12">
			        <table id="exam" class="table table" style="font-size: 12px!important;">
                <thead>
             <tr style="background-color:#3482AE;color:#FFFFFF;">
                  <th ></th>
