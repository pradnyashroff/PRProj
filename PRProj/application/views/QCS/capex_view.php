 ...
 <div class="box-header with-border">
              ...
              <!-- /.box-tools -->
			   ...
			   <div class="box-body">
					...
					<input type="hidden" name="capex_emp_code" class=" form-control" style="background-color:#E6F2FF;" readonly value="<?php echo $emp_code; ?>"  required>                          
			  ...
			  <label class="col-sm-1 pull-left control-label">4</label>
			   <label class="col-sm-4 pull-left control-label">Department</label>
				...
				<?php $dept_nm= $this->method_call->fetch_dept_nm($q_row->dept_id); ?>
				 ...
				 <input type="text" class="form-control" style="background-color:#E6F2FF;" readonly name="cpx_date" value="<?php print_r($dept_nm['dept_name']); ?>">
		 ...
		 <div class="form-group col-sm-4">
			  ...
			  <label class="col-sm-1 pull-left control-label">6</label>
			   <label class="col-sm-4 pull-left control-label">QCS Owner </label>
				<div class="input-group  col-sm-6">
				<input type="Text"  class=" form-control" name ="q_owner" value="<?php echo $q_row->qcs_owner; ?>" style="background-color:#E6F2FF;" readonly   required>                          
		 ...
		 <div class="form-group col-sm-4">
			  ...
			  <label class="col-sm-1 pull-left control-label">7</label>
			   <label class="col-sm-4 pull-left control-label">QCS Date </label>
				<div class="input-group  col-sm-6">
  <input type="text" name="dft_q_date" class=" form-control" value="<?php echo $q_row->qcs_date; ?>" style="background-color:#E6F2FF;" readonly   required>                          
...
2
			   ...
			   <label class="col-sm-3 pull-left control-label">Master Asset GL Code</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" disabled style="background-color:#E6F2FF;" value="<?php echo $capex_row->master_gl_code; ?> " name="dft_asset_gl_code"  class="form-control" >
...
3.1
			   ...
			   <label class="col-sm-4 pull-left control-label">Required Capital GL Code-1</label>
				<div class="col-sm-5">
                  ...
                  <input type="text" disabled style="background-color:#E6F2FF;" value="<?php echo $capex_row->actual_gl_code; ?> "  class="form-control" >

                </div>
				
				<div class="col-sm-2">
                 
                  <input type="text" disabled style="background-color:#E6F2FF;" value="<?php echo $capex_row->amtGlCode1; ?> "  class="form-control" >
...
foreach ($view_item->result() as $rowitem)  
        ...
        <tr>
			...
			<td class="right "><B><?php echo $total_final_ammount1; ?></b></td>
				...
				<input type="hidden" style="background-color:#E6F2FF;" name="grand_total" value="<?php echo  $total_final_ammount1; ?>" readonly class="form-control" >
...
<!--end -->
		 ...
		 <?php echo $capex_row->cpx_release_no;?>
				...
				<?php 
		if($capex_row->capex_owner_code== $emp_code && ($capex_row->capex_status=="capex_rejected_by_mds" || $capex_row->capex_status=="capex_rejected_by_finance"||
			$capex_row->capex_status=="capex_rejected_by_asset_dept"||$capex_row->capex_status=="capex_rejected"))
			{
			?>
...
<a href="<?php echo site_url('purchase/capex/draft_capex/'.$capex_row->capex_id) ?>"  class="btn  bg-skincolor pull-right" style="border: 1px solid orange;width: 100%; ">Move To Draft</a>
</div>
...
<a href="<?php echo site_url('purchase/QCS/print_capex_view/'.$capex_row->capex_id) ?>"  class="btn" style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);text-transform: uppercase;">Print</a>
</div>
	...
	<input type="Text" name="pr_plant" class="form-control" style="background-color:#E6F2FF;"  readonly value=" <?php echo $capex_row->pr_id;  ?> "  required>     
			  ...
			  <label class="col-sm-1 pull-left control-label">2</label>
			   <label class="col-sm-5 pull-left control-label">PR Owner nm</label>
				<div class="input-group  col-sm-6">
				<input type="Text" name="pr_owner_name" style="background-color:#E6F2FF;" class="form-control"  readonly value="<?php echo $capex_row->pr_owner_name;  ?>" required>  
