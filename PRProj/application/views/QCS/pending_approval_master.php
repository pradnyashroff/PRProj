...
<head>
  ...
  <title>Pending Approval Sourcing</title>
 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
    ...
    <section class="content-header">
     ...
     Pending Approval (Submited PR to Sourcing)
...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;"> Pending Approval Master (Sourcing) </li>
 ...
 <br><br>
              <table id="example" class="table table">
				...
				<?php
				 ...
				 $pr_approved_ph= $this->method_call->list_pr_approved_ph($emp_code);
 if($pr_approved_ph!=null){
	 	   
	$sr_no=1;			  
foreach ($pr_approved_ph->result() as $row)  
         {  ?>
			
			
			<tr>  
            <td style="display:none;"><?php echo $row->pr_id;?></td>  
            <td >  <a href="<?php echo site_url('purchase/QCS/create_qcs/'.$row->pr_id);?>"> PR <?php echo $row->pr_id;?> </a></td>  
