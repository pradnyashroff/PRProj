...
<li class="active">  Employee Details
 ...
 <form method="post" id="form" action="<?php echo site_url('purchase/QCS/emp_profile_update') ?>" enctype='multipart/form-data'>
...
<div class="form-group col-sm-12">
          ...
          <input type="text" value=" <?php echo $row->pr_dh_id;  ?>"  name="pr_dh_id"readonly required class="form-control" >
              ...
              <div class="box-footer">
			   ...
			   <button type="submit" class="btn  bg-skincolor "  id="btn_submit" style="border: 1px solid orange;width: 100%;">Update</button>
			   	</div>
				 <div class="col-sm-2">
                <a href="<?php echo site_url('purchase/PR/index') ?>" class="btn  bg-skincolor pull-right" style="border: 1px solid orange;width: 100%; ">Cancel</a>
				</div>
                 <div class="col-sm-4">
				</div>
                 </div>
