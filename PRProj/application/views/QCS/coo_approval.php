...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;">COO Approval
</li>
</li>
      </ol>
...
<!--end -->
			...
			<form method="post" id="main_form" action="<?php echo site_url('purchase/QCS/approve_coo') ?>" enctype='multipart/form-data'>
		
	<?php
     if($row4->pr_type != '13' && $row4->outside_budget == 'NO' && $row4->order_value == 'NO' && $row4->offers_received == 'NO' && $row4->cost_reimb_cust == 'NO' && $row4->repl_cost_agreed == 'NO' && $row4->advance_bg == 'NO' && $row4->advance_25 == 'NO' && $row4->paymt_trm_grn_90 == 'NO' && $row4->imported_item == 'NO' )
	{
		?>
		<div class="form-group col-sm-12">
			 
			 <label class="pull-left control-label">10</label>
			 <label class="col-sm-5 pull-left control-label">Action</label>
			   <div class="input-group  col-sm-6">
			 ...
			 <label class="pull-left control-label">11</label>
         	 ...
         	 <textarea name="coo_app_cmt" maxlength ="250" rows="4" cols="50"  required ></textarea>
		...
		<div class="form-group col-sm-12">
			 ...
			 <label class="col-sm-4 pull-left control-label">Action</label>
			  ...
			  <input type="radio" name="qcs_state" value="COO_Approved" required > APPROVE</input> 
			   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="qcs_state" value="COO_Reject" > REJECT</input>
			 ...
			 <label class="pull-left control-label">11</label>
         	 ...
         	 <textarea name="coo_app_cmt" rows="4" cols="50"  required ></textarea>
                </div>
                </div>
...
<!-- Pr owner EID-->
  ...
  <input type="text" name="mdo_email" value="<?php print_r($eid_owner['emp_email']); ?>" style="background-color:#E6F2FF;" readonly  class="form-control"  required>
