	...
	if($row->cust_cost == 'Up Front'){
	  $lab='Customer Cost Rs.';
	   ...
	   $lab='ROI Period (In Months)';
			 ...
			 <label class="col-sm-1 pull-left control-label">11</label>
			   <label class="col-sm-5 pull-left control-label">Department Head Comment</label>
				<div class="input-group  col-sm-6">
			 ...
			 <label class="col-sm-1 pull-left control-label">12</label>
			   <label class="col-sm-5 pull-left control-label">Plant Head Comment</label>
				<div class="input-group  col-sm-6">
...
<button type="button" onclick="window.print();" id= "printbtn" class="btn" style="width: 10%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">PDF</button>
			...
			<?php	 } ?>
			  ...
			  <div class="box-header with-border">
					   <div class="box box-default">
					   <div class="box-header with-border">
              <h3 class="box-title">14. &nbsp; QCS History</h3>
              ...
              <!-- /.box-tools -->
			   ...
			   <div class="box-body">
                ...
                <tbody>
	 				  ...
	 				  <?php $item= $this->method_call->qcs_history($pr_id);
 if($item!=null){
...
foreach ($item->result() as $row5)  
         {  ?>
			<tr>
				 ...
				 <td  ><?php echo $row5->qcs_date; ?> </td>
				 <td  ><?php echo $row3->project_detail; ?></td> 
				 
			<td><?php echo $row5->qcs_status; ?></td>
			</tr>
 ...
 ?>
		...
		<input type="hidden" name="pr_dh_id" value="<?php echo $row->dh_id;  ?>" class="form-control"  required>
		  ...
		  <div class="form-group col-sm-12" id="q_btn">
			...
			<center>
			 <a href="<?php echo site_url('purchase/QCS/qcs_step_one/'.$row->pr_id) ?>" class="btn" style="width: 15%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">
          <span class="glyphicon glyphicon-plus-sign"></span> Create New QCS
        </a>
			  </center>
              </div>
