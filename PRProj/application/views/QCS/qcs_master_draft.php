...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;"> Draft QCS </li>
 ...
 <br><br>
              <table id="example" class="table table">
                ...
                <tbody>
				  ...
				  <?php $pr= $this->method_call->list_qcs_draft($emp_code);
 if($pr!=null){
...
foreach ($pr->result() as $row)  
         {  ?>
            ...
            <td >  <a href="<?php echo site_url('purchase/QCS/draft_qcs_step_one/'.$row->qcs_id);?>"> QCS <?php echo $row->qcs_id;?> </a></td>  
