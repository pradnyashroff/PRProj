...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;">Aprroved by Sourcing </li>
...
foreach ($pr_approved_source->result() as $row)  
         {  ?>
            ...
            <td >  <a href="<?php echo site_url('purchase/QCS/view_pr_source_approved/'.$row->pr_id);?>"> PR <?php echo $row->pr_id;?> </a></td>  
