  ...
  <div class="content-wrapper" style="background-color:#3482AE">
   ...
   Approved Capex
     ...
     <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
       ...
       <li> <a href="<?php echo site_url('purchase/QCS/index') ?>" style="color:#FFFFFF;">Capex</a></li>
...
foreach ($reject_list->result() as $row)  
         {  ?>
            ...
            <td >  <a href="<?php echo site_url('purchase/QCS/view_capex/'.$row->capex_id);?>"> Capex <?php echo $row->capex_id;?> </a></td> 
