...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;">MDO Approval
</li>
</li>
      </ol>
 ...
 <div class="box-header with-border">
			  ...
			  <label class="col-sm-1 pull-left control-label">1</label>
               ...
               <input type="text" name="" value="<?php echo $row4->qcs_id; ?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly class="form-control"  required>
        ...
        <input type="hidden" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly name="pr_id" value="<?php echo $row4->pr_id; ?>" class="form-control"  required>
	...
	<span class="glyphicon glyphicon-edit"  data-toggle="modal" data-target="#pr_view_Modal"href="#pr_view_Modal<?php echo $row4->pr_id?>">&nbsp;<?php echo $row4->pr_id; ?></span>
	 ...
	 <input type="text" class="form-control" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly name="qcs_date" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value ="<?php echo $row4->qcs_date; ?>" >
    ...
    <input type="text" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly name="pr_dept" value="<?php echo($dept_nm['dept_name']); ?>" class="form-control"  required>              
			  ...
			  <label class="col-sm-1 pull-left control-label">4</label>
			   <label class="col-sm-4 pull-left control-label">QCS Owner</label>
				<div class="input-group  col-sm-6">
    <input type="text" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly name="qcs_owner_nm" value="<?php echo $row4->qcs_owner; ?>" class="form-control"  required>              
			  ...
			  <label class="col-sm-1 pull-left control-label">5</label>
			   <label class="col-sm-4 pull-left control-label">Plant</label>
				<div class="input-group  col-sm-6">
    <input type="text" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly name="pr_code" value="<?php echo $row4->plant_code; ?> " class="form-control"  required>              
			  ...
			  <input type="hidden" value="<?php echo $row4->pr_type; ?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly   name="" class="form-control"  required>
  
  <?php $pt_name= $this->method_call->fetch_prtype_nm($row4->pr_type); ?>
  <input type="text" name="" value="<?php print_r($pt_name['pt_name']); ?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly  class="form-control"  required>
			  ...
			  <label class="col-sm-1 pull-left control-label">7</label>
			   <label class="col-sm-4 pull-left control-label">ION NO</label>
				<div class="input-group  col-sm-6">
                    ...
                    <input type="text" name="" value="<?php echo $ionno;?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly  class="form-control"  required>   
...
foreach ($view_item->result() as $rowitem)  
		 ...
		 <!-- item code -->
		   <div class="form-group col-sm-4 hidden ">
			  <div class="input-group  col-sm-6">
                <input type="text" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly name="" value="<?php echo $rowitem->q_item_code; ?>" class="form-control"  required>
			
         <?php $item_nm= $this->method_call->fetch_item_nm($rowitem->q_item_code); ?>
 <input type="Text" name="pr_dept" class=" form-control" id="pr_dept" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php print_r($item_nm['item_code']); ?>"  >
                </div>
                </div>
			...
			<!--end -->	
                ...
                <thead>
				 ...
				 <tr style="background-color:#3482AE;color:#FFFFFF;width:100%;">
					...
					<th colspan="2" > <center><b> Supplier 1  :&nbsp;&nbsp;   <?php echo $row4->sup1_nm; ?></b><center></th>
...
<!-- Technical specification -->
 ...
 <!--  <input type="hidden" name="temp_qcs_id" placeholder="" value="<?php echo $pr_id.$emp_code; ?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly class="form-control"  required> -->
		...
		<br>
			 ...
			 <td style="display:none" >  </td>
				 ...
				 <td colspan="3" ><b> <center>Supplier 1  :&nbsp;&nbsp; <?php echo $row4->sup1_nm; ?><center></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
...
<div class="form-group col-sm-12">
        ...
        <b><a style="color: #337ab7;" href="<?php echo base_url()."uploads/additional_attachment/". $row4->additional_attachment ?>"> <?php echo $row4->additional_attachment ?></a> </b>
         ...
         <?php echo $row4->justification_supplier; ?>
			 ...
			 <label class="pull-left control-label">9</label>
			   <label class="col-sm-4 pull-left control-label">Sourcing Manager  Approval Comment</label>
				<div class="input-group  col-sm-6">
			 ...
			 <label class="pull-left control-label">10</label>
			   <label class="col-sm-4 pull-left control-label">Sourcing Head  Approval Comment</label>
				<div class="input-group  col-sm-6">
			 ...
			 <label class="pull-left control-label">11</label>
			   <label class="col-sm-4 pull-left control-label">CFO Comment</label>
				<div class="input-group  col-sm-6">
			<?php $cfo_name= $this->method_call->fetch_emp_name($row4->approval_level3); ?>
			 ...
			 <label class="pull-left control-label">12</label>
			   <label class="col-sm-4 pull-left control-label">COO Comment</label>
				<div class="input-group  col-sm-6">
			<?php $coo_name= $this->method_call->fetch_emp_name($row4->approval_level4); ?>

                 <?php if($row4->approval_level4_comment == null){
			 ...
			 <label class="pull-left control-label">13</label>
			   <label class="col-sm-4 pull-left control-label">MDO Comment</label>
				<div class="input-group  col-sm-6">
			<?php $mdo_name= $this->method_call->fetch_emp_name($row4->approval_level5); ?>

                 <?php if($row4->approval_level5_comment == null){
					 echo "Approval Pending From MD Office ($mdo_name)" ;
					 
				 }else{
					 
				 $mdo_dt= $this->method_call->fetch_status_sourcing_mgr($qcs_id,$row4->approval_level5);
				 
				 echo $row4->approval_level5_comment; echo ' ('.$mdo_name.')'; echo ' ('. $mdo_dt.')';
	...
	?>
	 approval1 
			 ...
			 <label class="pull-left control-label">11</label>
			   <label class="col-sm-4 pull-left control-label">MDO Comment</label>
				<div class="input-group  col-sm-6">
			<?php $mdo_name= $this->method_call->fetch_emp_name($row4->approval_level3); ?>
				 ...
				 $mdo_dt= $this->method_call->fetch_status_sourcing_mgr($qcs_id,$row4->approval_level3);
				 
				 echo $row4->approval_level3_comment; echo ' ('.$mdo_name.')'; echo ' ('. $mdo_dt.')';
...
<!--end -->
			...
			<form method="post" id="main_form" action="<?php echo site_url('purchase/QCS/approve_mdo') ?>" enctype='multipart/form-data'>
		...
		<div class="form-group col-sm-12">
			 ...
			 <label class="col-sm-4 pull-left control-label">Action</label>
			   <div class="input-group  col-sm-6">
			  <input type="radio" name="qcs_state" value="QCS_Approved" required > APPROVE</input> 
			   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			
                 
                                    <input type="radio" name="qcs_state" value="QCS_Reject" > REJECT</input>
			 ...
			 <label class="pull-left control-label">12</label>
         	 ...
         	 <textarea name="mdo_app_cmt" maxlength= "250" rows="4" cols="50"  required ></textarea>
...
<div class="col-sm-2"> <a href="<?php echo site_url('purchase/QCS/sourcing_head_approve_list') ?>" class="btn" style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Cancel</a></div>
	
<input type="hidden" name="qcs_emp_nm" value="<?php echo $emp_name; ?>" class="form-control">
...
<?php 
	...
	if($row4->pr_type == '13')
	{
		?>
			<!-- approval 3 -->
		<?php $sourcing_approval5= $this->method_call->fetch_sourcing_approval3($row4->pr_type); ?>
		<input type="hidden" name="sourcing_approval5" value="<?php print_r($sourcing_approval5['approval_level3']);?>" class="form-control">
	...
	<?php 
	 ...
	 ?>
			  ...
			  <input type="hidden" value="<?php echo $row4->pr_type; ?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly   name="pr_type_id" class="form-control"  required>
  	
				 <input type="hidden"  name="qcs_num" value="<?php echo $row4->qcs_id; ?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly class="form-control"  required> 
				 
				   <input type="hidden" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly name="pr_id" value="<?php echo $row4->pr_id; ?>" class="form-control"  required>
				   
				    <input type="hidden" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly name="qcs_emp_code" value="<?php echo $row4->qcs_emp_code; ?>" class="form-control"  required>
					</div>
...
<!-- Pr owner EID-->
  ...
  <input type="text" name="pr_owner_email" value="<?php print_r($eid_owner['emp_email']); ?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly  class="form-control"  required>
  ...
  <input type="text" name="qcs_ow_email" value="<?php print_r($eid_owner['emp_email']); ?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly  class="form-control"  required>
	...
	<!--MD ofc EID-->
			  ...
			  <label class="col-sm-1 pull-left control-label">7</label>
			   <label class="col-sm-4 pull-left control-label">MD ofc email</label>
				<div class="input-group  col-sm-6">
               
				  
  <?php $eid_owner= $this->method_call->fetchemp_email($row4->approval_level5); ?>
  <input type="text" name="mdo_email" value="<?php print_r($eid_owner['emp_email']); ?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly  class="form-control"  required>
				...
				<input type="hidden" name="sup1FinalAmt" value="<?php echo  $total_final_ammount1; ?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly  class="form-control"  required>
<input type="hidden" name="pr_date_email" value="<?php echo  $row4->pr_date; ?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly  class="form-control"  required>
	<input type="hidden" name="prOwnerName" class="form-control" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php echo $row4->pr_owner_name; ?>" required>  
<input type="hidden" name="pr_prpcRes" class="form-control" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php echo $row4->procurement_res; ?>" required>  
...
-->
  <form method="post" id="" action="" >
            <div class="row">
			  <input type="hidden" name="view_qcs_id" placeholder="" value="<?php echo $row4->qcs_id; ?>" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly class="form-control"  required></td>
...
foreach ($view_item->result() as $rowitem)  
         ...
         <?php $item_nm= $this->method_call->fetch_item_nm($rowitem->q_item_code); ?>
 <input type="Text" name="" class=" form-control" id="" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php print_r($item_nm['item_code']); ?>"  >
                </div>
                </div>
...
<div class="modal-dialog" role="document" style="width:980px;">
 ...
 if($qcs_detail!=null){
	...
	<input type="Text" name="pr_plant" class="form-control"  style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php echo $row_pr->pr_id; ?>" required>     
			  ...
			  <label class="col-sm-1 pull-left control-label">2</label>
			   <label class="col-sm-5 pull-left control-label">PR Owner nm</label>
				<div class="input-group  col-sm-6">
				<input type="Text" name="pr_owner_name" class="form-control" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php echo $row_pr->pr_owner_name; ?>" required>  
			  ...
			  <label class="col-sm-1 pull-left control-label">3</label>
			   <label class="col-sm-5 pull-left control-label">Plant</label>
				<div class="input-group  col-sm-6">
				<input type="Text" name="pr_plant" class="form-control"  style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php echo $row_pr->plant_code; ?>" required>  
			...
			<?php $pt_name= $this->method_call->fetch_prtype_nm($row_pr->pr_type); ?>
						   <input type="Text" name="pr_dept" class=" form-control" id="pr_dept" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php print_r($pt_name['pt_name']); ?>"  required>
                </div>
                </div>
	  ...
	  <div class="form-group col-sm-6">
			  ...
			  <label class="col-sm-1 pull-left control-label">5</label>
			   <label class="col-sm-5 pull-left control-label">PR Date</label>
				<div class="input-group  col-sm-6">
			  <input type="Text" name="pr_dept" class=" form-control" id="pr_dept" style="background-color:#E6F2FF;" style="background-color:#E6F2FF;" readonly value="<?php echo $row_pr->pr_date; ?>"  required>
                </div>
                </div>
		   ...
		   <div class="form-group col-sm-12">
			  ...
			  <label class="col-sm-6 pull-left control-label">6 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Requirement Details</label>
				<div class="input-group  col-sm-5 pull-center">
