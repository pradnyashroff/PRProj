...
<form method="post" id="main_form" action="<?php echo site_url('purchase/QCS/approval4_capex_insert') ?>" enctype='multipart/form-data' >  	
			  ...
			  <label class="col-sm-1 pull-left control-label">4</label>
			   <label class="col-sm-4 pull-left control-label">Department</label>
				<div class="input-group  col-sm-6">
						...
						<input type="text" class="form-control" readonly name="dft_plant" value="<?php print_r($dept_nm['dept_name']); ?>">
...
<?php 
		if($capex_row->outside_budget == 'YES' || $capex_row->order_value == 'YES' || $capex_row->offers_received == 'YES' || $capex_row->repl_cost_agreed == 'YES' || $capex_row->advance_bg == 'YES' || $capex_row->advance_25 == 'YES' || $capex_row->paymt_trm_grn_90 == 'YES' || $capex_row->imported_item == 'YES'){
		?>
             ...
             <!--  <input type="radio" name="capex_state" value="capex_rejected" required> Reject</input>-->
			   ...
			   <label class="col-sm-4 pull-left control-label">Approver Comment </label>
				<div class="input-group  col-sm-4">
					   ...
					   <textarea class="form-control" rows="5" name="capex_comment" required></textarea>
				</div>
		...
		else if($capex_row->outside_budget == 'NO' && $capex_row->order_value == 'NO' && $capex_row->offers_received == 'NO' && $capex_row->repl_cost_agreed == 'NO' && $capex_row->advance_bg == 'NO' && $capex_row->advance_25 == 'NO' && $capex_row->paymt_trm_grn_90 == 'NO' && $capex_row->imported_item == 'NO' ){
		?>
		
			<div class="form-group col-sm-12">
			  
			   <label class="col-sm-1 pull-left control-label">6</label>
			   <label class="col-sm-4 pull-left control-label">Finance Controller  Comment</label>
				<div class="input-group  col-sm-6">
				
				  <?php $approval1_name= $this->method_call->fetch_emp_name($capex_row->capex_approval1); ?>

                                   <?php if($capex_row->capex_approval1_cmt == null){
					 echo "Approval Pending From Finance Controller Department  ($approval1_name)";
	...
	<div class="form-group col-sm-12">
            ...
            <!--   <input type="radio" name="capex_state" value="capex_rejected"> Reject</input>-->
...
<input type="hidden" name="qcs_email" class="form-control"  readonly value="<?php print_r($qcs_email['emp_email']); ?> "  required>                          
   ...
   <input type="text"  name="capex_supllier" value="<?php echo $capex_row->cap_sel_supplier; ?>" readonly class="form-control" >
