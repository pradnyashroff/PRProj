...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;">View PR
</li>
</li>
      </ol>
...
foreach ($item->result() as $rowhistory)  
		 ...
		 <div class="form-group col-sm-12" id="printfile">
<?php $filea= $this->method_call->filefetch($pr_id); //displaying ccs
 ...
 ?>
			    ...
			    <div class="form-group col-sm-6">
			  <a style="color: #337ab7;" href="<?php echo base_url()."uploads/PR/". $pr_id ."/".$rowfile->file_name;?>">
			  <br><?php echo $rowfile->file_name; ?></a>
			  </div>
		 <?php }
 } ?>
		...
		<br>
		  ...
		  <div class="form-group col-sm-12" id="options">
<div class="form-group col-sm-5">
	</div>
<div class="form-group col-sm-2">	
			<button type="button" onclick="printpage();"  id ="printpagebutton" class="btn" style="width: 80%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;"><span class="glyphicon glyphicon-print"></span> &nbsp;&nbsp; Print</button>
	</div>
<div class="form-group col-sm-5">	
</div>
              </div>
