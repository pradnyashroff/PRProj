...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;"> Edit / Delete Item 
 ...
 if($item_qdetail!=null){
	 foreach ($item_qdetail->result() as $row)  
      ...
      <div class="row" >
	        <form method="POST" action="<?php echo site_url('purchase/QCS/updateitem');?>">  
        <div class="col-md-12">
          <!-- Horizontal Form -->
...
<div class="form-group col-md-2">
 ...
 <input class="form-control" type="text" style="background-color:#E6F2FF;" readonly  required name="q_update_quot_amt1" style="background-color:#E6F2FF;" readonly id="quot_amt1" value="<?php echo $row->quoted_amt1; ?>"  />	
 </div>
 ...
 <input class="form-control" type="text" style="background-color:#E6F2FF;" readonly required name="q_update_amount1" id="amount1" style="background-color:#E6F2FF;" readonly value="<?php echo $row->final_amt1; ?>" />	
 </div>
...
<div class="form-group col-md-2">
 ...
 <input class="form-control" type="text" style="background-color:#E6F2FF;" readonly value="<?php echo $row->quoted_amt2; ?>" style="background-color:#E6F2FF;" readonly required name="q_update_quot_amt2" id="quot_amt2" value=""  />	
 </div>
 
 
<div class="form-group col-md-2">
                   
 <input class="form-control" type="text"  value="<?php echo $row->final_rate2; ?>"  required name="q_update_final_rate2" id="final_rate2"  onkeyup="mul_final_quat2();"   />		 	</div>
 
<div class="form-group col-md-2">
                   
 <input class="form-control" type="text" style="background-color:#E6F2FF;" readonly value="<?php echo $row->final_amt2; ?>"style="background-color:#E6F2FF;" readonly required name="q_update_amount2" id="amount2"   />		 	</div>
...
<div class="form-group col-md-2">
 ...
 <input class="form-control" type="text" style="background-color:#E6F2FF;" readonly required name="q_update_quot_amt3" style="background-color:#E6F2FF;" readonly id="quot_amt3" value="<?php echo $row->quoted_amt3; ?>"  />	
 </div>
 
<div class="form-group col-md-2">
                    
 <input class="form-control" type="text" onkeyup="mul_final_quat3();" required name="q_update_final_rate3"  id="final_rate3" value="<?php echo $row->final_rate3; ?>"     />
 </div>
 
<div class="form-group col-md-2">
                    
 <input class="form-control" type="number" style="background-color:#E6F2FF;" readonly required name="q_update_amount3" style="background-color:#E6F2FF;" readonly id="amount3" value="<?php echo $row->final_amt3; ?>"     />
 </div>
...
<div class="col-sm-2">
 ...
 <button type="submit" id="item_btnold" class="btn" style="width: 80%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Update Item</button>
	...
	<!-- Delete Item -->
	<form method="post" action="<?php echo site_url('purchase/QCS/deleteItem/'.$row->qcs_item_id);
			?>">
