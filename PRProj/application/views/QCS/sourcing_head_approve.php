...
<head>
  ...
  <title>Sourcing Head Approved</title>
...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;">Approval1
</li>
</li>
      </ol>
...
foreach ($view_item->result() as $rowitem)  
 ...
 <input type="Text" name="pr_dept" class=" form-control" id="pr_dept" style="background-color:#E6F2FF;" readonly value="<?php print_r($item_nm['item_code']); ?>"  >
        ...
        <tr>
           <td colspan="1"></td>
			<td><B><?php echo $final_rate; ?></b></td>
			<td colspan="1"></td>
			<td><B><?php echo $total_final_ammount1; ?></b></td>
			<td colspan ="1"></td>
			<td><B><?php echo $total_quoted_amount2; ?></b></td>
			<td colspan ="1"></td>
			<td><B><?php echo $total_final_ammount2; ?></b></td>
			<td colspan ="1"></td>
			<td><B><?php echo $total_quoted_amount3; ?></b></td>
			<td colspan ="1"></td>
			<td><B><?php echo $total_final_ammount3; ?></b></td>
			<td colspan ="1"></td>
        </tr>
    </tfoot>
...
<!-- Technical specification -->
  <div class="box-header with-border">
					   ...
					   <div class="box-header with-border">
              <h4 class="box-title">3 . Technical Specification Comparison</h4>
...
<!-- Quotation Attachments -->
 <div class="box-header with-border">
					   <div class="box box-default collapsed-box">
					   <div class="box-header with-border">
              <h4 class="box-title">4 . Quotation Attachments</h4>
...
<!-- self declaration -->
 ...
 <div class="box-header with-border">
					   <div class="box box-default collapsed-box">
					   <div class="box-header with-border">
              <h4 class="box-title">5 . Self Declaration</h4>
		 ...
		 <label class="pull-left control-label" style="color:red;">Common for all</label>
			 ...
			 <div class= "col-sm-5">
			 	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_outside_budget; ?> ) </span>
		   ...
		   <div class="col-sm-5">
			 	...
			 	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_order_value; ?> ) </span>
			...
			<div class="col-sm-5">
			 	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_quot_reec; ?> ) </span>
			...
			<div class="col-sm-1">
			 ...
			 <div class="col-sm-5">
			 	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_adv_nonproprietery; ?> ) </span>
			 ...
			 <div class="col-sm-5">
			 	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_adv_proprietery; ?> ) </span>
			...
			<div class="col-sm-1">
			 ...
			 <div class="col-sm-5">
			 	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_final_payment_grn; ?> ) </span>
			...
			<div class="col-sm-5">	
			 	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_delivery_gate; ?> ) </span>
			...
			<div class="col-sm-5">
			 	...
			 	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_cost_reimb_cust; ?> ) </span>
...
<div class="col-sm-5">		   
                   	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_repl_cost_agree; ?> ) </span>
...
<div class="col-sm-5">			  
                 	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_adv_pymt_bg; ?> ) </span>
		...
		<div class="col-sm-5">	   
			   	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_advance_25; ?> ) </span>
			  ...
			  <label class="pull-left control-label">13</label>
			   ...
			   <div class="col-sm-5">
			   	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_paymt_trm_grn_90; ?> ) </span>
			...
			<div class="col-sm-1">
			   ...
			   <div class="col-sm-5">
			   	<?php 
						...
						<span style="color:#1E8449;">( <?php echo $row4->just_imported_item; ?> ) </span>
        ...
        <b><a style="color: #337ab7;" href="<?php echo base_url()."uploads/additional_attachment/". $row4->additional_attachment ?>"> <?php echo $row4->additional_attachment ?></a> </b>
          ...
          <?php echo $row4->selected_supplier; ?>
			  ...
			  <label class="pull-left control-label"><h4 class="box-title">8</h4></label>
			   <label class="col-sm-5 pull-left control-label"><h4 class="box-title">Justification for QCS Approval</h4></label>
				<div class="input-group  col-sm-6">
...
<!--end -->
   ...
   <!-- start -->
			    	<div class="form-group col-sm-12">
			   <label class="pull-left control-label"><h4 class="box-title">10</h4></label>
			   <label class="col-sm-5 pull-left control-label"><h4 class="box-title">Approval Status</h4></label>
...
?>
	...
	?>
		  <!--end-->
			...
			<form method="post" id="main_form" action="<?php echo site_url('purchase/QCS/approve_sourcing_mgr') ?>" enctype='multipart/form-data'>
		
		<div class="form-group col-sm-12">
			  
			 	 <label class="pull-left control-label"><h4 class="box-title">11</h4></label>
			   <label class="col-sm-5 pull-left control-label"><h4 class="box-title">Action</h4></label>
			   <div class="input-group  col-sm-6"><input type="radio" name="qcs_state" value="Sourcing_Mgr_approved" required > APPROVE</input>
				
                 &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;   &nbsp;&nbsp;
				 
                                    <input type="radio" name="qcs_state" value="Sourcing_Mgr_reject" > REJECT</input>
			 ...
			 <label class="pull-left control-label"><h4 class="box-title">12</h4></label>
			   <label class="col-sm-5 pull-left control-label"><h4 class="box-title">Approver Comment</h4></label>
				<div class="input-group  col-sm-6">
                 
                
                 
                  <textarea name="sourcing_mgr_app_cmt" maxlength= "250" rows="4" cols="50"  required ></textarea>
                     <div id="the-count">
...
<div class="col-sm-2"> <a href="<?php echo site_url('purchase/QCS/Qcs_master_draft') ?>" class="btn" style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Cancel</a></div>
	 ...
	 <div class="form-group col-sm-12 hidden">			
				 <input type="text"  name="qcs_num" value="<?php echo $row4->qcs_id; ?>" style="background-color:#E6F2FF;" readonly class="form-control"  required> 
				 
				   <input type="text" style="background-color:#E6F2FF;" readonly name="pr_id" value="<?php echo $row4->pr_id; ?>" class="form-control"  required>
				   
				    <input type="text" style="background-color:#E6F2FF;" readonly name="qcs_emp_code" value="<?php echo $row4->qcs_emp_code; ?>" class="form-control"  required> 
					<input type="text" style="background-color:#E6F2FF;" readonly name="login_user_nm" value="<?php echo $emp_name; ?>" class="form-control"  required> 
				
				 <!-- approval 1 -->
				 <?php $sourcing_approval1= $this->method_call->fetch_sourcing_approval1($row4->pr_type); ?>
		<input type="text" name="sourcing_approval1" value="<?php print_r($sourcing_approval1['approval_level1']);?>" class="form-control"  required>
		
			<!-- approval 2 -->
		<?php $sourcing_approval2= $this->method_call->fetch_sourcing_approval2($row4->pr_type); ?>
		<input type="text" name="sourcing_approval2" value="<?php print_r($sourcing_approval2['approval_level2']);?>" class="form-control"  required>
</div>
  ...
  <input type="text" name="qcs_ow_email" value="<?php print_r($eid_owner['emp_email']); ?>" style="background-color:#E6F2FF;" readonly  class="form-control"  required>
	...
	<!-- Next approval EID-->
			  ...
			  <label class="col-sm-1 pull-left control-label">7</label>
			   <label class="col-sm-4 pull-left control-label">2nd approval owner</label>
				<div class="input-group  col-sm-6">
               
				  
  <?php $eid_owner= $this->method_call->fetchemp_email($row4->approval_level2); ?>
  <input type="text" name="approval2_email" value="<?php print_r($eid_owner['emp_email']); ?>" style="background-color:#E6F2FF;" readonly  class="form-control"  required>
