					...
					<div class="box-body">
						...
						<div class="form-group col-sm-6">
								...
								<table id="example" class="table table-bordered table-striped" style="font-size: 12px!important;">
									 ...
									 <form method="post" id="pend_pr" name="pend_pr" action="<?php echo site_url('FTGS_PR/Ftgs_pr/plantHead_insert_ftgs_pr') ?>" >
									...
									$autho_code=$this->method_call->getSanctionAuthoDetails();;
									...
									<?php $PHAuthoEmail=$this->method_call->fetchPHMailDetails($IOCode);?>
									...
									<input class="form-control" type="hidden" name="txtPHAuthoEmail" value="<?php print_r($PHAuthoEmail['PhEmail']); ?>"/>
								...
								<?php $plant = $row->ftgs_plant_code;
								 $autho_code=$this->method_call->getSanctionAuthoDetails();?>
                                  <input type="hidden" value="<?php print_r($autho_code['autho_code']); ?>" name="txt_plant_Autho" class="form-control"  required>	
									<?php
								$ftgsActionData = $this->method_call->ftgsSancActionData($emp_code,$ftgs_pr_id);
