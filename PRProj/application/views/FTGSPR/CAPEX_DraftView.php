...
<li class="active" style="color:#FFFFFF;">Deaft CAPEX
</li>
</li>
      </ol>
    ...
    <!-- Main content -->
	  ...
	  <form method="post" role="form" enctype="multipart/form-data"  action="<?php echo site_url('FTGS_PR/Ftgs_pr/ftgs_draft_capex') ?>" >  
 <!-- Content Wrapper. Contains page content -->
 <div class="wrapper">
         ...
         <input type="text" name="" value="<?php echo $qcs_row->ftgs_plant_code; ?>" style="background-color:#E6F2FF" readonly class="form-control"  required>
			  ...
			  <label class="col-sm-1  control-label" style="color:#3482AE">3</label>
			   <label class="col-sm-3 control-label" style="color:#3482AE; text-transform: uppercase;">CAPEX Date</label>
				<div class="input-group  col-sm-6">
                   <input type="text" name="" value="<?php echo $qcs_row->ftgs_capex_date	; ?>" style="background-color:#E6F2FF" readonly class="form-control"  required>
			  ...
			  <label class="col-sm-1 pull-left control-label" style="color:#3482AE">7</label>
			   <label class="col-sm-4 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">QCS NO</label>
				<div class="input-group  col-sm-6">
				  ...
				  <input type="text" name="txtftgsId" class=" form-control" style="background-color:#E6F2FF" value="<?php echo $qcs_row->ftgs_qcs_id; ?>" readonly value=""  required>                          
     ...
     1   
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">FUND NO</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" value="<?php echo $qcs_row->ftgs_ion_no; ?>"  name="dft_fund_no"  class="form-control" >
...
2
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Master Asset GL Code</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <select class="form-control" required name="dft_asset_gl_code">	
						...
						<option value="<?php echo $qcs_row->ftgs_master_gl_code; ?>"><?php echo $qcs_row->ftgs_master_gl_code;?>  </option>
	...
	<?php }
	 ...
	 <div class="col-sm-1 invoice-col" style="color:#3482AE">
			...
			<option value="<?php echo $qcs_row->ftgs_revenue_gl_code1;?>"><?php echo $qcs_row->ftgs_revenue_gl_code1;?> </option>
	...
	<?php }
				...
				<div class="col-sm-2">
                  ...
                  <input type="text" value = "<?php echo $qcs_row->ftgs_amtRevenueGlCode1; ?>" name="dftamtRevenueGlCode1" id="dftamtRevenueGlCode1" onkeyup="enableDisable()"  data-toggle="tooltip" data-placement="top" title="Amount Should not gretter QCS GrandTotal" class="form-control" >
	 ...
	 <div class="col-sm-1 invoice-col" style="color:#3482AE">
			...
			<option value="<?php echo $qcs_row->ftgs_revenue_gl_code2;?>"><?php echo $qcs_row->ftgs_revenue_gl_code2;?> </option>
	...
	<?php }
				...
				<div class="col-sm-2">
                  ...
                  <input type="text" value = "<?php echo $qcs_row->ftgs_amtRevenueGlCode2; ?>" name="dftamtRevenueGlCode2" id="dftamtRevenueGlCode2" onkeyup="enableDisable()"  data-toggle="tooltip" data-placement="top" title="Amount Should not gretter QCS GrandTotal" class="form-control" >
...
3.1
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Required Capital GL Code-1</label>
				...
				<option value="<?php echo $qcs_row->ftgs_actual_gl_code;?>"><?php echo $qcs_row->ftgs_actual_gl_code;?> </option>
	...
	<?php }
				...
				<div class="col-sm-2">
                  ...
                  <input type="text" value = "<?php echo $qcs_row ->ftgs_amtGlCode1 ;?>" name="dftamtGlCode1" onkeyup="enableDisable()" id="dftamtGlCode1" data-toggle="tooltip" data-placement="top" title="Amount Should not gretter QCS GrandTotal" class="form-control" >
...
3.2
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Required Capital GL Code-2</label>
                ...
                <select class="form-control"  name="dftcapitalGlCode2">	
					<option value="<?php echo $qcs_row->ftgs_actual_gl_code2;?>"><?php echo $qcs_row->ftgs_actual_gl_code2;?> </option>
	...
	<?php }
				...
				<div class="col-sm-2">
                  ...
                  <input type="text" value = "<?php echo $qcs_row ->ftgs_amtGlCode2 ;?>"  name="dftamtGlCode2" id="dftamtGlCode2" 
...
3.3
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Required Capital GL Code-3</label>
				<div class="col-sm-4">
                 ...
                 <select class="form-control"  name="dftcapitalGlCode3">	
					<option value="<?php echo $qcs_row->ftgs_actual_gl_code3;?>"><?php echo $qcs_row->ftgs_actual_gl_code3;?> </option>
	...
	<?php }
				...
				<div class="col-sm-2">
                  ...
                  <input type="text"  value = "<?php echo $qcs_row ->ftgs_amtGlCode3;?>" name="dftamtGlCode3" id="dftamtGlCode3"  onkeyup="enableDisable()"  data-toggle="tooltip" data-placement="top" title="Amount Should not gretter QCS GrandTotal"  class="form-control" >
			...
			4
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Budget Sr. Number</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" value="<?php echo $qcs_row->ftgs_budget_no; ?>"  name="dft_budget_sr_no"  class="form-control" >
			...
			5
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Project completion Date (Put-To-Use Date) (Approx.)</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" value="<?php echo $qcs_row->ftgs_proj_comp_date; ?>"  name="dft_proj_comp_date"  class="form-control" >
    ...
    6
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Recommender</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" value="<?php echo $qcs_row->ftgs_cap_recommender; ?>" style="background-color:#E6F2FF" readonly name="dft_cap_recommender"  class="form-control" >
...
<div class="row invoice-info">
     ...
     7
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Company/ Unit</label>
				<div class="col-sm-7 pull-right">
                      ...
                      <input type="Text" readonly name="dft_cap_comp_unit" class=" form-control" style="background-color:#E6F2FF"  value="<?php echo $qcs_row->ftgs_cap_unit; ?>"  required>  
		...
		8
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Type of Capex</label>
				<div class="col-sm-7 pull-right">
				 ...
				 <option value="<?php echo $qcs_row->ftgs_capex_type;?>" ><?php echo $qcs_row->ftgs_capex_type;?></option>
	...
	9
               ...
               <select class="form-control" name="dft_cap_fin_year">  
				 <option value="<?php echo $qcs_row->ftgs_bussiness_plan;?>" ><?php echo $qcs_row->ftgs_bussiness_plan;?></option>
		...
		10
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Part of Approved Project</label>
				<div class="col-sm-7 pull-right">
				 ...
				 <option value="<?php echo $qcs_row->ftgs_approved_proj;?>" ><?php echo $qcs_row->ftgs_approved_proj;?></option>
				 <option value="YES">YES</option>
				 <option value="NO">NO</option>
	...
	11
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Brief Background/ Description of Capex</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <textarea rows="4" cols="50"  required maxlength="250" name="cap_brief_background"  class="form-control" ><?php echo $qcs_row->ftgs_des_capex;?></textarea>
	...
	16
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Basis of Price</label>
				<div class="col-sm-7 pull-right">
                 	 ...
                 	 <select class="form-control" name="dft_cap_basis_price">  
				<option value="<?php echo $qcs_row->ftgs_basis_price; ?>"><?php echo $qcs_row->ftgs_basis_price; ?></option>	 
				<option value="" >Select option</option>
...
19
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Any Bank Guarantees Involved</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" name="dft_cap_bank_gurantee" value = "<?php echo $qcs_row->ftgs_bank_guarantees; ?>" required  class="form-control" >
		...
		20
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Any penalties involved for failure on delivery or performance</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" name="dft_cap_penalties_involved" value = "<?php echo $qcs_row->ftgs_delivery_peformace; ?>" required  class="form-control" >
		...
		21
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Specific exclusions and inclusions in the scope of supply</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" name="dft_cap_specfic_exclusion"  value = "<?php echo $qcs_row->ftgs_scope_supply; ?>" required  class="form-control" >
		...
		22
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Any other special/ noteworthy terms or condition</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" name="dft_cap_noteworthy_cond"  value = "<?php echo $qcs_row->ftgs_noteworthy_capex; ?>"required  class="form-control" >
		...
		23
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Any Technical Aspect to be highlighted</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" name="dft_cap_tech_asp" value = "<?php echo $qcs_row->ftgs_technical_aspect; ?>" required data-toggle="tooltip" data-placement="top" title="What would be technically useful life for the investment? Also specifically mention those aspects that will be new to us either in terms of design or during operations or for servicing requirements" class="form-control" >
		...
		24
			   ...
			   <label class="col-sm-3 pull-left control-label" style="color:#3482AE; text-transform: uppercase;">Estimated Associated or Consequential Costs- that is, cost to company to make the capex actually productive</label>
				<div class="col-sm-7 pull-right">
                  ...
                  <input type="text" name="dft_estimated_associated" value = "<?php echo $qcs_row->ftgs_estimated_associated; ?>" required data-toggle="tooltip" data-placement="top" title="What would be technically useful life for the investment? Also specifically mention those aspects that will be new to us either in terms of design or during operations or for servicing requirements" class="form-control" >
...
<!-- Asset code -->
			 ...
			 <div class="box-header with-border">
					   <div class="box box-default">
					   <div class="box-header with-border">
              <h3 class="box-title" style="color:#3482AE">4 . Asset Code Creation </h3>
...
<?php
                        ...
                        ?>
									...
									<?php
								 $autho_code=$this->method_call->getIONAuthoDetails();
								 if($autho_code!=null)
						{
							foreach ($autho_code->result() as $rowauth)  
							{   
							?>
			 ...
			 <label class="pull-left control-label">5</label>
			   <label class="col-sm-4 pull-left control-label">Action</label>
				<div class="input-group  col-sm-6">
                                        ...
                                        <input type="radio" name="capex_state"  value="0" required > Save AS Draft</input> 
			   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			
              <?php if ( $disableFlag == "True"){
				echo "Please fill-up asset list..";
			}else{ ?>
				 <input type="radio" name="capex_state" value="1"> Submit For Approval</input>
			 ...
			 <label class="pull-left control-label">6</label>
			   <label class="col-sm-4 pull-left control-label">Justification for Capex Approval</label>
				<div class="input-group  col-sm-6">
                                        ...
                                        <textarea class="form-control"  value ="" maxlength="250" rows="4" cols="50" name="justification_capex" > <?php echo $qcs_row->ftgs_justification_capex; ?></textarea>
...
<div class="modal-dialog" role="document" style="width:1000px;">
    <div class="modal-content">
      <div class="modal-header">
	   ...
	   <form id="costCenterDetails" name="costCenterDetails" action="<?php echo site_url('FTGS_PR/Ftgs_pr/insertCostCenterDetails'); ?>" method="post">
      <div class="modal-body">
...
foreach ($view_item->result() as $rowitem)  
		...
		<tr> 
			...
			<td  ><?php echo $sr_no; ?> </td>
			<td><?php echo $qcs_row->ftgs_plant_code; ?></td>
				<td style="display:none"><input type="text" name="draft_txt_qcs_itm[]" value="<?php echo $rowitem->ftgs_qcs_item_id; ?>"  class="form-control" ></td>
			<td style="display:none"><input type="text" name="txtCapexId[]" value="<?php echo $qcs_row->ftgs_capex_id; ?>"></td>
			<td style="display:none"><input type="text" name="txtQcsId[]" value="<?php echo $qcs_row->ftgs_qcs_id;; ?>"></td>
			 <td  ><?php echo $rowitem->ftgs_q_item_code; ?></td> 
			<td>  <?php echo $rowitem->ftgs_q_item_description; ?></td>  
			   <td> <?php echo $rowitem->ftgs_q_uom; ?></td> 
            <td> <?php echo $rowitem->ftgs_q_req_quantity; ?></td>  
...
<div class="modal-dialog" role="document" style="width:800px;">
  ...
  <form id="itemDetails" name="itemDetails" action="<?php echo site_url('purchase/capex/updateAssetCodeEdit'); ?>" method="post">
            <div class="row">
				 <input type="text" name="asset_codeEdit" class=" form-control" id="asset_codeEdit"   required>
...
<script>
	function assetCodeUpdate_data(ftgs_asset_id,ftgs_cost_center,ftgs_asset_grp,ftgs_q_item_code,ftgs_q_item_description){
		
		document.getElementById("asset_codeEdit").value =ftgs_asset_id;
		document.getElementById("costCenterEdit").value =ftgs_cost_center;
		document.getElementById("assetGrpEdit").value=ftgs_asset_grp;
		document.getElementById("assetItemCode").value =ftgs_q_item_code;
		document.getElementById("assetItemDesc").value =ftgs_q_item_description;
