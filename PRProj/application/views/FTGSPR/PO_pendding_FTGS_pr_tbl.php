							...
							<form id="frm-example" action="" method="POST">
								...
								<br><br><table id="example" class="table table">
									...
									<tbody>
										<?php 
										//Create QCS app
										$QcsList= $this->method_call->pendingSoucingList($emp_code);
											if($QcsList!=null)
											{
												$sr_no=1;			  
												foreach ($QcsList->result() as $row)  
												{  
										?>
										<tr>
											<td> <a href="<?php echo site_url('FTGS_PR/Ftgs_pr/POCretpendFTGSview/'.$row->ftgs_pr_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row->ftgs_pr_id; ?></a></td>
											...
											//PO process
											$pendingList= $this->method_call->POCodefetchpendDtl($emp_code);
											if($pendingList!=null)
											{
												$sr_no=1;			  
