	...
	<body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >
		...
		<div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
			<section class="content-header">
				<h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">Create QCS</h1>
						...
						<div class="box-body">
							<form id="frm-example" action="" method="POST">
								...
								<br><br><table id="example" class="table table">
									...
									<tbody>
										<?php 
											$QcsList= $this->method_call->fetchCreateQcsList($emp_code);
											if($QcsList!=null)
											{
												$sr_no=1;			  
												foreach ($QcsList->result() as $row1)  
												{  
										?>
										<tr>
											<td> <a href="<?php echo site_url('FTGS_PR/Ftgs_pr/createQcsStepOne/'.$row1->ftgs_pr_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row1->ftgs_pr_id; ?></a></td>
