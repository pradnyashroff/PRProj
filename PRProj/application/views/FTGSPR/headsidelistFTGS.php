			...
			<div class="navbar-custom-menu">
				<ul class="nav navbar-nav">
					<li class="dropdown user user-menu">
						<?php $image= $this->method_call->profile_pic($emp_code);
							if($image!=null){
...
<!--------------------------------------------menu submenu end------------------------------------------------->
					...
					<li class="dropdown user user-menu">
						<a href="<?php echo site_url('welcome/logout') ?>" style="color:#fff;"><i class="fa fa-power-off " style="color:#fff;"></i> <span style="color:#fff;">Logout</span></a>
					</li>
				</ul>
			</div>
		</nav>
