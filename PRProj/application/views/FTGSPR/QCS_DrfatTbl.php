						...
						<div class="box-body">
							<form id="frm-example" action="" method="POST">
								...
								<br><br><table id="example" class="table table">
									...
									<tbody>
											<?php 
											$draftList= $this->method_call->fetchQcsDraftDetails($emp_code);
											if($draftList!=null)
											{
												$sr_no=1;			  
										...
										?>
										<tr>
											<td> <a href="<?php echo site_url('FTGS_PR/Ftgs_pr/QCS_DraftStepOne/'.$row->ftgs_qcs_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row->ftgs_qcs_id; ?></a></td>
