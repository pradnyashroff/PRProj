...
<li class="active" style="color:#FFFFFF;">View CAPEX
    ...
    <!-- Main content -->
	  ...
	  <form method="post" role="form" enctype="multipart/form-data"  action="<?php echo site_url('FTGS_PR/Ftgs_pr/insert_cpxRejectDraft') ?>" >  
 <!-- Content Wrapper. Contains page content -->
 <div class="wrapper">
...
<!--end -->
	...
	<div class="form-group col-sm-12">
			...
			<div class="form-group col-sm-12">
			 ...
			 <label class="pull-left control-label">9</label>
			   <label class="col-sm-4 pull-left control-label">Justification OF CAPEX</label>
				<div class="input-group  col-sm-6">
                  <input type="Text" name="txtRelseNo" readonly value="<?php echo $qcs_row->ftgs_justification_capex;?>" style="background-color:#E6F2FF" class="form-control"> </input>
	...
	<?php 
			if($qcs_row->ftgs_capex_status == 2)
			{
			 ...
			 <label class="pull-left control-label">9</label>
			   <label class="col-sm-4 pull-left control-label">Action</label>
				<div class="input-group  col-sm-6">
                                        ...
                                        <input type="radio" name="ftgs_status"  value="0" required > Draft</input> 
			   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			
         
				 <input type="radio"  disabled name="ftgs_status" value="2"> No Action </input>
