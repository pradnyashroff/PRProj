						...
						<div class="box-body">
							<form id="frm-example" action="" method="POST">
								...
								<br><br><table id="example" class="table table">
									...
									<tbody>
										<?php 
											$plant_pendingList= $this->method_call->plant_fetchpenddingDetails($emp_code);
											if($plant_pendingList!=null)
											{
												$sr_no=1;			  
												foreach ($plant_pendingList->result() as $row)  
												{  
										?>
										<tr>
											<td> <a href="<?php echo site_url('FTGS_PR/Ftgs_pr/plantpenddingFTGSview/'.$row->ftgs_pr_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row->ftgs_pr_id; ?></a></td>
