						...
						<div class="box-body">
							<form id="frm-example" action="" method="POST">
								...
								<br><br><table id="example" class="table table">
									...
									<tbody>
										<?php 
											$ph_pendingList= $this->method_call->ph_fetchpenddingDetails($emp_code);
											if($ph_pendingList!=null)
											{
												$sr_no=1;			  
												foreach ($ph_pendingList->result() as $row)  
												{  
										?>
										<tr>
											<td> <a href="<?php echo site_url('FTGS_PR/Ftgs_pr/ph_penddingFTGSview/'.$row->ftgs_pr_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row->ftgs_pr_id; ?></a></td>
