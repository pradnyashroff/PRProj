...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;">Create QCS Step -1
    ...
    <!-- Main content -->
      <section class="content">
							  ...
							  <?php $Ftgs_pr_detail= $this->method_call->ftgsqcsDetails($ftgs_qcs_id);
...
<form method="post" id="main_form" action="<?php echo site_url('FTGS_PR/Ftgs_pr/DraftinsertQcsStepOne'); ?>" enctype='multipart/form-data'>
              <div class="box-body">
			  ...
			  <label class="col-sm-1 pull-left control-label">1</label>
			   <label class="col-sm-4 pull-left control-label">QCS Number </label>
				<div class="input-group  col-sm-6">
                                      ...
                                      <input type="text" name="ftgsQCsId" value="<?php echo $row->ftgs_qcs_id; ?>" style="background-color:#E6F2FF;" readonly class="form-control"  required>
			  ...
			  <label class="col-sm-1 pull-left control-label">2</label>
			   <label class="col-sm-4 pull-left control-label">PR NO </label>
				<div class="input-group  col-sm-6">
                                      ...
                                      <input type="text" style="background-color:#E6F2FF;" readonly name="txtftgsId" value="<?php echo $row->ftgs_pr_id; ?>" class="form-control"  required>
			  ...
			  <label class="col-sm-1  control-label">3</label>
			   <label class="col-sm-4 control-label">QCS Date</label>
				<div class="input-group  col-sm-6">
				  ...
				  <input type="text" class="form-control" style="background-color:#E6F2FF;" value="<?php echo $row->ftgs_qcs_date; ?>" readonly name="qcs_date" readonly id="e" style=" line-height: 10px;padding: 0px 8px;   float: none;">
    ...
    <input type="text" class="form-control" style="background-color:#E6F2FF;" readonly value="<?php print_r($dept['dept_name']); ?>" name="txtDeptName" readonly  style=" line-height: 10px;padding: 0px 8px;   float: none;">
			  ...
			  <label class="col-sm-1 pull-left control-label">6</label>
			   <label class="col-sm-4 pull-left control-label">QCS Owner</label>
				<div class="input-group  col-sm-6">
									...
									<input type="text" style="background-color:#E6F2FF;" value="<?php echo $emp_name; ?>" name="txtQcsName" class="form-control"  required>
		...
		<div class="input-group  col-sm-6">
			  ...
			  <label class="col-sm-1 pull-left control-label">7</label>
			   <label class="col-sm-4 pull-left control-label">Plant</label>
				<div class="input-group  col-sm-6">
                 <input type="text" value="<?php echo $row->ftgs_plant_code; ?>" style="background-color:#E6F2FF;" name="txtPlantCode" class="form-control"  required>
			  ...
			  <label class="col-sm-1 pull-left control-label">6</label>
			   <label class="col-sm-4 pull-left control-label">Pr Owner emp</label>
				<div class="input-group  col-sm-6">
                 <?php $eid_owner= $this->method_call->emp_name_pr($row4->ftgs_pr_owner_empcode); ?>
		<input type="text" style="background-color:#E6F2FF;"  name="empnm" value="<?php print_r($eid_owner['emp_name']); ?>" readonly  class="form-control"  required>
	  ...
	  <tr>
			 ...
			 <td style="display:none" >  </td>
			 <td style="display:none" >  </td>
				 <td colspan="3"  >  <input type="text" value="<?php echo $row->ftgs_sup1_nm; ?>" name="txt_sup1_nm" class="form-control full_width"   required> </td>
				 <td colspan="3"  >  <input type="text"  placeholder="Enter 10 Digit Number" value="<?php echo $row->ftgs_sup1_contact_no; ?>"  name="txt_sup1_mno" class="form-control full_width"   > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3"  >  <input type="text" value="<?php echo $row->ftgs_sup1_contact_person; ?>"  name="txt_sup1_contactp" class="form-control full_width"   > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3"  >  <input type="text"  value="<?php echo $row->ftgs_sup1_eid; ?>"   name="txt_sup1_eid" class="form-control full_width"   > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
	  ...
	  <tr>
			 ...
			 <td style="display:none" >  </td>
			 <td style="display:none" >  </td>
				 <td colspan="3"  >  <input type="text"  name="txt_sup2_nm" value="<?php echo $row->ftgs_sup2_nm; ?>" class="form-control full_width"   required> </td>
				 <td colspan="3"  >  <input type="text" value="<?php echo $row->ftgs_sup2_contact_no; ?>" placeholder="Enter 10 Digit Number"   name="txt_sup2_mno" value="" class="form-control full_width"   > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3"  >  <input type="text"  name="txt_sup2_contactp" value="<?php echo $row->ftgs_sup2_contact_person; ?>" class="form-control full_width"   > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3"  >  <input type="text"   name="txt_sup2_eid"  value="<?php echo $row->ftgs_sup2_eid; ?>"  class="form-control full_width"> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
	  ...
	  <tr>
			 ...
			 <td style="display:none" >  </td>
			 <td style="display:none" >  </td>
				 <td colspan="3"  >  <input type="text"  name="txt_sup3_nm" value="<?php echo $row->ftgs_sup3_nm; ?>" class="form-control full_width"   required> </td>
				 <td colspan="3"  >  <input type="text"  value="<?php echo $row->ftgs_sup3_contact_no; ?>" placeholder="Enter 10 Digit Number"   name="txt_sup3_mno" class="form-control full_width"   > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3"  >  <input type="text"  name="txt_sup3_contactp" value="<?php echo $row->ftgs_sup3_contact_person; ?>"  class="form-control full_width"   > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3"  >  <input type="text" value="<?php echo $row->ftgs_sup3_eid; ?>"   name="txt_sup3_eid" class="form-control full_width"   > </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
			   ...
			   <button type="submit" id="" name="step2_pending" value=""class="btn" style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Update</button>
			   	</div>
				 <div class="col-sm-2">
                <a href="<?php echo site_url('FTGS_PR/Ftgs_pr/QCS_Approved_FTGS_tbl') ?>" class="btn" style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Cancel</a>
				</div>
				
				
				 <div class="col-sm-2">
                <a href="<?php echo site_url('FTGS_PR/Ftgs_pr/QCS_DraftStepTwo/'.$ftgs_qcs_id) ?>" class="btn" style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Next</a>
				</div>
                 <div class="col-sm-4">
				</div>
                 </div>
