						...
						<div class="box-body">
							<form id="frm-example" action="" method="POST">
								...
								<br><br><table id="example" class="table table">
									...
									<tbody>
										<?php 
											$phrejectList= $this->method_call->phfetchRejectTBL($emp_code);
											if($phrejectList!=null)
											{
												$sr_no=1;			  
												foreach ($phrejectList->result() as $row)  
												{  
										?>
										<tr>
											<td> <a href="<?php echo site_url('FTGS_PR/Ftgs_pr/ph_rejectFTGSview/'.$row->ftgs_pr_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row->ftgs_pr_id; ?></a></td>
