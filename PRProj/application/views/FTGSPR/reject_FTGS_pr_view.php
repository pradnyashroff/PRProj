						...
						<div class="form-group col-sm-6">
								...
								<div class="form-group col-sm-12">
								 <table id="example" class="table table-bordered table-striped" style="font-size: 12px!important;">
									...
									<form method="post" id="insert_ftgs_reject" name="insert_ftgs_reject" action="<?php echo site_url('FTGS_PR/Ftgs_pr/ftgsRejectPR') ?>" enctype='multipart/form-data'>
									...
									<div class="input-group  col-lg-6">
										<input type="radio" name="rdo_ftgs_status" value="draft" required >&nbsp;&nbsp; Save as Draft</input>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="radio" name="rdo_ftgs_status" value="no_action" > &nbsp;&nbsp; NO ACTION ON FTGS PR</input>
										<input class="form-control" type="hidden" name="txtftgsId" value="<?php echo $ftgs_pr_id; ?>"/>
         							</div>
								</div>
