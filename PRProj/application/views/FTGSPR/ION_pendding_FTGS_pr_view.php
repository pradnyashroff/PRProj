					...
					<div class="box-body">
						...
						<div class="form-group col-sm-6">
								...
								<table id="example" class="table table-bordered table-striped" style="font-size: 12px!important;">
									 ...
									 <form method="post" id="pend_pr" name="pend_pr" action="<?php echo site_url('FTGS_PR/Ftgs_pr/IONAuth_insert') ?>" >
									<div class="form-group col-lg-12">
										<label class="col-lg-4 pull-left control-label">17. &nbsp;&nbsp;&nbsp;ION/Fund NO.</label>
										<div class="input-group  col-lg-6">
											
											<input class="form-control" type="text" id="txt_ionNo" name="txt_ionNo" value="<?php echo $row->ftgs_ion_no; ?>" required>
										</div>
									</div>
									<div class="form-group col-lg-12">
									...
									<?php $plant = $row->ftgs_plant_code;
										$ION_code=$this->method_call->getIONAuthoDetails();;
										$IONCode=$ION_code['ION_Auth'];
									?>
									...
									<?php $IONAuthoEmail=$this->method_call->fetchIONMailDetails($IONCode);?>
									...
									<input class="form-control" type="hidden" name="txtIONAuthoEmail" value="<?php print_r($IONAuthoEmail['IONEmail']); ?>"/>
								...
								<?php $ION_code=$this->method_call->getIONAuthoDetails();?>
									<input type="hidden" value="<?php print_r($ION_code['ION_Auth']); ?>" name="txt_ION_Autho" class="form-control"  required>	
								<?php $ftgsActionData = $this->method_call->ftgsIONAuthoActionData($emp_code,$ftgs_pr_id);
