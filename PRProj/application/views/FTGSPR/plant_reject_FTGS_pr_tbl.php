...
<head>
  ...
  <title>Reject Table Interplant PR FTGS </title>
	...
	<body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >
		...
		<div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
			<section class="content-header">
				<h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">Reject Table Interplant PR FTGS</h1>
				<ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
					...
					<li class="active" style="color:#FFFFFF;text-transform: uppercase;">Reject Table Interplant PR FTGS</li>
				</ol>
			</section>
								...
								<br><br><table id="example" class="table table">
									<thead>
										<tr style="background-color:#3482AE;color:#FFFFFF;">
											...
											<th>PR OWNER NAME</th>
											<th>LOCATION</th>
											<th>PROCURMENT REASON</th>
											<th>PR Status</th>
										</tr>
									</thead>
									<tbody>
										<?php 
											$rejectList= $this->method_call->plant_fetchRejectDetails($emp_code);
											if($rejectList!=null)
											{
												$sr_no=1;			  
												foreach ($rejectList->result() as $row1)  
												{  
										?>
										<tr>
											<td> <a href="<?php echo site_url('FTGS_PR/Ftgs_pr/plantRejectFTGSview/'.$row1->ftgs_pr_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row1->ftgs_pr_id; ?></a></td>
											<td><?php echo $row1->ftgs_pr_date;?></td>
											<td><?php echo $row1->ftgs_pr_owner_name;?></td>
											<td><?php echo $row1->ftgs_delivary_loc;?></td>
											<td><?php echo $row1->ftgs_procurement_res;?></td>
											<td>
												<?php 
													$st = $row1->ftgs_pr_status;;
													$status= "";
													if($st == '2')
													echo 'Reject';
													?></td>
