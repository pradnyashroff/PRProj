  ...
  <?php include_once 'headsidelistFTGS.php'; ?>	
    <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
      <section class="content-header">
        ...
        <li class="active" style="color:#FFFFFF;text-transform: uppercase;">FTGS QCS </li>
        </ol>
      </section>
     <section class="content" id="content">
        <div class="wrapper">
            ...
            <div class="box-body">
                <form method="post" id="main_form" action="<?php echo site_url('FTGS_PR/Ftgs_pr/insertQcsSteptwo') ?>" enctype='multipart/form-data'>
                        ...
                        <div class="box-body">
                          <div class="col-sm-4">
                              ...
                              <div class="input-group  col-sm-6">
                                  <input type="text" name="ftgs_qcs_no" value="<?php echo $row4->ftgs_qcs_id; ?>" style="background-color:#E6F2FF;" readonly class="form-control"  required>
                          ...
                          <div class="col-sm-4">
                              ...
                              <div class="input-group  col-sm-6">
                                <input type="text" style="background-color:#E6F2FF;" readonly name="" value="<?php echo $row4->ftgs_dept_id; ?>" class="form-control"  required>
                  ...
                  <div class="input-group  col-sm-6">
                    <input type="text" class="form-control" style="background-color:#E6F2FF;" readonly name="ftgs_qcs_date" value="<?php echo $row4->ftgs_qcs_date; ?>" readonly >
  ...
  <input type="text" style="background-color:#E6F2FF;"  name="empnm" value="<?php print_r($eid_owner['emp_name']); ?>" readonly  class="form-control"  required>
                ...
                <div class="form-group col-sm-4">
                  ...
                  <div class="input-group  col-sm-6">
					  ...
					  <input type="text" style="background-color:#E6F2FF;" value="<?php echo $row4->ftgs_pr_type; ?>" readonly   name="" class="form-control"  required>
...
<?php $ionno= $this->method_call->fetch_ion_no($row4->ftgs_pr_id);?>
			  ...
			  <input type="text" style="background-color:#E6F2FF;" value="<?php echo $ionno; ?>" readonly   name="" class="form-control"  required>
			  ...
			  <label class="col-sm-1 pull-left control-label">7</label>
			   <label class="col-sm-4 pull-left control-label">Plant</label>
				<div class="input-group  col-sm-6">
    <input type="text" style="background-color:#E6F2FF;" readonly name="pr_plant" value="<?php echo $row4->ftgs_plant_code; ?>" class="form-control"  required>              
...
<div class="box-footer">
  ...
  <input type="hidden"  name="pr_no" value=" <?php echo $row4->ftgs_pr_id; ?>" class="form-control"  required>
...
<div class="col-sm-2"> <a href="<?php echo site_url('purchase/QCS/qcs_step2_list') ?>" class="btn" style="width: 80%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Cancel</a></div>
				...
				<div class="col-sm-4 ">
								...
								<?php
									$autho_code=$this->method_call->getQcsApproval2Autho();;
									$IOCode=$autho_code['autho_code'];
									?>
									<input type="text" value="<?php print_r($autho_code['autho_code']); ?>" name="txt_plant_Autho" class="form-control"  required>
...
$(document).ready(function (){
  ...
  <script type='text/javascript'>
		...
		$('#item_sts').val($(this).children(':selected').attr('data-time4'))
    });
