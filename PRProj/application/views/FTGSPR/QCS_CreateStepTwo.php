  ...
  <input type="text" style="background-color:#E6F2FF;"  name="empnm" value="<?php print_r($eid_owner['emp_name']); ?>" readonly  class="form-control"  required>
                ...
                <div class="form-group col-sm-4">
                  ...
                  <div class="input-group  col-sm-6">
					  ...
					  <input type="text" style="background-color:#E6F2FF;" value="Interplant FTGS PR" readonly   name="" class="form-control"  required>
...
<?php $ionno= $this->method_call->fetch_ion_no($row4->ftgs_pr_id);?>
    ...
    <input type="text" style="background-color:#E6F2FF;" readonly name="pr_plant" value="<?php echo $row4->ftgs_plant_code; ?>" class="form-control"  required>              
        ...
        <input type="hidden" readonly name="pr_id" value="<?php echo $row4->ftgs_pr_id; ?>" class="form-control"  required>
