...
<head>
  ...
  <title>View Approval Interplant PR FTGS </title>
	...
	<body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >
		...
		<div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
			<section class="content-header">
				<h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">View Approval Interplant PR FTGS</h1>
				<ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
					...
					<li class="active" style="color:#FFFFFF;text-transform: uppercase;">View Approval Interplant PR FTGS</li>
				</ol>
			</section>
					...
					<input type="hidden" name="txt_emp_code" placeholder="" value="<?php echo $emp_code; ?>" readonly class="form-control"  required>
					 <input class="form-control" type="hidden" name="txtftgsId" value="<?php echo $ftgs_pr_id; ?>"/>
						...
						<div class="form-group col-sm-6">
								...
								<div class="form-group col-sm-12">
									<label class="col-sm-3 pull-left control-label" style="color:#3482AE">18 &nbsp;&nbsp;&nbsp;&nbspAttachment</label>
								
								<div class="input-group  col-lg-6">
									<?php 
											$filefetch= $this->method_call->fetchAssetAttach($ftgs_pr_id);
											if($filefetch!=null)
											{
												foreach ($filefetch->result() as $rowattach)  
												{  
										?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<a style="color: #337ab7;" href="<?php echo base_url()."uploads/assetFile_attach_ftgs/".$rowattach->assetFile_attach_ftgs;?>"><?php echo $rowattach->assetFile_attach_ftgs; ?></a><br><br>
									...
									<?php $plant = $row->ftgs_plant_code;
										$sanc_code=$this->method_call->fetchsanctionDetails($plant);?>
										<input type="hidden" value="<?php print_r($sanc_code['sanc_id']); ?>" name="sanc_code" class="form-control"  required>
								...
								<div class="col-sm-4">
								<br>
								<button type="submit" onclick="window.print();"  class="btn" id ="printPageButton" class="btn  bg-skincolor " style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);">Print</button></div>
								<div class="col-sm-4"></div>
								</div>
							 </div>
					</div>
