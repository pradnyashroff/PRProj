...
<div class="form-group col-sm-12">
            ...
            <?php echo $row4->ftgs_sup1_nm; ?>
						...
						<div class="form-group col-sm-12">
						 ...
						 <form method="post" id="pend_pr" name="pend_pr" action="<?php echo site_url('FTGS_PR/Ftgs_pr/QcsApproval1_insert') ?>" >
							...
							<?php
								 $autho_code=$this->method_call->getApproval2AuthoDetails();?>
                                  <input type="hidden" value="<?php print_r($autho_code['autho_code']); ?>" name="txt_approval2_Autho" class="form-control"  required>	
									<?php
								$ftgsActionData = $this->method_call->ftgsApproval1Action($emp_code,$ftgs_qcs_id);
