						...
						<div class="form-group col-sm-6">
								...
								<div class="form-group col-sm-12">
								 <table id="example" class="table table-bordered table-striped" style="font-size: 12px!important;">
									 ...
									 <form method="post" id="pend_pr" name="pend_pr" action="<?php echo site_url('FTGS_PR/Ftgs_pr/upadatePend_insert_ftgs_pr') ?>" >
									...
									<?php $PHEmail=$this->method_call->fetchPHMailDetails($PHCode);?>					<!-- Department Head Mail  -->
									...
									<input class="form-control" type="hidden" name="txtPHAuthoEmail" value="<?php print_r($PHEmail['PhEmail']); ?>"/>
								...
								<input type="hidden" name="user_id" class="form-control" value="<?php print_r($ftgsuserid['user']); ?>">
									...
									<?php
								$ftgsActionData = $this->method_call->ftgsActionData($emp_code,$ftgs_pr_id);
