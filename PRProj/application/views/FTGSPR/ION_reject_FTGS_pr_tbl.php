						...
						<div class="box-body">
							<form id="frm-example" action="" method="POST">
								...
								<br><br><table id="example" class="table table">
									...
									<tbody>
										<?php 
											$rejectList= $this->method_call->IONfetchrejectDetails($emp_code);
											if($rejectList!=null)
											{
												$sr_no=1;			  
										...
										?>
										<tr>
											<td> <a href="<?php echo site_url('FTGS_PR/Ftgs_pr/IONrejectFTGSview/'.$row1->ftgs_pr_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row1->ftgs_pr_id; ?></a></td>
