	...
	<body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >
		...
		<div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
			<section class="content-header">
				<h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">Pending CAPEX</h1>
				<ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
					...
					<li class="active" style="color:#FFFFFF;text-transform: uppercase;">CAPEX Pending  FTGS</li>
				</ol>
			</section>
						...
						<div class="box-body">
							<form id="frm-example" action="" method="POST">
								...
								<br><br><table id="example" class="table table">
									...
									<tbody>
										<?php 
											$capexList= $this->method_call->UserApprovedCpxTblData($emp_code);
											if($capexList!=null)
											{
												$sr_no=1;			  
