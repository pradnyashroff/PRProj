...
<li class="active" style="color:#FFFFFF;">View CAPEX
    ...
    <!-- Main content -->
	  ...
	  <form method="post" role="form" enctype="multipart/form-data"  action="<?php echo site_url('FTGS_PR/Ftgs_pr/insert_capexApproval1') ?>" >  
 <!-- Content Wrapper. Contains page content -->
 <div class="wrapper">
...
<?php
								$ftgsActionData = $this->method_call->getCaxapp2AuthoDetails();
                        ...
                        ?>
									...
									<?php
								$ftgsActionData = $this->method_call->ftgscpxIDAction($emp_code,$ftgs_capex_id);
