						...
						<div class="box-body">
							<form id="frm-example" action="" method="POST">
								...
								<br><br><table id="example" class="table table">
									...
									<tbody>
										<?php 
											$phapprovedftgs= $this->method_call->phfetchFTGSApprovalTbl($emp_code);
											if($phapprovedftgs!=null)
											{
												$sr_no=1;			  
												foreach ($phapprovedftgs->result() as $row)  
												{  
										?>
										<tr>
											<td> <a href="<?php echo site_url('FTGS_PR/Ftgs_pr/ph_approvalFTGSview/'.$row->ftgs_pr_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row->ftgs_pr_id; ?></a></td>
