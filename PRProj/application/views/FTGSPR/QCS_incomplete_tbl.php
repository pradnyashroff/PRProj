	...
	<body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >
		...
		<div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
			<section class="content-header">
				<h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">Incomplte QCS</h1>
						...
						<div class="box-body">
							<form id="frm-example" action="" method="POST">
								...
								<br><br><table id="example" class="table table">
									...
									<tbody>
										<?php 
											$QcsList= $this->method_call->fetchIncompQcsTbl($emp_code);
											if($QcsList!=null)
											{
												$sr_no=1;			  
										...
										?>
										<tr>
											<td> <a href="<?php echo site_url('FTGS_PR/Ftgs_pr/QCS_CreateStepTwo/'.$row1->ftgs_qcs_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row1->ftgs_qcs_id; ?></a></td>
											<td><?php echo $row1->ftgs_pr_id;?></td>
											<td><?php echo $row1->ftgs_qcs_date;?></td>
											<td><?php echo $row1->ftgs_qcs_owner;?></td>
											<td><?php echo $row1->ftgs_sup1_nm;?></td>
										
											<td>
												<?php 
													$st = $row1->ftgs_qcs_status;;
													$status= "";
													if($st == '0')
													echo 'Incomplete QCS';
													?></td>
