...
<li class="active" style="color:#FFFFFF;">View CAPEX
    ...
    <!-- Main content -->
	  ...
	  <form method="post" role="form" enctype="multipart/form-data"  action="<?php echo site_url('FTGS_PR/Ftgs_pr/insert_capexApproval4') ?>" >  
 <!-- Content Wrapper. Contains page content -->
 <div class="wrapper">
...
<!--end -->
				  ...
				  <input type="hidden" name="txt_emp_code" value="<?php echo $emp_code; ?>" class=" form-control" id="capex_emp_code"   required>
				    <input type="hidden" name="user_nm" value="<?php echo $emp_name; ?>" class=" form-control" id="capex_emp_nm"   required>
								...
								<?php $UserEmail=$this->method_call->fetchUserMailDetailscpxid($ftgs_capex_id);?>			<!-- UserMail  -->		
								<input class="form-control" type="hidden" name="txtUserAuthoEmail" value="<?php print_r($UserEmail['UserEmail']); ?>"/>
									<?php
								$ftgsActionData = $this->method_call->ftgscpx4IDAction($emp_code,$ftgs_capex_id);
