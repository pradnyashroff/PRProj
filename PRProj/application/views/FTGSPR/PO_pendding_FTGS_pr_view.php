						...
						<div class="form-group col-sm-6">
								...
								<div class="form-group col-sm-12">
								 <table id="example" class="table table-bordered table-striped" style="font-size: 12px!important;">
									 ...
									 <form method="post" id="pend_pr" name="pend_pr" action="<?php echo site_url('FTGS_PR/Ftgs_pr/sourcing1_insert') ?>" >
								...
								<?php $ftgsActionData = $this->method_call->ftgssourcingAuthoActionData($emp_code,$ftgs_pr_id);
                               ...
                               <?php }
								...
								<?php $approval5AuthId = $row->ftgs_plant_code;
									$approval5AuthId=$this->method_call->getApproval5AuthID();;
									$IOCode=$approval5AuthId['autho_code'];
									?>
									<input type="hidden" value="<?php print_r($approval5AuthId['autho_code']); ?>" name="txt_sourcing1_Autho" class="form-control"  required>
