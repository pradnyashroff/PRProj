...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;"> Edit / Delete Item 
    ...
    <!-- Main content -->
	  ...
	  <?php $item_qdetail= $this->method_call->fetchQCSItemInID($ftgs_qcs_item_id);
 if($item_qdetail!=null){
	 foreach ($item_qdetail->result() as $row)  
      ...
      <div class="row" >
	        <form method="POST" action="<?php echo site_url('FTGS_PR/Ftgs_pr/QCSItemUpdate');?>">  
        <div class="col-md-12">
          <!-- Horizontal Form -->
          ...
          <div class="box">
            ...
            <!-- form start -->
			 ...
			 <input type="hidden" name="q_item_id"value="<?php echo $row->ftgs_qcs_item_id; ?>" style="background-color:#E6F2FF;" readonly class="form-control"  required>
			  ...
			  <label class="col-sm-1 pull-left control-label">1</label>
               ...
               <input type="text" name="qid"value="<?php echo $row->ftgs_qcs_id; ?>" style="background-color:#E6F2FF;" readonly class="form-control"  required>
    
                </div>
                </div>
					  <?php $q_detail= $this->method_call->qcs_detail_itemid($ftgs_qcs_item_id);
 if($q_detail!=null){
	 foreach ($q_detail->result() as $rowdata)  
         {  ?>
              ...
              <input type="text" style="background-color:#E6F2FF;" readonly name="pr_id" value="<?php echo $rowdata->ftgs_pr_id; ?>" class="form-control"  required>
			  ...
			  <label class="col-sm-1  control-label">3</label>
			   <label class="col-sm-4 control-label">QCS Date</label>
				<div class="input-group  col-sm-6">
				  ...
				  <input type="text" class="form-control" style="background-color:#E6F2FF;" readonly name="qcs_date" value ="<?php echo $rowdata->ftgs_qcs_date; ?>">
			  ...
			  <label class="col-sm-1 pull-left control-label">4</label>
			   <label class="col-sm-4 pull-left control-label">QCS Owner</label>
				<div class="input-group  col-sm-6">
                  ...
                  <input type="text" class="form-control" style="background-color:#E6F2FF;" readonly name="" value ="<?php echo $rowdata->ftgs_qcs_owner; ?>">
			 ...
			 <div class="form-group col-sm-4">
			  ...
			  <label class="col-sm-1 pull-left control-label">5</label>
			   ...
			   <?php
											$emp_dept=$rowdata->ftgs_dept_id;
											$dept=$this->method_call->department($emp_dept);
										 ?>
										

	  <input type="Text" name="pr_dept" class=" form-control" id="pr_dept" style="background-color:#E6F2FF;" readonly value="<?php print_r($dept['dept_name']); ?>" placeholder="PR Department" required>
	  </div>
                </div>
			  ...
			  <label class="col-sm-1 pull-left control-label">6</label>
			   <label class="col-sm-4 pull-left control-label">Plant</label>
				...
				<input type="text" class="form-control" style="background-color:#E6F2FF;" readonly name="qcs_date" value ="<?php echo $rowdata->ftgs_plant_code; ?>">
 ...
 <div class="form-group col-sm-12">
		  ...
		  <input class="form-control" type="text" name="q_update_itemc" required value="<?php echo $row->ftgs_q_item_code;?>"  data-validation-required-message="Please enter Valid Item code."/>
 ...
 <input class="form-control" type="text" name="q_update_item_desc" required value="<?php echo $row->ftgs_q_item_description; ?>"  data-validation-required-message="Please enter Valid Item Descriptions."/>		 	</div>
				    
         <div class="form-group col-md-4">
                    <label >Required Quantity</label>
 <input class="form-control" type="text" name="q_update_qty" id="qty" onkeyup="mulReq(this.value);" required value="<?php echo $row->ftgs_q_req_quantity; ?>"  data-validation-required-message="Please enter Valid Quantity."/>		 	</div>

  <div class="form-group col-md-4">
                    <label >UOM</label>
				  <select class="form-control" name="q_update_uom" required > 
			<option value="<?php echo $row->ftgs_q_uom; ?>"><?php echo $row->ftgs_q_uom; ?>	</option>				  
...
<option value="Years">	Years	</option>
 ...
 <input class="form-control" type="text" name="q_update_hsn" required value="<?php echo $row->ftgs_q_hsn_code; ?>"  data-validation-required-message="Please enter Valid Item Descriptions."/>	
 </div>		
...
<div class="form-group col-md-2">
 ...
 <!-- supplier1 style="display:block;text-overflow: ellipsis;width:150px;overflow: hidden; white-space: nowrap; -->
 <div class="form-group col-md-4"style="font-size:10px;">
                    <label >1. <?php echo $rowdata -> ftgs_sup1_nm;?></label>
</div>	
		
 <div class="form-group col-md-2">
   <input class="form-control" type="text" name="q_update_quot_rate1" id ="quot_rate1"  onkeyup="mulQuotRate1();"  required value="<?php echo $row->ftgs_quot_rate1; ?>"  data-validation-required-message="Please enter Valid Item Descriptions."/>	                
 ...
 <input class="form-control" type="text" style="background-color:#E6F2FF;" readonly  required name="q_update_quot_amt1" style="background-color:#E6F2FF;" readonly id="quot_amt1" value="<?php echo $row->ftgs_quoted_amt1; ?>"  />	
 </div>
 
 
 
				<div class="form-group col-md-2">
                 <input class="form-control" type="text"   value="<?php echo $row->ftgs_final_rate1; ?>"  required name="ftgs_q_update_final_rate1" id= "final_rate1" onkeyup="mulfinal_amt1();"  value=""  />		
				 </div>
				 
				 <div class="form-group col-md-2">
                  
 <input class="form-control" type="text" style="background-color:#E6F2FF;" readonly required name="q_update_amount1" id="amount1" style="background-color:#E6F2FF;" readonly value="<?php echo $row->ftgs_final_amt1; ?>" />	
 </div>
 

<!-- supplier 2 nm-->			
	<div class="form-group col-md-4"style="font-size:10px;">
                    <label > 2. <?php echo $rowdata -> ftgs_sup2_nm;?></label>
	 	</div>			
<div class="form-group col-md-2">
                   
 <input class="form-control" type="text" value="<?php echo $row->ftgs_quot_rate2; ?>"   required name="q_update_quot_rate2" id="quot_rate2" onkeyup="mulQuotRate2();"  value=""  />
 </div>
 
 <div class="form-group col-md-2">
                   
 <input class="form-control" type="text" style="background-color:#E6F2FF;" readonly value="<?php echo $row->ftgs_quoted_amt2; ?>" style="background-color:#E6F2FF;" readonly required name="q_update_quot_amt2" id="quot_amt2" value=""  />	
 </div>
 
 
<div class="form-group col-md-2">
                   
 <input class="form-control" type="text"  value="<?php echo $row->ftgs_final_rate2; ?>"  required name="q_update_final_rate2" id="final_rate2"  onkeyup="mul_final_quat2();"   />		 	</div>
 
<div class="form-group col-md-2">
                   
 <input class="form-control" type="text" style="background-color:#E6F2FF;" readonly value="<?php echo $row->ftgs_final_amt2; ?>"style="background-color:#E6F2FF;" readonly required name="q_update_amount2" id="amount2"   />		 	</div>
 ...
 <!-- Supplier 3-->
 	...
 	<div class="form-group col-md-4"style="font-size:10px;">
 <label > 3.  <?php echo $rowdata -> ftgs_sup3_nm;?></label>
  	</div>
			
			
<div class="form-group col-md-2">
                  
 <input class="form-control" type="text" onkeyup="mulQuotRate3();"   required name="q_update_quot_rate3" id="quot_rate3" value="<?php echo $row->ftgs_quot_rate3; ?>"  />	
 </div>
 
 <div class="form-group col-md-2">
                  
 <input class="form-control" type="text" style="background-color:#E6F2FF;" readonly required name="q_update_quot_amt3" style="background-color:#E6F2FF;" readonly id="quot_amt3" value="<?php echo $row->ftgs_quoted_amt3; ?>"  />	
 </div>
 
<div class="form-group col-md-2">
                    
 <input class="form-control" type="text" onkeyup="mul_final_quat3();" required name="q_update_final_rate3"  id="final_rate3" value="<?php echo $row->ftgs_final_rate3; ?>"     />
 </div>
 
<div class="form-group col-md-2">
                    
 <input class="form-control" type="number" style="background-color:#E6F2FF;" readonly required name="q_update_amount3" style="background-color:#E6F2FF;" readonly id="amount3" value="<?php echo $row->ftgs_final_amt3; ?>"     />
 </div>
...
<div class="col-sm-2">
 ...
 <button type="submit" id="item_btnold" class="btn" style="width: 80%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Update Item</button>
	...
	<!-- Delete Item -->
	<form method="post" action="<?php echo site_url('FTGS_PR/Ftgs_pr/QcsDeleteItem/'.$row->ftgs_qcs_item_id);
			?>">
			  
<input type="hidden"  name="del_itemid" value="<?php echo $row->ftgs_item_id; ?>" class="form-control"  >
<div class="col-sm-2">
...
<script>
	function mulQuotRate1(){
		...
		document.getElementById('quot_amt1').value = multiply1;	
...
<script>
	function mulQuotRate2(){
		...
		document.getElementById('quot_amt2').value = multiply2;	
...
<script>
		...
		function mulQuotRate3(){
				...
				document.getElementById('quot_amt3').value = multiply3;	
...
<script>
		 ...
		 function mulfinal_amt1(){
			...
			document.getElementById('amount1').value = multiplyFinal1;	
...
<script>
		function mul_final_quat2(){
			...
			document.getElementById('amount2').value = multiplyFinal2;	
...
<script>
		function mul_final_quat3(){
			...
			document.getElementById('amount3').value = multiplyFinal3;	
