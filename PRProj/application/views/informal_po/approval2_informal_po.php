...
?>
     ...
     <ol class="breadcrumb">
        <li><a href="<?php echo site_url('Welcome/index') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
         <li> <a href="<?php echo site_url('purchase/informal_po/informal_po_menu') ?>">Informal PO                      </a></li>
...
<form method="post" id="main_form" action="<?php echo site_url('purchase/informal_po/approval2_po'); ?>" enctype='multipart/form-data'>
...
<!-- po deatil -->
             <div class="box-header with-border">
			  ...
			  <label class="col-sm-1 pull-left control-label">1</label>
			   <label class="col-sm-4 pull-left control-label"> PO NO </label>
				<div class="input-group  col-sm-6">
                      <input type="text" name="po_no" value="<?php echo $po_row->informal_po_id; ?>" readonly class="form-control"  required>
			  ...
			  <label class="col-sm-1 pull-left control-label">2</label>
			   <label class="col-sm-4 pull-left control-label">Plant</label>
				<div class="input-group  col-sm-6">
                 <input type="Text" name="po_plant" class="form-control"  readonly value="<?php echo $po_row->plant_code; ?>"  required>                          
			  ...
			  <label class="col-sm-1 pull-left control-label">3</label>
			   <label class="col-sm-4 pull-left control-label">PO Date/Time</label>
				<div class="input-group  col-sm-6">
                 <input type="Text" name="po_date" class="form-control"  readonly value="<?php echo $po_row->informal_po_date; ?>"   required>                          
 ...
 <input type="hidden" name="po_pr_empcode" class=" form-control" readonly value="<?php echo $po_row->pr_owner; ?>"  required>  				  
			  ...
			  <label class="col-sm-1 pull-left control-label">5</label>
			   <label class="col-sm-4 pull-left control-label">PR Owner</label>
				<div class="input-group  col-sm-6">
                 <input type="Text" name="po_pr_owner" class="form-control"  readonly value="<?php echo $po_row->pr_owner_name; ?>"  required>                          
			  ...
			  <label class="col-sm-1 pull-left control-label">6</label>
			   <label class="col-sm-4 pull-left control-label">PR Date/Time</label>
				<div class="input-group  col-sm-6">
                 <input type="Text" name="po_pr_date" class="form-control"  readonly value="<?php echo $po_row->pr_date; ?>"  required>                          
			 ...
			 <div class="form-group col-sm-4">
			  ...
			  <label class="col-sm-1 pull-left control-label">7</label>
			   <label class="col-sm-4 pull-left control-label">QCS No</label>
				...
				<div class="input-group  col-sm-6">
                <input type="hidden" name="po_qcs_no" class=" form-control" href="#qcsModal<?php echo $po_row->qcs_id?>" data-toggle="modal" data-target="#qcsModal"  readonly value="<?php echo $po_row->qcs_id; ?>" required>                        
		 ...
		 <div class="form-group col-sm-4">
			  ...
			  <label class="col-sm-1 pull-left control-label">8</label>
			   <label class="col-sm-4 pull-left control-label">QCS Owner</label>
				<div class="input-group  col-sm-6">
				 ...
				 <input type="Text" name="po_qcs_nm" class="form-control" readonly value="<?php echo $po_row->qcs_owner; ?> "required> 
			  ...
			  <label class="col-sm-1 pull-left control-label">9</label>
			   <label class="col-sm-4 pull-left control-label">QCS Date/Time</label>
				<div class="input-group  col-sm-6">
                 <input type="Text" name="po_qcs_date" class="form-control"  readonly value="<?php echo $po_row->qcs_date; ?> "  required>                          
 ...
 <div class="form-group col-sm-12">
			  ...
			  <label class="pull-left control-label"><h4>2 .</h4></label>
			   <label class="col-sm-5 pull-left control-label"><h4>Final Supplier</h4></label>
				<div class="input-group  col-sm-6" style="color:red;">
...
<!-- item detail  -->
 <div class="box-header with-border">
		...
		<tr>
				   ...
				   <th >Qty.</th>
				   <th >UOM</th>
				 <th colspan="4" style="color:red;"><center> <?php echo $po_row->selected_supplier; ?>   <center></th>
  ...
  <div class="box-header with-border">
		...
		<br>
                ...
                <tbody>
				 ...
				 <td colspan="7" style="color:red" ><b> Supplier   :&nbsp;&nbsp; <?php echo $po_row->selected_supplier; ?></b> </td>
...
foreach ($item->result() as $rowhistory)  
	...
	<div class="form-group col-sm-12">
			 ...
			 <label class="pull-left control-label"><h4>11</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4>MDO Comment</h4></label>
			...
			<?php $emp_name= $this->method_call->fetch_emp_name($po_row->po_approval_level1); ?>
                 ...
                 <?php if($po_row->po_approval_level1_cmt == null){
					 echo "Approval Pending From MDO  ($emp_name)" ;
					 
				 }else{
					 $mdo_dt= $this->method_call->fetch_po_status_dt($informal_po_id,$po_row->po_approval_level1);
		echo $po_row->po_approval_level1_cmt; echo ' ('.$emp_name.')';
			 ...
			 <label class="pull-left control-label"><h4>12</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4>Sourcing Comment</h4></label>
				<h5><div class="input-group  col-sm-6">
			<?php $emp_name= $this->method_call->fetch_emp_name($po_row->qcs_approval); ?>

                 <?php if($po_row->qcs_approval_level2_cmt == null){
					 echo "Approval Pending From Sourcing  ($emp_name)" ;
					 
				 }else{
					 $cfo_dt= $this->method_call->fetch_po_status_dt($informal_po_id,$po_row->qcs_approval);
				 echo $po_row->qcs_approval_level2_cmt; echo ' ('.$emp_name.')('.$cfo_dt.')';
			 ...
			 <label class="pull-left control-label"><h4>13</h4></label>
	...
	<div class="form-group col-sm-12">
			 ...
			 <label class="pull-left control-label"><h4>14</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4>Approver Comment</h4></label>
				<div class="input-group  col-sm-6">
                 
               
                 
                   <textarea name="po_approver_cmt" rows="4" cols="50"  required ></textarea>
...
<input type="hidden" name="po_empcode" class="form-control"  readonly value="<?php echo $po_row->informal_po_empcode; ?> "  required>   
  <?php $eid_owner= $this->method_call->fetchemp_email($po_row->informal_po_empcode); ?>
  <input type="hidden" name="po_owner_eid" value="<?php print_r($eid_owner['emp_email']); ?>" readonly  class="form-control"  >
  

 <input type="hidden" name="po_approval2_emp" class="form-control"  readonly value="<?php echo $emp_code; ?> " required>  
 <?php $eid_owner= $this->method_call->fetchemp_email($emp_code); ?>
  <input type="hidden" name="qcs_eid" value="<?php print_r($eid_owner['emp_email']); ?>" readonly  class="form-control"  >
  
  
  	 <input type="hidden" name="qcs_nm" class="form-control" readonly value="<?php echo $po_row->qcs_owner; ?> "required> 
...
<div class="col-sm-2"><button type="submit" id="btn-submit" class="btn  bg-skincolor " style="border: 1px solid orange;width: 100%;">Proceed</button></div>

<div class="col-sm-2"> <a href="<?php echo site_url('purchase/informal_po/index') ?>" class="btn  bg-skincolor pull-right" style="border: 1px solid orange;width: 100%; ">Cancel</a></div>
...
<div class="modal-dialog" role="document" style="width:980px;">
	...
	<input type="Text" name="pr_plant" class="form-control"  readonly value="  <?php echo $po_row->pr_id; ?>"  required>     
			  ...
			  <label class="col-sm-1 pull-left control-label">2</label>
			   <label class="col-sm-5 pull-left control-label">PR Owner nm</label>
				<div class="input-group  col-sm-6">
				<input type="Text" name="pr_owner_name" class="form-control"  readonly value="<?php echo $po_row->pr_owner_name; ?>" required>  
			  ...
			  <label class="col-sm-1 pull-left control-label">3</label>
			   <label class="col-sm-5 pull-left control-label">Plant</label>
				<div class="input-group  col-sm-6">
				<input type="Text" name="pr_plant" class="form-control"  readonly value="<?php echo $po_row->plant_code; ?>" required>  
			  ...
			  <label class="col-sm-1 pull-left control-label">4</label>
			   <label class="col-sm-5 pull-left control-label">Department</label>
				...
				<?php $dept_nm= $this->method_call->fetch_dept_nm($po_row->dept_id); ?>
						   <input type="Text" name="pr_dept_nm" class=" form-control" id="pr_dept" readonly value="<?php print_r($dept_nm['dept_name']); ?>"  required>
	  ...
	  <div class="form-group col-sm-6">
			  ...
			  <label class="col-sm-1 pull-left control-label">6</label>
			   <label class="col-sm-5 pull-left control-label">PR Date</label>
				<div class="input-group  col-sm-6">
			  <input type="Text" name="pr_dept" class=" form-control" id="pr_dept" readonly value="<?php echo $po_row->pr_date; ?>"  required>
                </div>
                </div>
  ...
  <div class="box-header with-border">
            ...
            <div class="row">
			 ...
			 <td style="display:none" >  </td>
				 ...
				 <td colspan="3" style="color:red" ><b> <center>Selected Supplier   :&nbsp;&nbsp; <?php echo $po_row->sup1_nm; ?><center></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3" style="color:#00008B" ><b><center>Supplier 2  :&nbsp;&nbsp;<?php echo $po_row->sup2_nm; ?><center></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3" style="color:#00008B" ><b><center>Supplier 3  :&nbsp;&nbsp;<?php echo $po_row->sup3_nm; ?><center></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
...
$('#btn-submit').on('click',function(e){
    ...
    swal({
        ...
        if (isConfirm){			 
				 form.submit();		
 swal("Submitted!", "Your PO  Recorded Successfully.", "success");				 
				} 
    }
