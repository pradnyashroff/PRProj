...
<head>
  ...
  <title>Informal PO Pending List </title>
...
<body class="hold-transition skin-blue sidebar-mini" >
 ...
 Informal PO Pending List
     ...
     <ol class="breadcrumb">
       ...
       <li> <a href="<?php echo site_url('purchase/informal_po/index') ?>">Informal PO</a></li>

<li class="active">Informal PO Pending List</li>
 ...
 <br><br><table id="example" class="table">
			...
			<!-- approved list -->
				 ...
				 $qcs_approved = $this->method_call->pending_po_list($emp_code);
...
foreach ($qcs_approved->result() as $row)  
		...
		<?php $po_owner_nm= $this->method_call->fetch_emp_name($row->informal_po_empcode); ?>
            ...
            <td >  <a href="<?php echo site_url('purchase/informal_po/view_informal_po/'.$row->informal_po_id);?>"> Informal PO No <?php echo $row->informal_po_id;?> </a></td> 
