...
<li class="active"style="color:#FFFFFF;text-transform: uppercase;">Create PO</li>
</li>
      </ol>
...
<form method="post" id="main_form" action="<?php echo site_url('purchase/informal_po/reject_draft_po'); ?>" enctype='multipart/form-data'>
...
<!-- po deatil -->
             <div class="box-header with-border">
					   ...
					   <div class="box-header with-border">
              <h4 class="box-title">1 . Informal PO Details</h4>
...
<!-- item detail  -->
 <div class="box-header with-border">
					   <div class="box box-default ">
					   <div class="box-header with-border">
              <h4 class="box-title">3 . Item Details</h4>
...
<!-- Technical Declaration -->
  ...
  <div class="box-header with-border">
					   ...
					   <div class="box-header with-border">
              <h4 class="box-title">4 . Technical Specification Comparison</h4>
...
<!--end -->
	 ...
	 <div class="form-group col-sm-12">
			  ...
			  <label class="pull-left control-label"><h4 style="font-family:'exo';">6</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4 style="font-family:'exo';">QCS Attachments </h4></label>
				<div class="input-group  col-sm-6">
                 
                <div class="form-group col-sm-12">
			    <div class="col-sm-5 " style="font-family:'exo';">
 ...
 <?php }
			  ...
			  <label class="pull-left control-label"><h4 style="font-family:'exo';">7</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4 style="font-family:'exo';">Informal PO Attachments</h4></label>
			  	<div class="input-group  col-sm-6"> 
				<div class="form-group col-sm-12">
				<div class="input-group  col-sm-6">
                  <input type="file"  name="informal_po_attachment"  class="form-control"  >
...
<input type="hidden" class="form-control" value="<?php echo $po_row->informal_po_attachment ?>" name="attachment_check"/>
		    ...
		    <div class="table-responsive" style="width:95%;margin-left:2%;">
				&nbsp;&nbsp;<h4><b><h4 style="color:#3482AE;text-transform: uppercase;font-family:'exo';">8.&nbsp;&nbsp;  Approval History</h4></b> </h4>
...
foreach ($item->result() as $rowhistory)  
		 ...
		 <?php  }
			 ...
			 <div class="box-header with-border">
					   <div class="box box-default">
					   <div class="box-header with-border">
              <h3 class="box-title">9. Item Code Updation</h3>
...
<!--end --> 
			 ...
			 <label class="pull-left control-label"><h4 style="font-family:'exo';">10</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4 style="font-family:'exo';">Justification for Informal PO</h4></label>
				<div class="input-group  col-sm-6">
				
				
				 <textarea class="form-control" maxlength="250" rows="5" name="draft_justi_info_po" id="justi_info_po"><?php  echo $po_row->just_informal_po; ?> </textarea>
                 <div id="the-count">
			...
			<div class="input-group  col-sm-3">
                 <input type="hidden" name="po_app_lev1" class="form-control"  readonly value="<?php echo $po_row->qcs_emp_code; ?>">
				 
  <?php $eid_owner= $this->method_call->fetchemp_email($po_row->qcs_emp_code); ?>
  <input type="hidden" name="po_app_lev1_email" value="<?php print_r($eid_owner['emp_email']); ?>" readonly  class="form-control">				 
			 ...
			 <input type="hidden" name="info_po_status" class="form-control"  readonly value="<?php echo 'informal_po_created'; ?>"  required>		
...
<div class="col-sm-2"><button type="submit"  class="btn" id="btn-submit" style="width: 70%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);text-transform: uppercase;">Proceed</button></div>

<div class="col-sm-2"> <a href="<?php echo site_url('purchase/informal_po/index') ?>" class="btn" style="width: 70%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);text-transform: uppercase;">Cancel</a></div>
...
<!-- end -->	
  ...
  <div class="box-header with-border ">
            ...
            <div class="row">
			 ...
			 <td style="display:none" >  </td>
			 <td style="display:none" >  </td>
				 <td colspan="6"style="text-transform: uppercase;font-family:'exo';" >Technical Specification</td>
				 <td colspan="3" ><b> <center>Selected Supplier   :&nbsp;&nbsp; <?php echo $po_row->sup1_nm; ?><center></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3"style="text-transform: uppercase;font-family:'exo';" ><b><center>Supplier 2  :&nbsp;&nbsp;<?php echo $po_row->sup2_nm; ?><center></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
				  <td colspan="3"style="text-transform: uppercase;font-family:'exo';" ><b><center>Supplier 3  :&nbsp;&nbsp;<?php echo $po_row->sup3_nm; ?><center></b> </td>
				 <td style="display:none" >  </td>
				 <td style="display:none"> </td>
...
<div class="modal-dialog" role="document" style="width:600px;">
  ...
  <form id="itemDetails" name="itemDetails" action="<?php echo site_url('purchase/informal_po/updateItemCodeEdit'); ?>" method="post">
            <div class="row">
			 ...
			 <label class="col-sm-1 pull-left control-label">2</label>
			   <label class="col-sm-5 pull-left control-label">Item Description</label>
				<div class="input-group  col-sm-6">
...
$('#btn-submit').on('click',function(e){
    ...
    swal({
        ...
        if (isConfirm){			 
				 form.submit();		
 swal("Submitted!", "Your PO Forwareded Successfully.", "success");				 
				} 
    }
