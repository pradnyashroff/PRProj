...
<!--end -->
					    ...
					    <div class="table-responsive" style="width:99%;margin-left:1%;">
				<h4><b><h4 style="color:#3482AE;text-transform: uppercase;font-family:'exo';">6.&nbsp;&nbsp;  Approval History</h4></b> </h4>
...
foreach ($item->result() as $rowhistory)  
	 ...
	 <div class="form-group col-sm-12" id="q_attachement">
			  ...
			  <label class="pull-left control-label"><h4>7</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4 style="color:#3482AE;text-transform: uppercase;font-family:'exo';">QCS Attachments </h4></label>
				<div class="input-group  col-sm-6">
 ...
 <?php }
			  ...
			  <label class="pull-left control-label"><h4>8</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4 style="color:#3482AE;text-transform: uppercase;font-family:'exo';">Informal PO Attachments</h4></label>
			  	<div class="input-group  col-sm-6"> 
				<div class="form-group col-sm-12">
						 <div class="col-sm-5" >
			  ...
			  <label class="pull-left control-label"><h4>9</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4>Justification of Informal PO</h4></label>
				...
				<div class="form-group col-sm-12">
								...
								<h4 style="color:#3482AE;text-transform: uppercase;font-family:'exo';" ><?php  echo $po_row->just_informal_po; ?></h4>
...
<div class="col-sm-2"><button type="button"  class="btn " id="printPageButton" onClick="window.print();" style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);text-transform: uppercase;font-family:'exo';">Print</button></div>
