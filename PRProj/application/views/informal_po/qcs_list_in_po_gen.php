...
<li class="active"style="color:#FFFFFF;text-transform: uppercase;">Informal PO Pending List</li>
 ...
 <br><br><table id="example" class="table">
              ...
              <tr style="background-color:#3482AE;color:#FFFFFF;">
                ...
                <tbody>
				 ...
				 $qcs_approved = $this->method_call->qcs_approved_polist($emp_code);
...
foreach ($qcs_approved->result() as $row)  
         {  ?>
            ...
            <td >  <a href="<?php echo site_url('purchase/informal_po/create_po/'.$row->qcs_id);?>"> QCS <?php echo $row->qcs_id;?> </a></td> 
