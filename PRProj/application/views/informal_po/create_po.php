...
<li class="active" style="color:#FFFFFF;text-transform: uppercase;">Create PO                                                                                                                                                     
</li>
</li>
      </ol>
 ...
 <div class="wrapper">
	  ...
	  <?php $qcs_detail= $this->method_call->qcs_po_detail($qcs_id);
 if($qcs_detail!=null){
 ...
 <div class="box-header with-border">
	...
	<tr style="background-color:#3482AE;color:#FFFFFF;">
				 ...
				 <th colspan="4"><center> FINAL SUPPLIER : <?php echo $po_row->selected_supplier; ?>   <center></th>
...
foreach ($view_item->result() as $rowitem)  
         {  ?>
            ...
            <td>  <?php echo $rowitem->q_hsn_code; ?></td> 
              <form class="form" id="frmupdate" role="form" action="<?php echo site_url('purchase/informal_po/updateItemCode'); ?>" method="POST">
            <td> <input type="hidden" name="qcs_item_id" id="qcs_item_id" class="form-control" value=" <?php echo $rowitem->qcs_item_id; ?>"></td>
            <td> <input type="text" name="q_item_code" id="q_item_code" class="form-control" value=" <?php echo $rowitem->q_item_code; ?>"></td>
            <td><input type="submit" class="btn"style="width: 70%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);text-transform: uppercase;" id="exampleInputPassword2" value="update"></td>
            </form>
...
<form method="post" id="main_form" action="<?php echo site_url('purchase/informal_po/insert_po'); ?>" enctype='multipart/form-data'>
             ...
             <div class="box-header with-border">
			  ...
			  <label class="col-sm-1 pull-left control-label">1</label>
			   <label class="col-sm-4 pull-left control-label"> PO NO </label>
				<div class="input-group  col-sm-6">
                      <input type="text" name="po_no" value="auto-genrated" style="background-color:#E6F2FF;" readonly class="form-control"  required>
			  ...
			  <label class="col-sm-1 pull-left control-label">3</label>
			   <label class="col-sm-4 pull-left control-label">PO Date/Time</label>
				<div class="input-group  col-sm-6">
                 <input type="Text" name="po_date" class="form-control" style="background-color:#E6F2FF;"  readonly value="" id="e"  required>                          
<script>
		 ...
		 <div class="form-group col-sm-4">
			  ...
			  <label class="col-sm-1 pull-left control-label">9</label>
			   <label class="col-sm-4 pull-left control-label">QCS Date/Time</label>
				...
				<input type="hidden" name="po_qcs_owner" class="form-control" style="background-color:#E6F2FF;"  readonly value="<?php echo $po_row->qcs_emp_code; ?> "  required>
				
				<!-- end -->
				
			 <?php $eid_owner= $this->method_call->fetchemp_email($po_row->pr_owner_empcode); ?>
  <input type="hidden" name="po_owner_eid" value="<?php print_r($eid_owner['emp_email']); ?>" style="background-color:#E6F2FF;" readonly  class="form-control"  >
...
<!--end -->
 ...
 <div class="form-group col-sm-12">
          ...
          <h4><?php echo $po_row->selected_supplier; ?> </h4>
                	...
                	<input type="hidden" name="final_sup" class="form-control" readonly value="<?php echo $po_row->selected_supplier; ?> "  required>
				</br>
				</br>
<!-- item detail  -->
 <div class="box-header with-border">
			 ...
			 <label class="pull-left control-label"><h4>8</h4></label>
			   <label class="col-sm-4 pull-left control-label"><h4 style="font-family:'exo';">Justification for Informal PO</h4></label>
				<div class="input-group  col-sm-6">
				 ...
				 <textarea class="form-control" maxlength="250" rows="5" name="justi_info_po" id="justi_info_po"> </textarea>
                 <div id="the-count">
...
<div class="col-sm-2"><button type="submit" id="btn-submit" class="btn " style="width: 70%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);text-transform: uppercase;font-family:'exo';">Create PO </button></div>

<div class="col-sm-2"> <a href="<?php echo site_url('purchase/informal_po/index') ?>" class="btn  " style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Cancel</a></div>
	  ...
	  <div class="form-group col-sm-6">
		   ...
		   <div class="form-group col-sm-6">
			  ...
			  <div class="table-responsive" style="width:100%;">
                ...
                <tbody>
				  <?php $item= $this->method_call->list_pr_items($qcs_id);
				  				  $final_rate=0;
...
$(document).ready(function (){
    $("#frmupdate").submit(function(e){
        ...
        $.ajax({
             alert("in ......");
            url:'<?php echo base_url() ?>/purchase/informal_po/updateItemCode',
            type:'POST',
            dataType:'json',
