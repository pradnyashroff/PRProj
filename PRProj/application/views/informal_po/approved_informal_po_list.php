...
<head>
  ...
  <title>Informal PO Approved List </title>
...
<li class="active"style="color:#FFFFFF;text-transform: uppercase;">Informal PO Approved List</li>
 ...
 <br><br><table id="example" class="table ">
			...
			<!-- approved list -->
				 ...
				 $qcs_approved = $this->method_call->approved_po($emp_code);
