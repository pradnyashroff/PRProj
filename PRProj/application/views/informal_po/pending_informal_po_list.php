 ...
 <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
  ...
  Informal PO Pending List
     ...
     <ol class="breadcrumb" style="color:#FFFFFF;">
       ...
       <li> <a href="<?php echo site_url('purchase/informal_po/index') ?>" style="color:#FFFFFF;">Informal PO</a></li>

<li class="active" style="color:#FFFFFF;">Informal PO Pending List</li>
 ...
 <br><br><table id="example" class="table " >
				 ...
				 <th scope="col" style="text-align: center;width: 10%;">Informal PO No</th>
				   <th scope="col" style="text-align: center;width: 10%;"> Date / Time</th>
                 
				  <th scope="col" style="text-align: center;width: 10%;">Informal PO Owner</th>
				 <th scope="col" style="text-align: center;width: 10%;">Informal PO Status</th>
				...
				<!-- Pending  list -->
				 ...
				 $Pending = $this->method_call->pending_po_list($emp_code);
 if($Pending!=null){
...
foreach ($Pending->result() as $row)  
		...
		<?php $po_owner_nm= $this->method_call->fetch_emp_name($row->informal_po_empcode); ?>
            ...
            <td style="text-align:center">  <a href="<?php echo site_url('purchase/informal_po/view_informal_po/'.$row->informal_po_id);?>"> Informal PO No <?php echo $row->informal_po_id;?> </a></td> 
			<td style="text-align:center"><?php echo $row->informal_po_date;?></td>
							 
            <td style="text-align:center"><?php echo $po_owner_nm;?></td>
			<td style="text-align:center"><?php echo $row->informal_po_status;?></td>
