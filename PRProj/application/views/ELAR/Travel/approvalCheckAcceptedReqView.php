    ...
    <div class="modal-dialog" role="document" style="width: 720px;">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#3482AE">
                ...
                <h4 class="modal-title"style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">Add Person Detail</h4>
            </div>
         ...
         {  ?>
                              ...
                              <option value="<?php echo $row8->emp_code ; ?>"> <?php echo $row8->emp_name; ?></option>
                                    ...
                                    <div class="form-group col-md-4">
                                       ...
                                       <button type="submit" name="save"  class="btn  bg-skincolor" style="border: 1px solid orange;">Add Details</button>
                                         </div>
                                    </form>
                              </div>
                                 </section>
