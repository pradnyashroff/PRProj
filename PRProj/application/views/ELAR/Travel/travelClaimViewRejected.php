...
foreach ($conveyanceList->result() as $row)  
			  ...
			  <label class="col-sm-1 pull-left control-label">4</label>
               ...
               <?php }
					...
					<div class="box-header with-border">
					   <div class="box box-default ">
					   <div class="box-header with-border">
              <h3 class="box-title">7 . Claim Actions Log</h3>
	  ...
	  <tr>
         ...
         <?php $sr_no++;}
                   ...
                   <form method="post" id="crateClaim" name="crateClaim" action="<?php echo site_url('ELAR/Travel/Travel_cntr/userActionOnRejectedClaim') ?>" >
          ...
          <div class="form-group col-sm-12">
						 ...
						 <div class="input-group  col-sm-10">
								<center>
                                        <input class="form-control" type="hidden" name="trv_mst_id" value="<?php echo $trv_mst_id; ?>"/>
                                        <button type="submit" name="save" class="btn" style="background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Save</button>
    ...
    <div class="modal-dialog" role="document" style="width: 720px;">
        <div class="modal-content">
             <div class="modal-header" style="background-color:#3482AE">
                ...
                <h4 class="modal-title"style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;"> Add Daily Convenience Details</h4>
            </div>
            <div class="modal-body">
