...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';">    	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">TRAVEL CONVEYANCES APPROVED TABLE
                    <?php
                    if (isset($error)) {
      ...
      <div class="row">
        ...
        <table id="example" class="table table">
                ...
                <tbody>
                     <?php $claimApprovHodList= $this->method_call->fetchTrvelReimApprovalHODClaim($emp_code);
                 $final_rate=0; 	   
...
foreach ($claimApprovHodList->result() as $row)  
         {  ?>
                <tr>
                  <td> <a class="glyphicon glyphicon-edit" style="color:red;" href="<?php echo site_url('ELAR/Travel/Travel_cntr/approval_travel_claim_approved_view/'.$row->trv_mst_id);?>"><?php echo $row->trv_mst_id; ?></a></td>
