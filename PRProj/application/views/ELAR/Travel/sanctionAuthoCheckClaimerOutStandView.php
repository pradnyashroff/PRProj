         ...
         <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                   ...
                   <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Claimer Outstanding View
                    </li>
                    </li>
                </ol>
            </section>
                      ...
                      <tr> <th>Balance IOU Amount: </th>
                       <td>
                           <?php $claimer=$this->method_call->getClaimerDetails($trv_mst_id);
                            ...
                            $iou_tr_id=$this->method_call->fetchBalanceIOUOutStandingID($emp_id);
         ...
         {  ?>
		   ...
		   <?php  $sr_no++; }
			 ...
			 <td colspan="3"><?php echo $row->trv_mst_id; ?></td>
			    ...
			    <form method="post" id="finalizingClaim" name="finalizingClaim" action="<?php echo site_url('ELAR/Travel/Travel_cntr/claimerOutstandingAmtClearAction') ?>" >
		
			   <div class="form-group col-sm-12">
			  <?php $tt_id=$this->method_call->fetchBlanceTravelOutStandingID($trv_mst_id);
			...
			<div class="input-group  col-sm-8">
                <textarea class="form-control" placeholder="Justification" required rows="4" cols="50" style="width:50%; name="areaJustif"></textarea>
                </div>
                </div>                  
               <div class="col-sm-12">
