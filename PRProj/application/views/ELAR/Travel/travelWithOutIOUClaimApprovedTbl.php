    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';">    	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
                <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">TRAVEL REIMBURSEMENTS CLAIM WITHOUT IOU APPROVED
                    <?php
                    if (isset($error)) {
        ...
        <table id="example" class="table table">
                ...
                <tbody>
                     <?php $approvedClaimList= $this->method_call->fetchWithoutIOUTravelReimApprovedDetailsTbl($emp_code);
                 $final_rate=0; 	   
...
foreach ($approvedClaimList->result() as $row)  
         {  ?>
                <tr>
                  ...
                  <td> <a href="<?php echo site_url('ELAR/Travel/Travel_cntr/travel_without_iou_claim_approved_view/'.$row->trv_mst_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row->trv_mst_id; ?></a></td>
