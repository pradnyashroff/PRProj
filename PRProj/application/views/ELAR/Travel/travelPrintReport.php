       ...
       <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            <div class="container-fluid">
                <!-- Breadcrumbs--><div class="card">
                    <div class="wrapper" style="margin-left:5%; margin-right:5%; margin-top:2%">
                      
                                <br><br>
                                <div class="title">
                                    <center><h5 style="font-family:'exo';"><b style="color:#FF0000">TRAVEL REIMBURSEMENT CLAIM</b></h5></center>
                                </div>
  ...
  <tr>
    ...
    <?php  }
        ...
        <hr>
                            ...
                            <h5 style="font-family:'exo';">Traveling Details - Total Amount: &#8377;<label id="lblTrvlTotalAmt"></label>/-  </h5>
                            <div class="form-group col-sm-12">

                                <table style="font-family: exo; font-size: 12px" id="example" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Date</th>
                                            <th>From Station</th>
...
?>
 ...
 <div class="box-header with-border">
	  ...
	  <div class="box-body">
        ...
        <table id="hotels" style="font-family: exo; font-size: 12px" class="table table-bordered">
                <thead>
                <tr>
                  <th>Date From</th>
                  <th>Date To</th>
...
foreach ($conveyanceList->result() as $row)  
 ...
 <div class="box-header with-border">
	  ...
	  <div class="box-body">
        ...
        <table style="font-family: exo; font-size: 12px" id="travelIntraCity" class="table table-bordered">
                <thead>
                <tr>
                  <th>Date</th>
                  <th>Place From</th>
...
foreach ($conveyanceList->result() as $row)  
 ...
 <div class="box-header with-border">
	  ...
	  <div class="box-body">
                        ...
                        <table style="font-family: exo; font-size: 12px" id="MealDetails" class="table table-bordered">
                <thead>
                <tr>
                  <th>Emp Code</th>
                  <th>Emp Name</th>
                ...
                ?>
                  ...
                  <div class="form-group col-sm-12">
                      ...
                      <div class="box-body">
                        ...
                        <table style="font-family: exo; font-size: 12px" id="iouLinkWithTrvel" class="table table-bordered">
                <thead>
                <tr>
                  <th>IOU Claim No</th>
                  <th>IOU Amount</th>
