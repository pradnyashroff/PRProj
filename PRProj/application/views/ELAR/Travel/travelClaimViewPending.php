			  ...
			  <label class="col-sm-1 pull-left control-label">5</label>
			   ...
			   <label class="col-sm-5 control-label"> Department : </label>
				<div class="input-group  col-sm-4">
                                    <input type="hidden" value="<?php echo $emp_dept; ?>" style="background-color:#E6F2FF;" readonly   name="dept_id" class="form-control"  required>
...
foreach ($conveyanceList->result() as $row)  
         {  ?>
		   ...
		   <?php  $sr_no++; }
			  ...
			  <div class="form-group col-sm-4">
                              <h4 style="font-family:exo;"> <label class="col-sm-12 pull-left control-label" style="margin-left: 155%">Total Amount : <span class="fa fa-inr"> <?php echo $final_rate4; ?></span> </label>
                              </h4>
                          </div>
				<div class="form-group col-sm-1">
                                </div>
			   ...
			   <?php 
                ...
                ?>
                    <div class="form-group col-sm-12">
                      <center>
                              <h3 style="font-family:exo;"> <label class="col-sm-12 pull-left control-label"> Total Claim Amount : <span class="fa fa-inr"> <?php echo $totalAmtclaim; ?></span> </label>
                              </h3>
                          </center>
                      </div></div></div></div>
                        <div class="box-header with-border">
         ...
         {  ?>          
			  ...
			  <label class="col-sm-1 pull-left control-label">4</label>
			   <label class="col-sm-4 pull-left control-label">Purpose of the tour: </label>
				<div class="input-group  col-sm-6">
                                     <textarea class="form-control" readonly style="background-color:#E6F2FF;" required rows="4" cols="50" name="areaJustif"><?php echo $row->justification; ?></textarea>
                </div>
                           <br>
                </div>
	  ...
	  <tr>
         ...
         <?php $sr_no++;}
                ...
                <div class="form-group col-sm-12"> <br>                                                                             
                 <center><a  href="<?php echo site_url('ELAR/Travel/Travel_cntr/printingTravelReport/'.$trv_mst_id);?>">
    ...
    <div class="modal-dialog" role="document" style="width: 720px;">
        <div class="modal-content">
           <div class="modal-header" style="background-color:#3482AE">
                ...
                <h4 class="modal-title">Add Person Details:</h4>
            </div>
         ...
         {  ?>
                              ...
                              <option value="<?php echo $row8->emp_code ; ?>"> <?php echo $row8->emp_name; ?></option>
                                    ...
                                    <div class="form-group col-md-4">
                                       ...
                                       <button type="submit" name="save"  class="btn  bg-skincolor" style="border: 1px solid orange;"class="btn" style="background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Add Details</button>
                                         </div>
                                    </form>
                    ...
                    <div class="container" style="width: auto;">
                        ...
                        <form method="post" role="form" enctype="multipart/form-data" action="<?php echo site_url('ELAR/Travel/Travel_cntr/addTravelingDraftDetails') ?>" >
                            ...
                            <div class="row">
                                ...
                                <center><button type="submit" name="save"  class="btn  bg-skincolor" style="border: 1px solid orange;">Add Details</button></center> 
                                </section>
         ...
         {  ?>
                              ...
                              <option value="<?php echo $row8->emp_code ; ?>"> <?php echo $row8->emp_name; ?></option>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control" style="background-color:#E6F2FF;" type="text" readonly name="txtMealRates" id="txtMealRates"/>	
                                    </div>
                                     <div class="form-group col-md-4">
