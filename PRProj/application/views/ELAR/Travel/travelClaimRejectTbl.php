		...
		<div class="box">
          ...
          <div class="form-group col-sm-12">
           ...
           <table id="example" class="table table">
                ...
                <tbody>
                     <?php $claimList= $this->method_call->fetchTravelReimRejectDetails($emp_code);
                 $final_rate=0; 	   
                    if($claimList!=null){
	$sr_no=1;			  
foreach ($claimList->result() as $row)  
         {  ?>
                <tr>
                  <td> <a href="<?php echo site_url('ELAR/Travel/Travel_cntr/travel_claim_reject_view/'.$row->trv_mst_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row->trv_mst_id; ?></a></td>
