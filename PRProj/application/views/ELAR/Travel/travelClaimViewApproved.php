        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;"> 
                   ...
                   <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Claim Approved View
                    </li>
                    </li>
                </ol>
            </section>
...
foreach ($conveyanceList->result() as $row)  
         {  ?>
                ...
                <div class="col-sm-12">
                  <center> <h4> <label class="col-sm-12 pull-left control-label"> Total Amount Linked IOU Amount:  <span class="fa fa-inr"> <?php  echo $final_rate5;?></label></span> </h4></center>
                  </div> 
                  </div>     
               </div>
              </div> </div>
		 ...
		 <input class="form-control" type="hidden" required name="trv_mst_id" value="<?php echo $trv_mst_id;?>"/>
           ...
           <input class="form-control" type="hidden" name="txtRepAutho" value="<?php print_r($reporting_autho['reporting_autho']); ?>"/>
			...
			<div class="form-group col-sm-12">
				<center><a href="<?php echo site_url('ELAR/Travel/Travel_cntr/printingTravelReportApproved/'.$trv_mst_id);?>">
                  <button type="button"  class="btn" style="background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Print</button></div>
                 </a> </center>
             </div>
