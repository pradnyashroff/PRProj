        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                   ...
                   <li class="active" style="color:#FFFFFF;text-transform: uppercase;">TRAVEL REIMBURSEMENTS VIEW CLAIM
                    </li>
                    </li>
                </ol>
            </section>
         ...
         {  ?>
           ...
           <!-- ItemCode detail collapsed-box -->
		    <div class="box-header with-border">
					   <div class="box box-default ">
					   <div class="box-header with-border">
              <h3 class="box-title">6 . Add Daily Convenience </h3>
             ...
             <div class="box-body">
               <table class="table table">
                           <tr>
                                           <th>Claim Base: </th>
                                <td>                
                           <?php $countData=$this->method_call->fetchClaimBase($trv_mst_id);

                            if($countData['countData']=="0"){
                                echo 'This Claim Is Not Based On IOU';
                                $claimBase=$countData['countData'];
                                
                            }  else {
                                echo 'IOU Based Claim';
                                $claimBase="IouBased";
                                }
                       ...
                       <tr>
                      <th>Actual Travel Amount: </th> <td>      <?php $total_amt=$this->method_call->fetchActualTravelAmount($trv_mst_id);
                                                
                                                  
                                                     $actualTvlAmt=$total_amt['total_amt'];
                                                     echo  $actualTvlAmt;
                                                ?></td>  </tr>    
                    <tr>  <th>Balance Travel Amount: </th> <td><?php $closing_amt=$this->method_call->fetchBlanceTravelAmount($trv_mst_id);
                                                if($closing_amt['closing_amt']==""){
                                                    echo 'No Transaction Performed yet...';
                                                    $closingAmt="NULL";
                                                    
                                                }  else {
                                                     
                                                     $closingAmt=$closing_amt['closing_amt'];
                                                      echo $closingAmt;
                                                }
                                                ?> </td></tr>
                      <tr> <th>Total Linked Claim:</th> <td><?php $df=$this->method_call->fetchLinkedIOUCount($trv_mst_id);
                                                if($df['df']==""){
                                                    echo 'No IOU Found.....';
                                                }  else {
                                                     print_r($df['df']);
                                                ...
                                                ?></td></tr>
                      <tr> <th>Total Linked IOU AMOUNT:</th> <td><?php $iouSum=$this->method_call->fetchLinkedIOUTotlAmount($trv_mst_id);
                                                if($iouSum['iouSum']==""){
                                                    echo 'No IOU Balance Found...';
                                                }  else {
                                                    
                                                     print_r($iouSum['iouSum']);
                                                     $totalIOUClaimAmt=$iouSum['iouSum'];
                                                }
                                                ?></td> </tr>                      
                                            
                      <tr> <th>Balance IOU Amount: </th>
                       <td>
                           <?php $claimer=$this->method_call->getClaimerDetails($trv_mst_id);

                            $emp_id=$claimer['claimer'];
                          
                               
                            $closing_amt=$this->method_call->fetchBalanceIOUAmount($emp_id);
                                                if($closing_amt['closing_amt']=="0"){
                                                    echo 'No Balance Available';
                                                     $iouClosingBal="0";
                                                    
                                                }  else {
                                                     print_r($closing_amt['closing_amt']);
                                                     $iouClosingBal=$closing_amt['closing_amt'];
                                                }
                                                ?></td></tr>
              	           ...
              	           <h4>Link IOU With Travel Claim :</h4>
              	           <div class="table-responsive">
...
foreach ($conveyanceList->result() as $row)  
         {  ?>
                <tr>
                  ...
                  <td> <form method="post" role="form" enctype="multipart/form-data"  action="<?php echo site_url('ELAR/Travel/Travel_cntr/transactionOnClaim'); ?>">
                     <input type="hidden" value="<?php echo $row->trvl_iou_link_id; ?>"   style="background-color:#E6F2FF;"  readonly   name="trvl_iou_link_id" class="form-control"  required>
                     <input type="hidden" value="<?php echo $row->lou_clm_id; ?>"   style="background-color:#E6F2FF;"  readonly   name="lou_clm_id" class="form-control"  required>
                     <input type="hidden" value="<?php echo $trv_mst_id; ?>"   style="background-color:#E6F2FF;"  readonly   name="trv_mst_id" class="form-control"  required>
                     <input type="hidden" value="<?php echo $row->iou_amt; ?>"   style="background-color:#E6F2FF;"  readonly   name="iou_amt" class="form-control"  required>
                     <input type="hidden" value="<?php echo $actualTvlAmt; ?>"   style="background-color:#E6F2FF;"  readonly   name="actualTvlAmt" class="form-control"  required>
                     <input type="hidden" value="<?php echo $closing_amt['closing_amt']; ?>"   style="background-color:#E6F2FF;"  readonly   name="iouTotalAmt" class="form-control"  required>
                     <input type="hidden" value="<?php echo $emp_code; ?>"   style="background-color:#E6F2FF;"  readonly   name="sanctionAuthoId" class="form-control"  required>
                     <input type="hidden" value="<?php echo $emp_id; ?>"   style="background-color:#E6F2FF;"  readonly   name="claimerID" class="form-control"  required>
                     <input type="hidden" value="<?php echo $closingAmt; ?>"   style="background-color:#E6F2FF;"  readonly   name="trvlAmountTrans" class="form-control"  required>
                     <input type="hidden" value="<?php echo $totalIOUClaimAmt; ?>"   style="background-color:#E6F2FF;"  readonly   name="totalIOUClaimAmt" class="form-control"  required>
                     <input type="hidden" value="<?php echo $iouClaimCount; ?>"   style="background-color:#E6F2FF;"  readonly   name="iouClaimCount" class="form-control"  required>
                        
                       <?php
                        if($closingAmt=="NULL"){
                            ?>
                            <input type="hidden" value="<?php echo $actualTvlAmt; ?>"   style="background-color:#E6F2FF;"  readonly   name="closingAmt" class="form-control"  required>
                             
                                <?php
                        }else{?>
                              <input type="hidden" value="<?php echo $closingAmt; ?>"   style="background-color:#E6F2FF;"  readonly   name="closingAmt" class="form-control"  required>
                        <?php }
                       ?>
                       
                       <button type="submit" name="save"  class="btn" style="background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase; margin-left:10%">Clear Claim &nbsp;<i class="fa fa-dollar"></i></button>
                   </form>
                     </td>
                  <?php
		   ...
		   <?php  $sr_no++; }
				 ...
				 <div class="box-header with-border">
					   <div class="box box-default ">
					   <div class="box-header with-border">
              <h3 class="box-title">8 . Action History</h3>
              ...
              <div class="box-tools pull-right">
				...
				<div class="box-body">
				    <div class="table-responsive">
                 <table id="actionHistory" class="table table">
                  <thead>
                <tr style="background-color:#3482AE;color:#FFFFFF;width:100%;">
                  <th>IOU Claim No</th>
                  <th>IOU Amount</th>
                   <th>Clearing Phase</th>
                   <th>Status</th>
                ...
                <tbody>
                <?php $conveyanceList= $this->method_call->fetchTakenActionClaim($trv_mst_id);
               	     if($conveyanceList!=null){
	$sr_no=1;			  
foreach ($conveyanceList->result() as $row)  
         {  ?>
                <tr>
                  <td><?php echo $row->lou_clm_id; ?></td>
                  <td><?php echo $row->iou_amt; ?></td>
                  <td><?php echo $row->closing_amt; ?></td>
                  <td><?php 
                        if($row->trn_status=="1"){
                             echo "Claim Cleared";
                        }
                        elseif($row->trn_status=="2"){
                            echo "Claim Not Clear - (Outstanding at Claimer)";
                        } elseif($row->trn_status=="3"){
                            echo "Claim Not Clear - (Outstanding at Company)";
                        }
                  ?></td>
		   ...
		   <?php  $sr_no++; }
					   ...
					   <div class="box box-default ">
					   <div class="box-header with-border">
              <h3 class="box-title">9 . Claim Actions Log</h3>
	  ...
	  <tr>
                     <?php
                        $LocalClaimHodApproved = $this->method_call->travelClaimDetailsStatusLog($trv_mst_id);
			 ...
			 <td colspan="3"><?php echo $row->trv_mst_id; ?></td>
         ...
         <?php $sr_no++;}
              ...
              <form method="post" id="finalizingClaim" name="finalizingClaim" action="<?php echo site_url('ELAR/Travel/Travel_cntr/finalActionOnTrvlClaim') ?>" >
				 <input class="form-control" type="hidden" required name="trv_mst_id" value="<?php echo $trv_mst_id;?>"/>
			...
			<div class="input-group  col-sm-8">
					  <?php 
			if($closingAmt<0){?>
                <input type="radio" checked="checked" name="claim_state" value="6" required>&nbsp;&nbsp;Claimer Outstanding</input>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<?php }
					elseif ($iouClosingBal<0) {
                ?>
				
				 <input type="radio" checked="checked" name="claim_state" value="5" >&nbsp;&nbsp; Company Outstanding</input>
				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<?php  }
                elseif ($closingAmt==0 && $closingAmt!="NULL") {
                 ?>
				<input type="radio" checked="checked"  name="claim_state" value="4" >&nbsp;&nbsp; Claim Cleared</input>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <?php }
                elseif ($claimBase == "0") {
				?>
				<input type="radio" checked="checked"  name="claim_state" value="7" >&nbsp;&nbsp; Non IOU Claim</input>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio"   name="claim_state" value="2" > &nbsp;&nbsp; Reject This Claim</input>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <?php
                 }
                 else {
			...
			<div class="input-group  col-sm-8">
            <textarea class="form-control" placeholder="Justification" required rows="4" cols="50" name="areaJustif"></textarea>
                </div>
                </div>  
                    
                         <?php
                        $TravelClaimLastApprovalDetail= $this->method_call->travelLastApprovalDetils($emp_code,$trv_mst_id);
                        if ($TravelClaimLastApprovalDetail != null) {
                            foreach ($TravelClaimLastApprovalDetail->result() as $row) {
                                ?>
                              
                                <br>
                                <input type="hidden" name="final_trvl_status_id" class="form-control" value="<?php echo $row->trvl_status_id;?>">
                                <input type="hidden" name="final_rep_autho" class="form-control" value="<?php echo $row->rep_autho;?>">
                                <input type="hidden" name="final_trv_mst_id" class="form-control" value="<?php echo $row->trv_mst_id;?>">
                            ...
                            <div class="row">
                                <div class="col-sm-12" style="  ">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control"   style="background-color:#E6F2FF;"  readonly type="hidden" required name="hotelDetailEditId" id="hotelDetailEditId"  data-validation-required-message="Please enter Valid Item Code."/>
                            ...
                            <div class="row">
                                <div class="col-sm-12" style="">
                                     <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control"   style="background-color:#E6F2FF;"  readonly type="text" required name="txtTrvelDate" id="txtTrvelDate"  data-validation-required-message="Please enter Valid Item Code."/>		
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label >Place From</label>
      ...
      function get_data(id)
{
   ...
   if(document.add_localRim_details.comboVehicle.value != '2'){
		document.add_localRim_details.txtAmount.  style="background-color:#E6F2FF;"  disabled=1;
                document.add_localRim_details.txtKM.  style="background-color:#E6F2FF;"  disabled=0;  
                document.add_localRim_details.txtKM.value=0;  
    }
	else {
		document.add_localRim_details.txtAmount.  style="background-color:#E6F2FF;"  disabled=0;
                 document.add_localRim_details.txtKM.  style="background-color:#E6F2FF;"  disabled=1;
            }
...
$(document).ready(function (){
   var table = $('#actionHistory').DataTable({
      'columnDefs': [
         {
            'targets': 0,
         }
