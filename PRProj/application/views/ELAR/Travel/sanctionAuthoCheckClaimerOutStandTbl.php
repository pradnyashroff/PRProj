    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';">    	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
                <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">TRAVEL REIMBURSEMENTS CLAIMER OUTSTANDING TABLE
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase";>
                   ...
                   <li class="active" style="color:#FFFFFF;text-transform: uppercase";>Claimer Outstanding Amount Table
                    </li>
                    </li>
                </ol>
            </section>
      ...
      <div class="row">
        ...
        <table id="example" class="table table">
                ...
                <tr style="background-color:#3482AE;color:#FFFFFF;width:100%;">
                  <th>Sr.No.</th>
                  <th>Claim No.</th>
                  <th>Claimer Emp. Code</th>
                  <th>Claimer Name</th>
                  <th>Claimer Phone No.</th>
                  <th>Claim Date</th>
                ...
                <tbody>
                     <?php $claimListApproval= $this->method_call->fetchClaimerOutStandingAmtList();
                 $final_rate=0; 	   
...
foreach ($claimListApproval->result() as $row)  
         {  ?>
                <tr>
                  <td><a href="<?php echo site_url('ELAR/Travel/Travel_cntr/sancAutho_travel_Claimer_OutStanding_claim_view/'.$row->trv_mst_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $sr_no; ?></a></td>
