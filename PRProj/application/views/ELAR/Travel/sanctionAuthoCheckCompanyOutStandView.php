         ...
         <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                   ...
                   <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Company Outstanding View
                    </li>
                    </li>
                </ol>
            </section>
                  ...
                  <input class="form-control" required type="hidden" name="txtTotalAmt" id="txtTotalAmt" value = "<?php echo $totalAmtclaim; ?>"/>
                    ...
                    <tr>  <th>Balance Travel Amount: </th> <td><?php $closing_amt=$this->method_call->fetchBlanceTravelAmount($trv_mst_id);
                      ...
                      <tr> <th>Balance IOU Amount: </th>
                       <td>
                          <?php $claimer=$this->method_call->getClaimerDetails($trv_mst_id);
                           ...
                           $closing_amt=$this->method_call->fetchBalanceIOUAmount($emp_id);
                                               ...
                                               $iou_tr_id=$this->method_call->fetchBalanceIOUOutStandingIDForCompany($emp_id);
                                               $iou_tr_id=$iou_tr_id['iou_tr_id'];
                                               ?></td></tr>
                              </table> <br>
                       </div> </div> </div> </div>
					   <div class="box-header with-border">
					   <div class="box box-default ">
					   <div class="box-header with-border">
              <h3 class="box-title">7 . Action History</h3>
...
foreach ($conveyanceList->result() as $row)  
         {  ?>
			...
			<div class="box-header with-border">
					   <div class="box box-default ">
					   <div class="box-header with-border">
              <h3 class="box-title">8 . Claim Actions Log</h3>
	  ...
	  <?php $sr_no++;}
				...
				<form method="post" id="finalizingClaim" name="finalizingClaim" action="<?php echo site_url('ELAR/Travel/Travel_cntr/companyOutstandingAmtClearAction') ?>" >
				 <?php $tt_id=$this->method_call->fetchBlanceTravelOutStandingIDForCompany($trv_mst_id);
                   $tt_id=$tt_id['tt_id'];
                   ?>
				   <input class="form-control" type="hidden" required name="tt_id" value="<?php echo $tt_id;?>"/>
                     <input class="form-control" type="hidden" required name="iou_tr_id" value="<?php echo $iou_tr_id;?>"/>
                     <input class="form-control" type="hidden" required name="iouClosingBal" value="<?php echo $iouClosingBal;?>"/>
                     <input class="form-control" type="hidden" required name="txtEmpCode" value="<?php echo $emp_code;?>"/> 
                     <input class="form-control" type="hidden" required name="trv_mst_id" value="<?php echo $trv_mst_id;?>"/>
				   
              <div class="form-group col-sm-12">
					<center><h3 style="color: red">Claimer Outstanding Amount Is: &#8377 <?php echo $iouClosingBal;?></h3></center>
                </div>
				<div class="form-group col-sm-12">
			 <label class="col-sm-1 pull-left control-label">9</label>
			 <label class="col-sm-2 pull-left control-label">Justification</label>
			<div class="input-group  col-sm-4">
               <textarea class="form-control" placeholder="Justification" required rows="2" cols="50" name="areaJustif"></textarea>
                </div>
                </div>
               <div class="col-sm-12">
                 <center><button type="submit" name="save"  class="btn" style="background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase; margin-left:10%"> Clear Claim</button></center> 
                 </div>
                  </form>   
                </div>
            </div>   
         ...
         {  ?>
                              ...
                              <option value="<?php echo $row8->emp_code ; ?>"> <?php echo $row8->emp_name; ?></option>
                                    ...
                                    <div class="form-group col-md-4">
                                       ...
                                       <button type="submit" name="save"  class="btn" style="background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase; margin-left:10%">Add Details</button>
                                         </div>
                                    </form>
                              </div>
                                 </section>
                    ...
                    <div class="container" style="width: auto;">
                        ...
                        <form method="post" role="form" enctype="multipart/form-data" action="<?php echo site_url('ELAR/Travel/Travel_cntr/addTravelingDraftDetails') ?>" >
                            ...
                            <div class="row">
                                ...
                                <center><button type="submit" name="save"  class="btn" style="background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase; margin-left:10%">Add Details</button></center> 
                                </section>
