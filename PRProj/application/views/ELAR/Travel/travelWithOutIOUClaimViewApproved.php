   ...
   <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';">   	  
       ...
       <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
                <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">TRAVEL REIMBURSEMENTS VIEW CLAIM WITHOUT IOU
                    <?php
                    if (isset($error)) {
...
foreach ($conveyanceList->result() as $row)  
		 ...
		 <input class="form-control" type="hidden" required name="trv_mst_id" value="<?php echo $trv_mst_id;?>"/>
			 ...
			 <td colspan="3"><?php echo $row->trv_mst_id; ?></td>
					...
					<div class="form-group col-sm-12">
					<center>
                    <a  href="<?php echo site_url('ELAR/Travel/Travel_cntr/printingTravelReport/'.$trv_mst_id);?>">
                 <button type="button"  class="btn" style="background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase; width: 10%;">Print</button></div>
                 </a>  </center>                                                                             
                 </div>
            </div>
