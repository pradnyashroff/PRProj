    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >	  
      ...
      <div class="row">
        ...
        <table id="example" class="table table">
                ...
                <tbody>
                     <?php $claimListApproval= $this->method_call->fetchLocalReimSancAuthoRejectDetails($emp_code);
                 $final_rate=0; 	   
...
foreach ($claimListApproval->result() as $row)  
         {  ?>
                <tr>
                  <td><a href="<?php echo site_url('ELAR/local_reim/Local_cntr/sanc_autho_local_claim_rejct_view/'.$row->lrcm_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $sr_no; ?></a></td>
