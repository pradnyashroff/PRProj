    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >    	  
       ...
       <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
                <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">LOCAL CONVEYANCES REJECT TABLE
                    <?php
                    if (isset($error)) {
      ...
      <div class="row">
        ...
        <table id="example" class="table table">
               ...
               <tr style="background-color:#3482AE;color:#FFFFFF;width:100%;">
                ...
                <tbody>
                     <?php $claimApprovHodList= $this->method_call->fetchLocalReimRejectHODClaim($emp_code);
                 $final_rate=0; 	   
...
foreach ($claimApprovHodList->result() as $row)  
         {  ?>
                <tr>
                  <td> <a href="<?php echo site_url('ELAR/local_reim/Local_cntr/appr_local_claim_rejct_view/'.$row->lrcm_id);?>" class="glyphicon glyphicon-edit" style="color:red;"> <?php echo $row->lrcm_id; ?></a></td>
