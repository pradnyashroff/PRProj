            ...
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">LOCAL CONVEYANCES REIMBURSEMENTS CLAIM APPROVED
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
					...
					') ?>" style="color:#FFFFFF;text-transform: uppercase;">Cash Reimbursement</a></li>
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Accepted Request View</li>
                    </li>
                </ol>
            </section>
...
?>
	  ...
	  <tr>
                     <?php
                        $LocalClaimHodApproved = $this->method_call->localClaimDetailsSancApprovedReq($lrcm_id,$emp_code);
                      //  echo '$lrcm_id-----------' .$lrcm_id;
                      //  echo '$emp_code----------' .$emp_code;
                        if ($LocalClaimHodApproved != null) {
                             $sr_no = 1;
