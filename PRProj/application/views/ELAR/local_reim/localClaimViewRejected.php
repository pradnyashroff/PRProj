        ...
        <!-- Content Wrapper. Contains page content -->
         <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
              <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">LOCAL CONVEYANCES REIMBURSEMENTS CLAIM REJECT
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Rejected Claim View
                    </li>
                    </li>
                </ol>
            </section>
...
foreach ($conveyanceList->result() as $row)  
	  ...
	  <tr>
         ...
         <?php $sr_no++;}
					   ...
					   <div class="box box-default">
					   <div class="box-header with-border">
              <h3 class="box-title">4 . Approval Status</h3>
	  ...
	  <tr>
                     <?php
                        $LocalClaimHodActtionStatus = $this->method_call->localClaimDetailsHodActionStatus($lrcm_id,$emp_code);
                        //echo '$lrcm_id-----------' .$lrcm_id;
                        //echo '$emp_code----------' .$emp_code;
	  ...
	  <tr>
              <?php
                        $LocalClaimSanAuthoActtionStatus = $this->method_call->localClaimDetailsSanAuthoActionStatus($lrcm_id,$emp_code);
                        //echo '$lrcm_id-----------' .$lrcm_id;
                        //echo '$emp_code----------' .$emp_code;
			 ...
			 <label class="col-lg-4 pull-left control-label">Action</label>
				...
				<div class="input-group  col-lg-6">
				  <form method="post" id="crateClaim" name="crateClaim" action="<?php echo site_url('ELAR/local_reim/Local_cntr/userActionOnRejectedClaim') ?>" >
  ...
  <input class="form-control" type="hidden" name="txtClaimId" value="<?php echo $lrcm_id; ?>"/>
				...
				<div class="col-sm-12">
                 <center> <button type="submit" name="save" class="btn" style="background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Save</button></center></div>
		       </form>
            </div>
        </div>
        <!-- /.box-body -->
