            ...
            <section class="content-header">      
              <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">LOCAL CONVEYANCES REIMBURSEMENTS CLAIM REJECT
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Reject Claim View  </li>
                    </li>
                </ol>
            </section>
...
?>
   ...
   <div class="box-header with-border">
	  ...
	  <tr>
                     <?php
                        $LocalClaimHodApproved = $this->method_call->localClaimDetailsSancAuthoReject($lrcm_id,$emp_code);
                       // echo '$lrcm_id-----------' .$lrcm_id;
                       // echo '$emp_code----------' .$emp_code;
                        if ($LocalClaimHodApproved != null) {
                             $sr_no = 1;
        ...
        <div class="modal-dialog" role="document" style="width: 720px;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Claim Details :</h4>
                </div>
                                    ...
                                    <div class="col-sm-12" style="  ">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" id="comboVehicle" name="comboVehicle" onchange="get_data(this.value)">
                                                ...
                                                <?php
                                                $vehicles = $this->method_call->getVehicleDetailsByGrade($grade_id);
                                                if ($vehicles != null) {
...
?>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label >KM Rec.</label>
                                            <input class="form-control" type="text" disabled name="txtKM" value="NULL"  data-validation-required-message="Please enter Valid Item Code."/>		
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label >Current Rate Per KM</label>

                                            <input class="form-control" readonly type="text" required name="txtCrrKmRate"  id="txtCrrKmRate" value="" data-validation-required-message="Please enter Valid Item Code."/>	
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label >Total Amount</label>
                                            <input class="form-control" disabled  type="text"  name="txtAmount" value=""  data-validation-required-message="Please enter Valid Item Code."/>		
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label >Reason</label>
                                            <textarea class="form-control" rows="3" name="areaReason"></textarea>  
                                        </div>
                                    </div>
