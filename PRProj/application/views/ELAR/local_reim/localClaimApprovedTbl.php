      ...
      <div class="row">
        ...
        <table id="example" class="table table">
               ...
               <tr style="background-color:#3482AE;color:#FFFFFF;width:100%;">
                ...
                <tbody>
                     <?php $approvedClaimList= $this->method_call->fetchLocalReimApprovedDetailsTbl($emp_code);
                 $final_rate=0; 	   
...
foreach ($approvedClaimList->result() as $row)  
         {  ?>
                <tr>
                  ...
                  <td> <a href="<?php echo site_url('ELAR/local_reim/Local_cntr/local_claim_approved_view/'.$row->lrcm_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row->lrcm_id; ?></a></td>
