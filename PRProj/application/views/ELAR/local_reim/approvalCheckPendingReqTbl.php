    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >  	  
      ...
      <div class="row">
        ...
        <table id="example" class="table table">
                ...
                <tbody>
                     <?php $claimListApproval= $this->method_call->fetchLocalReimApprovalDetails($emp_code);
                 $final_rate=0; 	   
...
foreach ($claimListApproval->result() as $row)  
         {  ?>
                <tr>
                  <td><a  href="<?php echo site_url('ELAR/local_reim/Local_cntr/appr_local_claim_pend_view/'.$row->lrcm_id);?>" class="glyphicon glyphicon-edit" style="color:red;"><?php echo $sr_no; ?></a></td>
