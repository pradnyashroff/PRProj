...
?>
	 ...
	 <form method="post" id="crateClaim" name="crateClaim" action="<?php echo site_url('ELAR/local_reim/Local_cntr/updateClaimActionBySancAutho') ?>" >
                              <div class="form-group col-sm-12">
                                 ...
                                 <?php $autho_code=$this->method_call->getSanctionAuthoDetails();?>
                                  <input type="hidden" value="<?php print_r($autho_code['autho_code']); ?>" name="auto_code" class="form-control"  required>
                                   ...
                                   <?php
                        $LocalClaimLastApprovalDetail= $this->method_call->localClaimDetailsLastApprovalDetils($emp_code,$lrcm_id);
                        if ($LocalClaimLastApprovalDetail != null) {
                            foreach ($LocalClaimLastApprovalDetail->result() as $row) {
                                ?>
                              
                                <br>
                                <input type="hidden" name="final_local_rim_id" class="form-control" value="<?php echo $row->local_rim_id;?>">
                                <input type="hidden" name="final_rep_autho" class="form-control" value="<?php echo $row->rep_autho;?>">
                                <input type="hidden" name="final_lrcm_id" class="form-control" value="<?php echo $row->lrcm_id;?>">
	...
	<div class="form-group col-lg-12">
			<br>
			 ...
			 <label class="col-lg-4 pull-left control-label">Download Attachment</label>
				...
				<div class="input-group  col-lg-6">
                     ...
                     <a style="color: #337ab7;" href="<?php echo base_url()."uploads/images/".$pic_file['pic_file'];?>"><?php print_r($pic_file['pic_file']); ?></a>                           
                </div> </div>
				<div class="form-group col-lg-12">
			...
			<div class="form-group col-lg-12">
			 ...
			 <label class="col-lg-4 pull-left control-label"> Approver Comment</label>
				...
				<div class="input-group  col-lg-6">
					<textarea class="form-control" rows="4" cols="50" name="comment" required> </textarea>
                            ...
                            <center>
                                ...
                                <button type="submit" name="save"  class="btn" style="background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase; width:15%;">Proceed This Claim</button>  
                                <a href="<?php echo site_url('ELAR/local_reim/Local_cntr/create_local_claim');?>"> <input type="button" value="Cancel" class="btn" style="width:15%; background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;"></a>
                            </center>
