    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" > 	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">LOCAL CONVEYANCES REIMBURSEMENTS APPROVED CLAIM
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Approved Claim View
                    </li>
                    </li>
                </ol>
            </section>
	  ...
	  <tr>
			 ...
			 <label class="col-lg-4 pull-left control-label"> Claim Justification</label>
				...
				<center>
                 ...
                 <button type="button"  class="btn" style="width: 10%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Print</button>
                 </a>    </center>                
                   </div>                
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12" style="  ">
                                     <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control" type="text" style="background-color:#E6F2FF;" disabled name="txtGatePassEdit" value=""  data-validation-required-message="Please enter Valid Item Code."/>	
                                         </div>
                                   <div class="form-group col-md-4">
                                        <label >Place From</label>
                                        <input class="form-control" type="text" style="background-color:#E6F2FF;" disabled name="txtPlaceFromEdit" value=""  data-validation-required-message="Please enter Valid Item Code."/>		
                                    </div>
                                        <div class="form-group col-md-4">
                                        <label >Place To</label>
                                        <input class="form-control" type="text" style="background-color:#E6F2FF;" disabled name="txtPlaceToEdit" value=""  data-validation-required-message="Please enter Valid Item Code."/>	
                                         </div>
                                   <div class="form-group col-md-4">
                                        <label >KM Rec.</label>
                                        <input class="form-control" type="text"  style="background-color:#E6F2FF;" readonly name="txtKMEdit" id="txtKMEdit" value=""  data-validation-required-message="Please enter Valid Item Code."/>		
                                    </div>
                                        <div class="form-group col-md-4">
                                        <label >Current Rate Per KM</label>
                                        <input class="form-control" type="text" style="background-color:#E6F2FF;" disabled required name="txtCrrKmRateEdit" value=""  data-validation-required-message="Please enter Valid Item Code."/>	
                                         </div>
                                   <div class="form-group col-md-4">
                                     ...
                                     <div class="form-group col-md-4">
                                        <label >Reason</label>
                                        <textarea class="form-control" rows="3" style="background-color:#E6F2FF;" disabled name="areaReasonEdit"></textarea>  
                                     </div>
                                </div>
