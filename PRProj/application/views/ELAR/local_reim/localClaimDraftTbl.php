...
label,.col-sm-1,.box-title
{
 ...
 <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">LOCAL CONVEYANCES DRAFT TABLE
      ...
      <div class="row">
        ...
        <table id="example" class="table table">
               ...
               <tr style="background-color:#3482AE;color:#FFFFFF;width:100%;">
                ...
                <tbody>
                     <?php $claimList= $this->method_call->fetchLocalReimDraftDetails($emp_code);
                 $final_rate=0; 	   
                    if($claimList!=null){
	$sr_no=1;			  
foreach ($claimList->result() as $row)  
         {  ?>
                <tr>
                  <td> <a href="<?php echo site_url('ELAR/local_reim/Local_cntr/viewDraftLocalClaim/'.$row->lrcm_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row->lrcm_id; ?></a></td>
