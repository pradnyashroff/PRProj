        ...
        <!-- Content Wrapper. Contains page content -->
         <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
                <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">LOCAL CONVEYANCES REIMBURSEMENTS CLAIM PENDING VIEW
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Pending Request View
                    </li>
                    </li>
                </ol>
            </section>
	  ...
	  <tr>
         ...
         <?php $sr_no++;}
                        ...
                        ?>	
                          ...
                          <form method="post" id="crateClaim" name="crateClaim" action="<?php echo site_url('ELAR/local_reim/Local_cntr/updateClaimAction') ?>" >
						 <div class="form-group col-lg-12">
							<br>
							 <label class="col-lg-4 pull-left control-label">4. &nbsp;&nbsp;&nbsp;Download Attachment</label>
						...
						<div class="form-group col-lg-12">
							 <label class="col-lg-4 pull-left control-label">5. &nbsp;&nbsp;&nbsp;Claim Justification</label>
							 <div class="input-group  col-lg-6">
								<?php $justification=$this->method_call->getDraftJustification($lrcm_id);?> 
                                <?php print_r($justification['justification']); ?></div>
				         </div>
						 <div class="form-group col-lg-12">
							 <label class="col-lg-4 pull-left control-label">6. &nbsp;&nbsp;&nbsp;Action</label>
							 <div class="input-group  col-lg-6">
						  ...
						  <div class="form-group col-lg-12">
							 <label class="col-lg-4 pull-left control-label">7. &nbsp;&nbsp;&nbsp;Approver Comment</label>
							 <div class="input-group  col-lg-6">
                              ...
                              <div class="form-group col-sm-12">
                                  <input type="hidden" name="lrcm_id" class="form-control" value="<?php echo $lrcm_id;?>">
                                  <?php $claimer=$this->method_call->getClaimerDetails($lrcm_id);?>
                              ...
                              <?php
                        $hodActionData = $this->method_call->localClaimDetailsHodActionData($emp_code,$lrcm_id);
                        if ($hodActionData != null) {
                            foreach ($hodActionData->result() as $row) {
                                ?>
                            <input type="hidden" name="local_rim_id" class="form-control" value="<?php echo $row->local_rim_id;?>">
                        ...
                        ?>
							...
							<div class="box-footer">
							  <div class="form-group col-sm-12">
								...
								<div class="col-sm-3"><button type="submit" name="save"  class="btn" style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Proceed Claim</button></div>
								<div class="col-sm-3"> <a href="<?php echo site_url('ELAR/local_reim/Local_cntr/create_local_claim');?>"> <input type="button" value="Cancel" class="btn" style="width: 60%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;"></a></div>
								<div class="col-sm-3 "></div>
							</div>			
						</div>		
                           ...
                           <?php $emp_email=$this->method_call->fetchUserMailDetails($lrcm_id);?>
                                    ...
                                    <input class="form-control" type="hidden"name="txtSancAuthoEmail" value="<?php print_r($SancAuthoEmail['SancAuthoEmail']); ?>"/>
                                        ...
                                        <?php $emp_name=$this->method_call->fetchEmpNameForMail($lrcm_id); ?>
                            ...
                            <div class="row">
                                <div class="col-sm-12" style="  ">
                                     <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control" style="background-color:#E6F2FF;" readonly type="text" required name="datepicker1" id="datepicker1"  data-validation-required-message="Please enter Valid Item Code."/>		
                                    </div>
                                         <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control" style="background-color:#E6F2FF;" readonly type="text" required name="txtGatePassEdit" value=""  data-validation-required-message="Please enter Valid Item Code."/>	
                                         </div>
                                   <div class="form-group col-md-4">
                                        <label >Place From</label>
                                        <input class="form-control" style="background-color:#E6F2FF;" readonly type="text" required name="txtPlaceFromEdit" value=""  data-validation-required-message="Please enter Valid Item Code."/>		
                                    </div>
                                        <div class="form-group col-md-4">
                                        <label >Place To</label>
                                        <input class="form-control" style="background-color:#E6F2FF;" readonly type="text" required name="txtPlaceToEdit" value=""  data-validation-required-message="Please enter Valid Item Code."/>	
                                         </div>
                                   <div class="form-group col-md-4">
                                        <label >KM Rec.</label>
                                        <input class="form-control" style="background-color:#E6F2FF;" readonly type="text"  required name="txtKMEdit" id="txtKMEdit" value=""  data-validation-required-message="Please enter Valid Item Code."/>		
                                    </div>
                                        <div class="form-group col-md-4">
                                        <label >Current Rate Per KM</label>
                                        <input class="form-control" type="text" style="background-color:#E6F2FF;" readonly required name="txtCrrKmRateEdit" value=""  data-validation-required-message="Please enter Valid Item Code."/>	
                                         </div>
                                   <div class="form-group col-md-4">
                                        <label >Total Amount</label>
                                        <input class="form-control" style="background-color:#E6F2FF;" disabled type="text" required name="txtAmountEdit" id="txtAmountEdit" value=""  data-validation-required-message="Please enter Valid Item Code."/>		
                                    </div>
                                     <div class="form-group col-md-4">
                                        <label >Reason</label>
                                        <textarea class="form-control" style="background-color:#E6F2FF;" readonly rows="3" name="areaReasonEdit"></textarea>  
                                     </div>
                                </div>
                                </section>
