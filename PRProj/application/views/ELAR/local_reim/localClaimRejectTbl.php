    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >  	  
      ...
      <div class="row">
        ...
        <table id="example" class="table table">
                ...
                <tbody>
                     <?php $claimList= $this->method_call->fetchLocalReimRejectDetails($emp_code);
                 $final_rate=0; 	   
                    if($claimList!=null){
	$sr_no=1;			  
foreach ($claimList->result() as $row)  
         {  ?>
                <tr>
                  <td> <a href="<?php echo site_url('ELAR/local_reim/Local_cntr/local_claim_reject_view/'.$row->lrcm_id);?>" class="glyphicon glyphicon-edit" style="color:red;"><?php echo $row->lrcm_id; ?></a></td>
