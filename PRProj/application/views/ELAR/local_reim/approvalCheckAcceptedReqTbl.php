    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >      	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">LOCAL CONVEYANCES APPROVED TABLE
                    <?php
                    if (isset($error)) {
      ...
      <div class="row">
        ...
        <table id="example" class="table table">
                ...
                <tbody>
                     <?php $claimApprovHodList= $this->method_call->fetchLocalReimApprovalHODClaim($emp_code);
                 $final_rate=0; 	   
...
foreach ($claimApprovHodList->result() as $row)  
         {  ?>
                <tr>
                  <td> <a class="glyphicon glyphicon-edit" style="color:red;" href="<?php echo site_url('ELAR/local_reim/Local_cntr/appr_local_claim_accpt_view/'.$row->lrcm_id);?>"><?php echo $row->lrcm_id; ?></a></td>
