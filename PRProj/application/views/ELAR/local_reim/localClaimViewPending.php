			 ...
			 <label class="col-lg-4 pull-left control-label"> Claim Justification</label>
				...
				<div class="input-group  col-lg-6">
							   ...
							   <div class="col-sm-12">
								...
								<center>
									 <a  href="<?php echo site_url('ELAR/local_reim/Local_cntr/printingLocalReport/'.$lrcm_id);?>">
                 <button type="button"  class="btn" style="width:8%;background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Print</button>
                 </a>    
									  </center>
									 </div>
