...
<html>
    <head>
        ...
        <title>IOU APPROVED CLAIM</title> 
   ...
   <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >   	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">IOU APPROVED CLAIM ADVANCE IOU CLAIM PENDING 
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">IOU Accepted Claim View
                    </li>
                    </li>
                </ol>
            </section>
<section class="content">
 ...
 if($LocalClaimDetail!=null){
	...
	<div class="box-header with-border">
	  ...
	  <tr>
                     <?php
                        $LocalClaimHodApproved = $this->method_call->iouDetailsSancApprovedReq($lou_clm_id,$emp_code);
                      //  echo '$lrcm_id-----------' .$lrcm_id;
                      //  echo '$emp_code----------' .$emp_code;
                        if ($LocalClaimHodApproved != null) {
                             $sr_no = 1;
			 ...
			 <td colspan="3"  > <?php echo $row->iou_amt; ?></td>
