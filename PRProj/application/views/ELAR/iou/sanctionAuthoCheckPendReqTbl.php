      ...
      <div class="row">
        ...
        <table id="example" class="table table">
              ...
              <tr style="background-color:#3482AE;color:#FFFFFF;width:100%;">
                ...
                <tbody>
                     <?php $claimListApproval= $this->method_call->iouSancAuthoDetails($emp_code);
                 $final_rate=0; 	   
...
foreach ($claimListApproval->result() as $row)  
         {  ?>
                <tr>
                  <td><a href="<?php echo site_url('ELAR/IOU/IouCntr/iou_sancAutho_claim_view/'.$row->lou_clm_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $sr_no; ?></a></td>
