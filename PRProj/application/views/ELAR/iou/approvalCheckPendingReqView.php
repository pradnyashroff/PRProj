...
<html>
   ...
   <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >  	  
       ...
       <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">IOU CLAIM PENDING VIEW
                    <?php
                    if (isset($error)) {
 ...
 if($LocalClaimDetail!=null){
	 foreach ($LocalClaimDetail->result() as $row)  
         {  ?>
			  ...
			  <label class="col-sm-1 pull-left control-label">1</label>
			   <label class="col-sm-3 pull-left control-label">Advance Amount: </label>
				<div class="input-group  col-sm-6">
                                    <input type="text" style="background-color:#E6F2FF;" disabled class="form-control" id="txtAdvAmount" value="<?php $claimAmt=$row->iou_amt; echo $row->iou_amt;  ?>" name="txtAdvAmount"/>
                </div><br>
                          </div>
                                   <div class="col-sm-12">
			  <label class="col-sm-1 pull-left control-label">2</label>
	  ...
	  <form method="post" id="crateClaim" name="crateClaim" action="<?php echo site_url('ELAR/IOU/IouCntr/updateClaimAction') ?>" >
	...
	<div class="form-group col-sm-12"><br>
					   ...
					   <div class="col-sm-12">
						  ...
						  <div class="input-group  col-sm-6">
                            ...
                            <?php
                        $hodActionData = $this->method_call->iouDetailsHodActionData($emp_code,$lou_clm_id);
                        ...
                        ?>
                           ...
                           <?php $emp_email=$this->method_call->fetchUserMailDetails($lou_clm_id);?>
                                    ...
                                    <input class="form-control" type="hidden" name="txtSancAuthoEmail" value="<?php print_r($SancAuthoEmail['SancAuthoEmail']); ?>"/>
                                        ...
                                        <input class="form-control" type="hidden" name="txtClaimAmt" value="<?php print_r($claimAmt); ?>"/>
                                        
                                    <!------Mail Details Code End here--->
									
									<div class="form-group col-sm-12"><br>  
                                <center><button type="submit" name="save" class="btn" style="background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);width:15%;font-family:'exo';text-transform: uppercase;">Proceed This Claim</button>  
