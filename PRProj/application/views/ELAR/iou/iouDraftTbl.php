    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >  	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">ADVANCE IOU DRAFT TABLE
                    <?php
                    if (isset($error)) {
                 ...
                 <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">IOU Draft Table
                    </li>
                    </li>
                </ol>
            </section>
      ...
      <div class="row">
        ...
        <table id="example" class="table table">
                ...
                <tbody>
                     <?php $claimList= $this->method_call->fetchIouDraftDetails($emp_code);
                 $final_rate=0; 	   
                    if($claimList!=null){
	$sr_no=1;			  
foreach ($claimList->result() as $row)  
         {  ?>
                <tr>
                  <td> <a href="<?php echo site_url('ELAR/IOU/IouCntr/viewDraftIou/'.$row->lou_clm_id);?>" class="glyphicon glyphicon-edit" style="color:red;"><?php echo $row->lou_clm_id; ?></a></td>
