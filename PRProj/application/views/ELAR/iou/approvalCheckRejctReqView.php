...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >	  
       ...
       <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">IOU CLAIM REJECT VIEW
                    <?php
                    if (isset($error)) {
 ...
 if($LocalClaimDetail!=null){
	 foreach ($LocalClaimDetail->result() as $row)  
	  ...
	  <tr>
                     <?php
                        $LocalClaimHodApproved = $this->method_call->iouDetailsHodReject($lou_clm_id,$emp_code);
                       // echo '$lrcm_id-----------' .$lrcm_id;
                       // echo '$emp_code----------' .$emp_code;
                        if ($LocalClaimHodApproved != null) {
                             $sr_no = 1;
