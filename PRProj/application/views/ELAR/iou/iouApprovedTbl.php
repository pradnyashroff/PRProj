...
<html>
    <head>
        ...
        <title>Advance IOU Reimbursement</title>
   ...
   <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >    	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
                <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">ADVANCE IOU CLAIM APPROVED
                    <?php
                    if (isset($error)) {
      ...
      <div class="row">
        ...
        <table id="example" class="table table">
                ...
                <tbody>
                     <?php $approvedClaimList= $this->method_call->fetchIouApprovedDetailsTbl($emp_code);
                 $final_rate=0; 	   
...
foreach ($approvedClaimList->result() as $row)  
         {  ?>
                <tr>
                  ...
                  <td> <a href="<?php echo site_url('ELAR/IOU/IouCntr/iou_claim_accept_view/'.$row->lou_clm_id);?>" style="color:red;" class="glyphicon glyphicon-edit"><?php echo $row->lou_clm_id; ?></a></td>
