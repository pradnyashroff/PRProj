                                    ...
                                    <ul class="treeview-menu">
                                        <li>
                                            <a href="<?php echo site_url('purchase/PR/Pending_Approval') ?>" class="">
                                                <i class="fa fa-angle-down pull-right" style="color:#FFFFFF"></i> <span style="color:#FFFFFF"> Pending Approval</span>
                            ...
                            <ul class="treeview-menu">
                                <li>
                                    <a href="<?php echo site_url('purchase/PR/approved_list') ?>" class="">
                                        <i class="fa fa-angle-down pull-right" style="color:#FFFFFF"></i> <span style="color:#FFFFFF"> Apprved </span>
