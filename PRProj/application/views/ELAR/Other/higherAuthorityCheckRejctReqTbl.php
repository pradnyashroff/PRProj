    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >    	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">OTHER CLAIM REJECT TABLE
                    <?php
                    if (isset($error)) {
      ...
      <div class="row">
        ...
        <table id="example" class="table table">
                ...
                <tbody>
                     <?php $claimApprovHodList= $this->method_call->fetchOtherReimRejectHigherAuthoClaim($emp_code);
                 $final_rate=0; 	   
...
foreach ($claimApprovHodList->result() as $row)  
         {  ?>
                <tr>
                  <td> <a href="<?php echo site_url('ELAR/Other/Other_cntr/higher_other_claim_rejct_view/'.$row->ocm_id);?>" style="color:red;" class="glyphicon glyphicon-edit"> <?php echo $row->ocm_id; ?></a></td>
