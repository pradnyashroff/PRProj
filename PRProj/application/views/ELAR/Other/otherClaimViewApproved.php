   ...
   <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >      	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
                <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">OTHER REIMBURSEMENTS APPROVED VIEW
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li> <a href="<?php echo site_url('ELAR/Other/Other_cntr/appr_other_claim_dash') ?>" style="color:#FFFFFF;text-transform: uppercase;">Other Reimbursement</a></li>
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Approved Claim
                    </li>
                    </li>
                </ol>
            </section>
			   ...
			   <label class="col-sm-3 pull-left control-label">Justification: </label>
				<div class="input-group  col-sm-6">
                               <textarea class="form-control" rows="4" style="background-color:#E6F2FF;" readonly cols="50" name="areaJustification" required><?php echo $row1->justification; ?></textarea>
                                        ...
                                        <input class="form-control" type="hidden" style="background-color:#E6F2FF;" readonly name="txtRepAutho" value="<?php print_r($reporting_autho['reporting_autho']); ?>"/>
