            ...
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">OTHER REIMBURSEMENTS PENDING CLAIM VIEW
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Other Pending Claim
                    </li>
                    </li>
                </ol>
            </section>
         ...
         <?php $sr_no++;}
			...
			<!-- end -->
                             <?php }
                                  ...
                                  <form method="post" role="form" enctype="multipart/form-data" action="<?php echo site_url('ELAR/Other/Other_cntr/sanctionAuthoActionOtherClaim') ?>" >
