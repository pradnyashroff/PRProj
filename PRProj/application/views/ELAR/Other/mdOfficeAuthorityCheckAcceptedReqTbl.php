      ...
      <div class="row">
        ...
        <table id="example" class="table table">
               ...
               <tr style="background-color:#3482AE;color:#FFFFFF;width:100%;">
                ...
                <tbody>
                     <?php $claimApprovHodList= $this->method_call->fetchOtherReimAcceptmdOfficeClaim($emp_code);
                 $final_rate=0; 	   
...
foreach ($claimApprovHodList->result() as $row)  
         {  ?>
                <tr>
                  <td> <a class="glyphicon glyphicon-edit" style="color:red;" href="<?php echo site_url('ELAR/Other/Other_cntr/fetchOtherReimAcceptMdOfficeClaimView/'.$row->ocm_id);?>"><?php echo $row->ocm_id; ?></a></td>
