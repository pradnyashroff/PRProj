     ...
     <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >   	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">OTHER CONVEYANCES APPROVED TABLE
                    <?php
                    if (isset($error)) {
      ...
      <div class="row">
        ...
        <table id="example" class="table table">
               ...
               <tr style="background-color:#3482AE;color:#FFFFFF;width:100%;">
                ...
                <tbody>
                     <?php $claimApprovHodList= $this->method_call->fetchOtherReimApprovalHigherAuthoClaim($emp_code);
                 $final_rate=0; 	   
...
foreach ($claimApprovHodList->result() as $row)  
         {  ?>
                <tr>
                  <td> <a class="glyphicon glyphicon-edit" style="color:red;" href="<?php echo site_url('ELAR/Other/Other_cntr/fetchOtherReimApprovalHigherAuthoClaimView/'.$row->ocm_id);?>"><?php echo $row->ocm_id; ?></a></td>
