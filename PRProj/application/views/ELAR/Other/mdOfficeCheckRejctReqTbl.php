      ...
      <div class="row">
        ...
        <table id="example" class="table table">
               ...
               <tr style="background-color:#3482AE;color:#FFFFFF;width:100%;">
                ...
                <tbody>
                     <?php $claimApprovHodList= $this->method_call->fetchOtherReimRejectMdOfficeClaim($emp_code);
                 $final_rate=0; 	   
...
foreach ($claimApprovHodList->result() as $row)  
         {  ?>
                <tr>
                  <td> <a href="<?php echo site_url('ELAR/Other/Other_cntr/mdOffice_other_claim_rejct_view/'.$row->ocm_id);?>" style="color:red;" class="glyphicon glyphicon-edit"> <?php echo $row->ocm_id; ?></a></td>
