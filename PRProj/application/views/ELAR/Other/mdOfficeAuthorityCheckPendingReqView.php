     ...
     <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >  	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
                <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">OTHER REIMBURSEMENTS PENDING CLAIM VIEW
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Pending Claim View
                    </li>
                    </li>
                </ol>
            </section>
         ...
         <?php $sr_no++;}
               ...
               <!-- end -->
                             <?php }
                                  ...
                                  <form method="post" role="form" enctype="multipart/form-data" action="<?php echo site_url('ELAR/Other/Other_cntr/higherAuthoTwoActionOtherClaim') ?>" >
                                   
                                     <?php $actionTakenBy= $this->method_call->actionTakerDetails($ocm_id,$emp_code);
                                            if($actionTakenBy!=null){
                                                    foreach ($actionTakenBy->result() as $row)  
                                                    {  ?>
                                      <input class="form-control" type="hidden" name="txtStatusId" value="<?php echo $row->other_status_id; ?>"/>
                                      <input class="form-control" type="hidden" name="txtEmpCode" value="<?php echo $row->rep_autho;?>"/>
			 ...
			 <div class="form-group col-sm-12"><br>
			  <label class="col-sm-1 pull-left control-label">5</label>
			   <label class="col-sm-3 pull-left control-label">Action </label>
				<div class="input-group  col-sm-6">
                     <input type="radio" name="claim_state" value="accept" required >&nbsp;&nbsp; Accept Claim</input>
					 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="claim_state" value="reject">&nbsp;&nbsp; Reject Claim</input>
					 </div><br></div>
				<div class="form-group col-sm-12">
			  <label class="col-sm-1 pull-left control-label">6</label>
			   <label class="col-sm-3 pull-left control-label">Justification </label>
				<div class="input-group  col-sm-6">
                     <textarea class="form-control" rows="4" placeholder="Remark...."  cols="50" name="comment" required></textarea>
					 </div><br></div>
				
                             <?php $claimer=$this->method_call->getClaimerDetails($ocm_id);?>
                                ...
                                <?php $autho_code=$this->method_call->getSanctionAuthoDetails();?>
                                  <input type="hidden" value="<?php print_r($autho_code['autho_code']); ?>" name="sanc_autho" class="form-control"  required>
                                  
                                   <?php $authoHih_one=$this->method_call->getHigherAuthoTwoDetails();?>
                                  <input type="hidden" value="<?php print_r($authoHih_one['authoHih_one']); ?>" name="authoHih_one" class="form-control"  required>
                           
              
                                      
                                      <!------Mail Details Code Start From here--->
                           <?php $emp_email=$this->method_call->fetchUserMailDetails($ocm_id);?>
                                    ...
                                    <input class="form-control" type="hidden" name="txtSancAuthoEmail" value="<?php print_r($SancAuthoEmail['SancAuthoEmail']); ?>"/>
                                        <?php $HigherAuthoEmail=$this->method_call->fetchHigherAuthoMailDetailsForClaimer();?>
                                    <input class="form-control" type="hidden" name="txtHigherAuthoEmail" value="<?php print_r($HigherAuthoEmail['HigherAuthoEmail']); ?>"/>
                                    
                                    
                                    <?php $mdOfficeAuthoEmail=$this->method_call->fetchMdOfficeMailDetailsForClaimer();?>
                                    <input class="form-control" type="hidden" name="txtMdOfficeEmail" value="<?php print_r($mdOfficeAuthoEmail['mdOfficeAuthoEmail']); ?>"/>
                                    
                                    
                                    <?php $dept_name=$this->method_call->fetchUserDepartmentDetails($ocm_id);?>
                                    <input class="form-control" type="hidden" name="txtDeptNameDetails" value="<?php print_r($dept_name['dept_name']); ?>"/>
                                     
                                    <?php $plant_name=$this->method_call->fetchUserPlantDetails($ocm_id);?>
                                    <input class="form-control" type="hidden" name="txtPlantNameDetails" value="<?php print_r($plant_name['plant_name']); ?>"/>
                                     
                                    
                                    
                                    <input class="form-control" type="hidden" name="txtHodName" value="<?php print_r($emp_name); ?>"/>
                                    ...
                                    <?php $claimerPlant=$this->method_call->getClaimerPlant($ocm_id);?>
                                        ...
                                        <?php $emp_name=$this->method_call->fetchEmpNameForMail($ocm_id); ?>
