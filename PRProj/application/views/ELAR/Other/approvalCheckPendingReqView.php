        ...
        <!-- Content Wrapper. Contains page content -->
         <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">OTHER REIMBURSEMENTS CLAIM VIEW
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Pending Claim
                    </li>
                    </li>
                </ol>
            </section>
				...
				?>
                  ...
                  <div class="form-group col-sm-12">
                      <div class="form-group col-sm-7"></div>
                          ...
                          <div class="form-group col-sm-4">
                              <label class="col-sm-12 pull-left control-label" style="margin-left: 25%"><h5>Total Amount : <span class="fa fa-inr"> </span> <?php echo $final_rate; ?></h5> </label>
         ...
         <?php $sr_no++;}
			...
			<!-- end -->
                             <?php }
                                  ...
                                  <form method="post" role="form" enctype="multipart/form-data" action="<?php echo site_url('ELAR/Other/Other_cntr/hodActionOtherClaim') ?>" >
				 ...
				 <div class="form-group col-sm-6">
					...
					<input type="radio" name="claim_state" value="reject"> &nbsp;&nbsp;Reject Claim</input>
                             ...
                             <?php $claimer=$this->method_call->getClaimerDetails($ocm_id);?>
                                ...
                                <?php $autho_code=$this->method_call->getSanctionAuthoDetails();?>
                                  <input type="hidden" value="<?php print_r($autho_code['autho_code']); ?>" name="sanc_autho" class="form-control"  required>
                                   ...
                                   <?php $authoHih_one=$this->method_call->getHigherAuthoOneDetails();?>
                        ...
                        <center><button type="submit" name="save"  class="btn" style="background-color:#3482AE;color:white;box-shadow: 0 0 3px 1px rgba(0,0,0,.35);font-family:'exo';text-transform: uppercase;">Save Claim Details</button>
                                 </center><!------Mail Details Code Start From here--->
