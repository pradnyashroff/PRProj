    ...
    <body class="hold-transition skin-blue sidebar-mini" style="font-family:'exo';" >   	  
        ...
        <div class="content-wrapper"  style="background-color:#3482AE;text-transform: uppercase;">
            ...
            <section class="content-header">      
               <h1 style="color:#FFFFFF; font-family:'exo';text-transform: uppercase;">OTHER ACCEPTED CLAIM TABLE
                    <?php
                    if (isset($error)) {
                ...
                <ol class="breadcrumb" style="color:#FFFFFF;text-transform: uppercase;">
                    ...
                    <li class="active" style="color:#FFFFFF;text-transform: uppercase;">Approved Request Table
                    </li>
                    </li>
                </ol>
            </section>
...
<div class="container">
    <form method="post" id="add_localRim_detailsEdit" name="add_localRim_detailsEdit" action="<?php echo site_url('ELAR/Other/Other_cntr/showSancAuthoReportAccept') ?>" >
    <div class="row">
        <div class='col-sm-4'>
        ...
        <div class='col-sm-2'>
            <div class="form-group">
                <label></label>
                <div class='input-group date' id='datetimepicker1'>
                    <img src="<?php echo base_url(); ?>assets/images/excel.jpg" style="width: 65px" onclick="fnExcelReport();">
...
echo '<tr>' . '<td class="e_id"> <a href="'. site_url('ELAR/Other/Other_cntr/sanc_autho_other_claim_accpt_view/'.$value->ocm_id).'" style="color:red;" class="glyphicon glyphicon-edit">' . $value->ocm_id . '</a></td>' . '<td>' . $value->reg_date . '</td>' . '<td>' . $value->emp_name . '</td>' .'<td>' . $value->emp_code . '</td>'.'<td>' . $value->dept_name . '</td>'.'<td>' . $value->plant_name . '</td>'. '<td>' . $value->total_amt . '</td>' .''. '</td> <td>You Approved</td>' . '<tr/>';
}
